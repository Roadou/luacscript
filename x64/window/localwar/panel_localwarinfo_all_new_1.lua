...
function PaGlobal_LocalWarInfo_All_New:setInstanceRoomList()
  ...
  for index = 0, roomCount - 1 do
    ...
    local isSeasonOnly = ToClient_isSeasonRedBattleField(currentFieldMapKey)
    local isDisableCamouflage = ToClient_isDisableCamouflageRedBattleField(currentFieldMapKey)
