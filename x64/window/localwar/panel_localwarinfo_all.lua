PaGlobal_LocalWarInfo_All_New = {
  _ui = {
    ...
    _txt_season = nil,
    _txt_disableCamo = nil,
    _stc_rewardAreaBG = nil,
    _stc_winRewardSlotBG = nil,
    _stc_loseRewardSlotBG = nil,
    _frame_desc = nil,
    _penalty = {
      _txt_title = nil,
      _stc_background = nil,
  ...
  _maxPlayerCount = ToClient_GetRedBattleFieldMaxPlayerCount(),
  _matchingPlayerCount = ToClient_GetRedBattleFieldMatchingPlayerCount(),
