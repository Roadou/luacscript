...
function PaGlobal_RandowShop_All:controlAll_Init()
  ...
  self._ui.stc_blockBg = UI.getChildControl(Panel_Window_RandomShop_All, "Static_BlockBG")
end
...
function PaGlobal_RandowShop_All:setKeyGuide()
  PaGlobalFunc_ConsoleKeyGuide_SetAlign(self._keyGuideList, self._ui_console.stc_guideAreaBg, CONSOLEKEYGUID_ALIGN_TYPE.eALIGN_TYPE_RIGHTAUTOWRAP)
end
...
function PaGlobal_RandowShop_All:update(slotNo, priceRate)
  ...
  if _ContentsGroup_UseCharacterWp == true then
    if slotNo == nil and priceRate == nil then
      PaGlobal_RandowShop_All:setDefaultRandomShop(true, true)
      return
    else
      PaGlobal_RandowShop_All:setDefaultRandomShop(false)
    end
  end
  ...
  for ii = 0, sellCount - 1 do
    ...
    if slotNo == shopItem.shopSlotNo then
      ...
      if nil ~= itemRandomSS then
        ...
        self._ui.stc_itemSlot:ChangeTextureInfoNameAsync("Icon/" .. itemIconPath)
...
function PaGlobal_RandowShop_All:registEventHandler()
  ...
  registerEvent("FromClient_BuyItemFromShop", "FromClient_RandomShop_All_BuyItem")
  if true == self._isConsole then
...
function PaGlobal_RandowShop_All:setDefaultRandomShop(showDefaultRandomShop, openCharacterWp)
  if Panel_Window_RandomShop_All == nil then
    return
  end
  self._isShowRandomItem = not showDefaultRandomShop
  if showDefaultRandomShop == true then
    if self._isConsole == true then
      Panel_Window_RandomShop_All:registerPadEvent(__eConsoleUIPadEvent_Up_Y, "HandleEventLUp_RandomShop_All_ItemShow()")
      Panel_Window_RandomShop_All:registerPadEvent(__eConsoleUIPadEvent_Up_A, "")
      Panel_Window_RandomShop_All:registerPadEvent(__eConsoleUIPadEvent_Up_LT, "")
      self._ui_console.btn_guideOther:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_OTHERCHARACTER_ENERGYPOINT_BUY_ITEM"))
      self._ui_console.btn_guideReserve:SetShow(false)
      self._ui_console.btn_guideDetail:SetShow(false)
      self._ui_console.btn_guideBuy:SetShow(false)
      self._keyGuideList = {
      ...
      self._ui_pc.btn_other:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_OTHERCHARACTER_ENERGYPOINT_BUY_ITEM"))
      self._ui_pc.btn_other:addInputEvent("Mouse_LUp", "HandleEventLUp_RandomShop_All_ItemShow()")
      self._ui_pc.btn_reserve:SetIgnore(true)
      self._ui_pc.btn_reserve:SetMonoTone(true)
      self._ui_pc.btn_buy:SetIgnore(true)
      self._ui_pc.btn_buy:SetMonoTone(true)
    ...
    if openCharacterWp == true then
      PaGlobalFunc_UseCharacterWp_All_Open(PaGlobal_UseCharacterWp_All._openType._secretRandomShop)
    end
    if ToClient_IsRandomShopKeepItem() == true then
    ...
    if self._isConsole == true then
      ...
      Panel_Window_RandomShop_All:registerPadEvent(__eConsoleUIPadEvent_Up_A, "HandleEventLUp_RandomShop_All_BuyItem()")
      Panel_Window_RandomShop_All:registerPadEvent(__eConsoleUIPadEvent_Up_LT, "HandleEventLUp_RandomShop_All_ReserveKeepItem()")
      self._ui_console.btn_guideOther:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_UNKNOWNRANDOMSELECT_BTN_ITEMRESELECT"))
      self._ui_console.btn_guideReserve:SetShow(true)
      self._ui_console.btn_guideDetail:SetShow(true)
      self._ui_console.btn_guideBuy:SetShow(true)
      self._keyGuideList = {
      ...
      self._ui_pc.btn_other:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_UNKNOWNRANDOMSELECT_BTN_ITEMRESELECT"))
      self._ui_pc.btn_other:addInputEvent("Mouse_LUp", "HandleEventLUp_RandomShop_All_OtherItemShow()")
      self._ui_pc.btn_reserve:SetIgnore(false)
      self._ui_pc.btn_reserve:SetMonoTone(false)
      self._ui_pc.btn_buy:SetIgnore(false)
