function Panel_NumberPad_Show(isShow, s64_moneyMaxNumber, param0, confirmFunction, isExchange, param1, isItemMarket, param2, s64_weightMaxNumber, param3, numberPadOptionDesc)
  ...
  if false == isShow then
    ...
    if Defines.s64_const.s64_1 == s64_moneyMaxNumber then
      PaGlobal_NumberPad_All:openSetting(param0, confirmFunction, false, param1, param2, param3, numberPadOptionDesc)
      HandleEventLUp_NumberPad_All_ConfirmButton_Click()
    else
      PaGlobal_NumberPad_All:openSetting(param0, confirmFunction, true, param1, param2, param3, numberPadOptionDesc)
