...
function PaGlobal_NumberPad_All:prepareClose()
  ...
  PaGlobal_NumberPad_All:clearNumberPadOption()
...
function PaGlobal_NumberPad_All:checkConfirmEnable()
  if PaGlobal_NumberPad_All:checkNumberPadOption(PaGlobal_NumberPad_All.NUMBERPAD_OPTION.CANINPUTZERO) == true then
...
function PaGlobal_NumberPad_All:openSetting(param0, confirmFunction, isShow, param1, param2, param3, numberPadOptionDesc)
  local numberPad = PaGlobal_NumberPad_All._numberPad
  ...
  PaGlobal_NumberPad_All:setNumberPadOption(numberPadOptionDesc)
...
function PaGlobal_NumberPad_All:checkNumberPadOption(optionEnum)
  if self._numberPadOptionDesc == nil or optionEnum == nil then
    return false
  end
  if self._numberPadOptionDesc[optionEnum] == nil then
    return false
  end
  return self._numberPadOptionDesc[optionEnum]
end
function PaGlobal_NumberPad_All:setNumberPadOption(optionDesc)
  if optionDesc == nil then
    self._numberPadOptionDesc = nil
  end
  self._numberPadOptionDesc = optionDesc
end
function PaGlobal_NumberPad_All:clearNumberPadOption()
  self._numberPadOptionDesc = nil
end
