...
function PaGlobal_Socket_All:controlAll_Init()
  ...
  for idx = 1, self._socketSlotCount do
    ...
    if true == self._isConsole then
      self._ui.stc_crystalSlot[idx]:ChangeOnTextureInfoNameAsync("Combine/Etc/Combine_Etc_Extract_UI_05.dds")
...
function PaGlobal_Socket_All:updateSocketSlotBg(index, isNormal)
  ...
  local texturePath = ""
  self._ui.stc_crystalInfoBg[index]:ChangeTextureInfoNameAsync("Combine/Frame/Combine_Frame_00.dds")
