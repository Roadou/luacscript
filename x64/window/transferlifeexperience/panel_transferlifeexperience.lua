...
local ChangeTexture_Class = function(control, classType)
  if classType == __eClassType_Warrior then
    control:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Window/Lobby/Lobby_ClassSelect_Btn_00.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(control, 2, 1, 458, 61)
    control:getBaseTexture():setUV(x1, y1, x2, y2)
    control:setRenderTexture(control:getBaseTexture())
    control:ChangeOnTextureInfoNameAsync("New_UI_Common_forLua/Window/Lobby/Lobby_ClassSelect_Btn_00.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(control, 2, 62, 458, 122)
    control:getOnTexture():setUV(x1, y1, x2, y2)
    control:ChangeClickTextureInfoNameAsync("New_UI_Common_forLua/Window/Lobby/Lobby_ClassSelect_Btn_00.dds")
  ...
  elseif classType == __eClassType_Sorcerer then
    ...
    control:getOnTexture():setUV(x1, y1, x2, y2)
    control:ChangeClickTextureInfoNameAsync("New_UI_Common_forLua/Window/Lobby/Lobby_ClassSelect_Btn_01.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(control, 2, 1, 458, 61)
    control:getClickTexture():setUV(x1, y1, x2, y2)
  elseif classType == __eClassType_Giant then
    control:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Window/Lobby/Lobby_ClassSelect_Btn_01.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(control, 2, 62, 458, 122)
    control:getBaseTexture():setUV(x1, y1, x2, y2)
    control:setRenderTexture(control:getBaseTexture())
    control:ChangeOnTextureInfoNameAsync("New_UI_Common_forLua/Window/Lobby/Lobby_ClassSelect_Btn_01.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(control, 2, 123, 458, 183)
    control:getOnTexture():setUV(x1, y1, x2, y2)
    control:ChangeClickTextureInfoNameAsync("New_UI_Common_forLua/Window/Lobby/Lobby_ClassSelect_Btn_01.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(control, 2, 184, 458, 244)
  ...
  elseif classType == __eClassType_Tamer then
    control:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Window/Lobby/Lobby_ClassSelect_Btn_02.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(control, 2, 1, 458, 61)
    control:getBaseTexture():setUV(x1, y1, x2, y2)
    control:setRenderTexture(control:getBaseTexture())
    control:ChangeOnTextureInfoNameAsync("New_UI_Common_forLua/Window/Lobby/Lobby_ClassSelect_Btn_02.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(control, 2, 62, 458, 122)
    control:getOnTexture():setUV(x1, y1, x2, y2)
    control:ChangeClickTextureInfoNameAsync("New_UI_Common_forLua/Window/Lobby/Lobby_ClassSelect_Btn_02.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(control, 2, 123, 458, 183)
    control:getClickTexture():setUV(x1, y1, x2, y2)
  ...
  elseif classType == __eClassType_BladeMasterWoman then
    control:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Window/Lobby/Lobby_ClassSelect_Btn_04.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(control, 2, 184, 458, 244)
    control:getBaseTexture():setUV(x1, y1, x2, y2)
    control:setRenderTexture(control:getBaseTexture())
    control:ChangeOnTextureInfoNameAsync("New_UI_Common_forLua/Window/Lobby/Lobby_ClassSelect_Btn_04.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(control, 2, 245, 458, 305)
    control:getOnTexture():setUV(x1, y1, x2, y2)
    control:ChangeClickTextureInfoNameAsync("New_UI_Common_forLua/Window/Lobby/Lobby_ClassSelect_Btn_04.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(control, 2, 306, 458, 366)
    control:getClickTexture():setUV(x1, y1, x2, y2)
  ...
  elseif classType == __eClassType_WizardMan then
    control:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Window/Lobby/Lobby_ClassSelect_Btn_05.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(control, 2, 1, 458, 61)
    control:getBaseTexture():setUV(x1, y1, x2, y2)
    control:setRenderTexture(control:getBaseTexture())
    control:ChangeOnTextureInfoNameAsync("New_UI_Common_forLua/Window/Lobby/Lobby_ClassSelect_Btn_05.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(control, 2, 62, 458, 122)
    control:getOnTexture():setUV(x1, y1, x2, y2)
    control:ChangeClickTextureInfoNameAsync("New_UI_Common_forLua/Window/Lobby/Lobby_ClassSelect_Btn_05.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(control, 2, 123, 458, 183)
    control:getClickTexture():setUV(x1, y1, x2, y2)
  ...
  elseif classType == __eClassType_Kunoichi then
    control:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Window/Lobby/Lobby_ClassSelect_Btn_06.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(control, 2, 184, 458, 244)
    control:getBaseTexture():setUV(x1, y1, x2, y2)
    control:setRenderTexture(control:getBaseTexture())
    control:ChangeOnTextureInfoNameAsync("New_UI_Common_forLua/Window/Lobby/Lobby_ClassSelect_Btn_06.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(control, 2, 245, 458, 305)
    control:getOnTexture():setUV(x1, y1, x2, y2)
    control:ChangeClickTextureInfoNameAsync("New_UI_Common_forLua/Window/Lobby/Lobby_ClassSelect_Btn_06.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(control, 2, 306, 458, 366)
    control:getClickTexture():setUV(x1, y1, x2, y2)
  elseif classType == __eClassType_NinjaMan then
    control:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Window/Lobby/Lobby_ClassSelect_Btn_07.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(control, 2, 1, 458, 61)
    control:getBaseTexture():setUV(x1, y1, x2, y2)
    control:setRenderTexture(control:getBaseTexture())
    control:ChangeOnTextureInfoNameAsync("New_UI_Common_forLua/Window/Lobby/Lobby_ClassSelect_Btn_07.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(control, 2, 62, 458, 122)
    control:getOnTexture():setUV(x1, y1, x2, y2)
    control:ChangeClickTextureInfoNameAsync("New_UI_Common_forLua/Window/Lobby/Lobby_ClassSelect_Btn_07.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(control, 2, 123, 458, 183)
    control:getClickTexture():setUV(x1, y1, x2, y2)
  ...
  elseif classType == __eClassType_Combattant then
    ...
    local x1, y1, x2, y2 = setTextureUV_Func(control, 2, 428, 458, 488)
    control:getOnTexture():setUV(x1, y1, x2, y2)
    control:ChangeClickTextureInfoNameAsync("New_UI_Common_forLua/Window/Lobby/Lobby_ClassSelect_Btn_08.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(control, 2, 1, 458, 61)
    control:getClickTexture():setUV(x1, y1, x2, y2)
  elseif classType == __eClassType_Mystic then
    control:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Window/Lobby/Lobby_ClassSelect_Btn_08.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(control, 2, 62, 458, 122)
    control:getBaseTexture():setUV(x1, y1, x2, y2)
    control:setRenderTexture(control:getBaseTexture())
    control:ChangeOnTextureInfoNameAsync("New_UI_Common_forLua/Window/Lobby/Lobby_ClassSelect_Btn_08.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(control, 2, 123, 458, 183)
    control:getOnTexture():setUV(x1, y1, x2, y2)
    control:ChangeClickTextureInfoNameAsync("New_UI_Common_forLua/Window/Lobby/Lobby_ClassSelect_Btn_08.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(control, 2, 184, 458, 244)
  ...
  elseif classType == __eClassType_RangerMan then
    ...
    control:getBaseTexture():setUV(x1, y1, x2, y2)
    control:setRenderTexture(control:getBaseTexture())
    control:ChangeOnTextureInfoNameAsync("New_UI_Common_forLua/Window/Lobby/Lobby_ClassSelect_Btn_09.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(control, 2, 1, 458, 61)
    control:getOnTexture():setUV(x1, y1, x2, y2)
    control:ChangeClickTextureInfoNameAsync("New_UI_Common_forLua/Window/Lobby/Lobby_ClassSelect_Btn_09.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(control, 2, 62, 458, 122)
    control:getClickTexture():setUV(x1, y1, x2, y2)
  elseif classType == __eClassType_ShyWaman then
    control:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Window/Lobby/Lobby_ClassSelect_Btn_09.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(control, 2, 123, 458, 183)
    control:getBaseTexture():setUV(x1, y1, x2, y2)
    control:setRenderTexture(control:getBaseTexture())
    control:ChangeOnTextureInfoNameAsync("New_UI_Common_forLua/Window/Lobby/Lobby_ClassSelect_Btn_09.dds")
