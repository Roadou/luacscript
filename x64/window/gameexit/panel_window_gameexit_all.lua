PaGlobal_GameExit_All = {
  ...
  _ui = {
    ...
    _charInfo = {
      ...
      _stc_countGuide = nil,
      _btn_orderReset = nil,
      _chk_changeModeToggle = nil,
      _chk_pushModeToggle = nil,
      _stc_changeOrderDesc = nil,
      _stc_pushModechangeOrderDesc = nil
    },
    _frame_charList = nil,
    _charList = {
      _stc_characterSlot = nil,
  ...
  _eServantView = {
    vehicle = __eServantTypeVehicle,
    ship = __eServantTypeShip,
    max = 1
  },
  _servantTextureUV = {
    [__eServantTypeVehicle] = {
      x1 = 375,
      y1 = 142,
      x2 = 405,
      y2 = 172
  ...
  _selectChangeFromCharacterIdx = -1,
  _selectChangeToCharacterIdx = -1,
  _startScrollPos = 0,
  _vewingServantTooltipVehicleType = nil,
  _nextPosY = 0,
  _maxSlotLimitViewCount = 35,
  _initialize = false
}
