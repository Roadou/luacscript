function PaGlobal_ChannelSelect_All:initialize()
  ...
  self._ui.stc_Icon_RoseWar = UI.getChildControl(Panel_ChannelSelect_All, "StaticText_RoseWarServer")
  self._ui.stc_Icon_HardCoreChannel = UI.getChildControl(Panel_ChannelSelect_All, "StaticText_HardCoreServer")
  self._ui.stc_Icon_OceanSiegeChannel = UI.getChildControl(Panel_ChannelSelect_All, "StaticText_OceanSiegeServer")
  ...
  self._ui.txt_RoseWar = UI.getChildControl(self._ui.stc_DescPanel, "StaticText_Channel_RoseWar")
  self._ui.txt_RoseWarDesc = UI.getChildControl(self._ui.stc_DescPanel, "StaticText_Channel_RoseWarDesc")
  self._ui.txt_RoseWar_Schedule = UI.getChildControl(self._ui.stc_DescPanel, "StaticText_Schedule_RoseWar")
  self._ui.txt_RoseWar_ScheduleDesc = UI.getChildControl(self._ui.stc_DescPanel, "StaticText_Schedule_RoseWarDesc")
  ...
  self._ui.txt_OceanSiegeChannel = UI.getChildControl(self._ui.stc_DescPanel, "StaticText_Channel_OceanSiegeChannel")
  self._ui.txt_OceanSiegeChannelDesc = UI.getChildControl(self._ui.stc_DescPanel, "StaticText_Channel_OceanSiegeChannelDesc")
  ...
  if nil ~= temporaryWrapper then
    ...
    if 0 == userType then
      ...
      self._ui.chk_ShowDesc:ChangeTextureInfoNameAsync("combine/icon/combine_basic_icon_00.dds")
...
function PaGlobal_ChannelSelect_All:swichPlatform()
  ...
  if false == _ContentsGroup_RenewUI then
    ...
    self._ui.txt_RoseWar:SetSize(self._ui.txt_RoseWar:GetSizeX() + descSize, self._ui.txt_RoseWar:GetSizeY())
    self._ui.txt_RoseWarDesc:SetSize(self._ui.txt_RoseWarDesc:GetSizeX() + descSize, self._ui.txt_RoseWarDesc:GetSizeY())
    self._ui.txt_RoseWar_Schedule:SetSize(self._ui.txt_RoseWar_Schedule:GetSizeX() + descSize, self._ui.txt_RoseWar_Schedule:GetSizeY())
    self._ui.txt_RoseWar_ScheduleDesc:SetSize(self._ui.txt_RoseWar_ScheduleDesc:GetSizeX() + descSize, self._ui.txt_RoseWar_ScheduleDesc:GetSizeY())
    ...
    self._ui.txt_OceanSiegeChannel:SetSize(self._ui.txt_OceanSiegeChannel:GetSizeX() + descSize, self._ui.txt_OceanSiegeChannel:GetSizeY())
    self._ui.txt_OceanSiegeChannelDesc:SetSize(self._ui.txt_OceanSiegeChannelDesc:GetSizeX() + descSize, self._ui.txt_OceanSiegeChannelDesc:GetSizeY())
    ...
    self._ui.stc_blockBG:ChangeTextureInfoNameAsync("renewal/etc/console_etc_fullscreenbg.dds")
    ...
    self._ui.stc_Icon_Maintenance:ChangeTextureInfoNameAsync("renewal/ui_icon/console_icon_01.dds")
    ...
    stc_slotIcon_Maintenance:ChangeTextureInfoNameAsync("renewal/ui_icon/console_icon_01.dds")
...
function PaGlobal_ChannelSelect_All:createChannelUI()
  ...
  for idx = 0, totalChannelCount - 1 do
    do
      ...
      cloned_ChannelSlot._stc_RoseWar = UI.getChildControl(rdo_Channel, "Static_RosewarServer")
      cloned_ChannelSlot._stc_HardCoreChannel = UI.getChildControl(rdo_Channel, "Static_HardCoreServer")
      cloned_ChannelSlot._stc_OceanSiegeChannel = UI.getChildControl(rdo_Channel, "Static_OceanSiegeServer")
      ...
      localFunc_PushTableWithSetShow(cloned_ChannelSlot._stc_RoseWar)
      localFunc_PushTableWithSetShow(cloned_ChannelSlot._stc_HardCoreChannel)
      localFunc_PushTableWithSetShow(cloned_ChannelSlot._stc_OceanSiegeChannel)
...
function PaGlobal_ChannelSelect_All:alignDesc()
  ...
  if _ContentsGroup_RoseWar then
    descTable:push_back(self._ui.txt_RoseWar)
    descTable:push_back(self._ui.txt_RoseWarDesc)
    descTable:push_back(self._ui.txt_RoseWar_Schedule)
    descTable:push_back(self._ui.txt_RoseWar_ScheduleDesc)
    self._ui.txt_RoseWar:SetShow(true)
    self._ui.txt_RoseWarDesc:SetShow(true)
    self._ui.txt_RoseWar_Schedule:SetShow(true)
    self._ui.txt_RoseWar_ScheduleDesc:SetShow(true)
  else
    self._ui.txt_RoseWar:SetShow(false)
    self._ui.txt_RoseWarDesc:SetShow(false)
    self._ui.txt_RoseWar_Schedule:SetShow(false)
    self._ui.txt_RoseWar_ScheduleDesc:SetShow(false)
  end
  ...
  if _ContentsGroup_OceanSiege == true then
    descTable:push_back(self._ui.txt_OceanSiegeChannel)
    descTable:push_back(self._ui.txt_OceanSiegeChannelDesc)
    self._ui.txt_OceanSiegeChannel:SetShow(true)
    self._ui.txt_OceanSiegeChannelDesc:SetShow(true)
  else
    self._ui.txt_OceanSiegeChannel:SetShow(false)
    self._ui.txt_OceanSiegeChannelDesc:SetShow(false)
  end
  ...
  elseif isGameTypeRussia() or isGameTypeNA() or isGameTypeJapan() or isGameTypeTR() or isGameTypeSA() or true == isTawan or true == isKorea then
    self._ui.txt_PkTitle:SetShow(true)
    self._ui.txt_PkDesc:SetShow(true)
  end
...
function PaGlobal_ChannelSelect_All:createServerDesc()
  ...
  local descData = {
    ...
    [8] = {
      title = PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SERVERSELECT_ROSEWARCHANNEL_SUB_TITLE"),
      desc = PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SERVERSELECT_ROSEWARCHANNEL_SUB_DESC"),
      contentsOption = _ContentsGroup_RoseWar == true
    },
    [9] = {
      title = PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SERVERSELECT_ROSEWARCHANNEL_DATE_SUB_TITLE"),
      desc = PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SERVERSELECT_ROSEWARCHANNEL_DATE_SUB_DESC"),
      contentsOption = _ContentsGroup_RoseWar == true
    },
    [10] = {
    ...
    [12] = {
      title = PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SERVERSELECT_OCEANSIEGE_SERVER_TITLE"),
      desc = PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SERVERSELECT_OCEANSIEGE_SERVER_DESC"),
      contentsOption = _ContentsGroup_OceanSiege
    }
  }
  if _ContentsGroup_HadumCalpheon == true then
  ...
  for idx = 1, #descData do
    if descData[idx].contentsOption then
      ...
      if nil ~= UIControls then
        ...
        UIControls.rdo:addInputEvent("Mouse_LUp", "HandleEventLUp_ChannelSelect_All_SelectDescriptionIndex( \"" .. UIControls.rdo:GetID() .. "\" )")
  ...
  if nil ~= self._serverDescControls[1] then
    local radioButton = self._serverDescControls[1].rdo
    radioButton:SetCheck(true)
    PaGlobal_ChannelSelect_All:SelectDescription(radioButton:GetID())
  end
...
function PaGlobal_ChannelSelect_All:alignBottomIcon()
  ...
  if _ContentsGroup_RoseWar == true then
    bottomIconList:push_back(self._ui.stc_Icon_RoseWar)
    self._ui.stc_Icon_RoseWar:SetShow(true)
  else
    self._ui.stc_Icon_RoseWar:SetShow(false)
  end
  if _ContentsGroup_HardCoreChannel == true then
  ...
  if _ContentsGroup_OceanSiege == true then
    bottomIconList:push_back(self._ui.stc_Icon_OceanSiegeChannel)
    self._ui.stc_Icon_OceanSiegeChannel:SetShow(true)
  else
    self._ui.stc_Icon_OceanSiegeChannel:SetShow(false)
  end
  local gabX = 20
  local gabY = 10
  local startPosX = 15
...
function PaGlobal_ChannelSelect_All:update(isByPersonalField)
  ...
  if _ContentsGroup_HardCoreChannel == true then
    for ch_Index = 0, channelCount - 1 do
      local serverData = getGameChannelServerDataByWorldNo(curChannelData._worldNo, ch_Index)
      if nil ~= serverData and serverData._isHardCoreChannel == true then
        self._serverIndexTable:push_back(ch_Index)
      end
    end
  end
  if _ContentsGroup_OceanSiege == true then
    for ch_Index = 0, channelCount - 1 do
      local serverData = getGameChannelServerDataByWorldNo(curChannelData._worldNo, ch_Index)
      if serverData ~= nil and serverData._isSiegeChannel == true and serverData:getSiegeTerritoryType() == __eSiegeTerritoryType_Ocean then
        self._serverIndexTable:push_back(ch_Index)
      end
    end
  end
  if false == _ContentsGroup_RenewUI then
    for ch_Index = 0, channelCount - 1 do
      ...
      if nil ~= serverData then
        if isUseTotalAccountVer2() == true then
          local getAccessNationServerString = serverData:getAccessibleNation()
          if true == _ContentsGroup_SeasonContents then
            if (false == serverData._isInstanceChannel and serverData:isMultiNationChampionshipInstanceServer() == false or ToClient_SelfPlayerIsGM() == true and _ContentsOption_CH_GameType == false) and serverData._isSpeedChannel == false and serverData._isSeasonChannel == false and serverData._isSeasonNewbieChannel == false and serverData._isHardCoreChannel == false and (serverData._isSiegeChannel == false or serverData:getSiegeTerritoryType() ~= __eSiegeTerritoryType_Ocean) then
          ...
          elseif (serverData._isInstanceChannel == false and serverData:isMultiNationChampionshipInstanceServer() == false or ToClient_SelfPlayerIsGM() == true and _ContentsOption_CH_GameType == false) and serverData._isSpeedChannel == false and serverData._isSeasonNewbieChannel == false then
            if ToClient_SelfPlayerIsGM() == true then
              self._serverIndexTable:push_back(ch_Index)
            elseif getAccessNationServerString == "" or getEnteredNationString == getAccessNationServerString then
              self._serverIndexTable:push_back(ch_Index)
        ...
        elseif (false == serverData._isInstanceChannel and serverData:isMultiNationChampionshipInstanceServer() == false or ToClient_SelfPlayerIsGM() == true and _ContentsOption_CH_GameType == false) and serverData._isSpeedChannel == false and serverData._isSeasonNewbieChannel == false then
          self._serverIndexTable:push_back(ch_Index)
        end
      end
    end
    ...
    for ch_Index = 0, channelCount - 1 do
      ...
      if nil ~= serverData then
        ...
        if _ContentsGroup_SeasonContents == true and serverData._isSeasonChannel == true or serverData._isSpeedChannel == true or serverData._isSeasonNewbieChannel == true or serverData._isHardCoreChannel == true or serverData._isSiegeChannel == true and serverData:getSiegeTerritoryType() == __eSiegeTerritoryType_Ocean then
          isInserted = true
        end
        if false == isInserted then
          if __ePlatformType_COUNT == serverData._servicePlatformType then
            if false == serverData._isInstanceChannel and serverData:isMultiNationChampionshipInstanceServer() == false or ToClient_SelfPlayerIsGM() == true and _ContentsOption_CH_GameType == false then
              crossPlayServer:push_back(ch_Index)
            end
          elseif false == serverData._isInstanceChannel and serverData:isMultiNationChampionshipInstanceServer() == false then
  ...
  for ch_Index = 1, #self._serverIndexTable do
    ...
    if nil == _serverData then
      ...
      channelSlot._stc_WarIcon:SetShow(isBeingWar == true and _serverData:getSiegeTerritoryType() == __eSiegeTerritoryType_Default)
      channelSlot._stc_OceanSiegeChannel:SetShow(isBeingWar == true and _serverData:getSiegeTerritoryType() == __eSiegeTerritoryType_Ocean)
      ...
      channelSlot._stc_RoseWar:SetShow(_serverData._roseWarGameNo == true and ToClient_GetRoseWarState() == __eRoseWar_Start)
      ...
      if _serverData._isSpeedChannel then
        if 0 ~= tempWrapper:getMyAdmissionToSpeedServer() and false == isGMClient and ToClient_isConsole() == false then
      ...
      if _serverData._isSeasonChannel == true then
        channelName = "<PAColor0xffb5e45b>" .. channelName .. "<PAOldColor>"
      end
  ...
  if true == _ContentsGroup_InstanceSiege and (nil == isByPersonalField or false == isByPersonalField) then
    ...
    local instanceServerSiegeTerritoryType = __eSiegeTerritoryType_Default
    for ch_Index = 0, channelCount - 1 do
      local serverData = getGameChannelServerDataByWorldNo(curChannelData._worldNo, ch_Index)
      if nil ~= serverData and true == serverData._isInstanceChannel and true == _serverData._isSiegeBeing then
        ...
        instanceServerSiegeTerritoryType = _serverData:getSiegeTerritoryType()
        break
      end
    end
    ...
    for mode = 0, __eInstanceSiegeMode_Count do
      ...
      if instanceSiegeFieldCount > 0 then
        channelSlot._bg:SetShow(true)
        channelSlot._txt_Status:SetText("")
        channelSlot._stc_WarIcon:SetShow(isInstanceServerWarBeing == true and instanceServerSiegeTerritoryType == __eSiegeTerritoryType_Default)
        channelSlot._stc_OceanSiegeChannel:SetShow(isInstanceServerWarBeing == true and instanceServerSiegeTerritoryType == __eSiegeTerritoryType_Ocean)
        channelSlot._stc_Maintenance:SetShow(false)
...
function PaGlobal_ChannelSelect_All:validate()
  ...
  self._ui.stc_Icon_RoseWar:isValidate()
  self._ui.stc_Icon_HardCoreChannel:isValidate()
  self._ui.stc_Icon_OceanSiegeChannel:isValidate()
  ...
  self._ui.txt_RoseWar:isValidate()
  self._ui.txt_RoseWarDesc:isValidate()
  self._ui.txt_RoseWar_Schedule:isValidate()
  self._ui.txt_RoseWar_ScheduleDesc:isValidate()
  self._ui.txt_HardCoreChannel:isValidate()
  self._ui.txt_HardCoreChannelDesc:isValidate()
  self._ui.txt_OceanSiegeChannel:isValidate()
  self._ui.txt_OceanSiegeChannelDesc:isValidate()
...
function PaGlobal_ChannelSelect_All:SelectDescription(selectedRadioID)
  ...
  for idx = 1, self._descButtonCount do
    if nil ~= self._serverDescControls[idx] then
      ...
      local descBGSizeY = self._descSpanSize + desc[descCount]:GetTextSizeY() + desc[descCount]:GetPosY()
      local sizeY = self._minDescBGSizeY
      if radioButton:GetID() == selectedRadioID then
        sizeY = descBGSizeY
        descBG:SetShow(true)
      else
        sizeY = self._minDescBGSizeY
        descBG:SetShow(false)
      end
  ...
  self._ui.frame_Desc:SetSize(self._ui.frameContent:GetSizeX(), Panel_ChannelSelect_All:GetSizeY())
  self._ui.frame_Desc:UpdateContentPos()
  self._ui.frame_Desc:UpdateContentScroll()
end
