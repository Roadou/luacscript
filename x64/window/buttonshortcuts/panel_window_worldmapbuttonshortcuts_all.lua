PaGlobal_WorldmapButtonShortcuts_All = {
  ...
  _keyString = {
    ...
    [CppEnums.VirtualKeyCode.KeyCode_CONTROL] = PAGetString(Defines.StringSheet_GAME, "InputCustomizer_Ctrl"),
    [CppEnums.VirtualKeyCode.KeyCode_SHIFT] = PAGetString(Defines.StringSheet_GAME, "InputCustomizer_Shift"),
    [CppEnums.VirtualKeyCode.KeyCode_OEM_EQUAL] = "+",
    [CppEnums.VirtualKeyCode.KeyCode_OEM_MINUS] = "-"
  },
  _ePanelType = 0,
  _listOriginPos = 0,
...
runLua("UI_Data/Script/Window/ButtonShortcuts/Panel_Window_WorldmapButtonShortcuts_All_1.lua")
runLua("UI_Data/Script/Window/ButtonShortcuts/Panel_Window_WorldmapButtonShortcuts_All_2.lua")
registerEvent("FromClient_luaLoadComplete", "FromClient_WorldmapButtonShorcuts_All_Init")
function FromClient_WorldmapButtonShorcuts_All_Init()
  PaGlobal_WorldmapButtonShortcuts_All:initialize()
end
