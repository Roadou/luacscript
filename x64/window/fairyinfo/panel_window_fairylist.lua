    ...
    for index = 0, unsealPetCount - 1 do
      ...
      if nil ~= pcPetData and key == pcPetData:getPcPetNo() then
        ...
        if nil ~= SettingData then
          ...
          if nil ~= ItemSSW then
            slot_HpItem:ChangeTextureInfoNameAsync("Icon/" .. ItemSSW:getIconPath())
          ...
          if nil ~= ItemSSW then
            slot_MpItem:ChangeTextureInfoNameAsync("Icon/" .. ItemSSW:getIconPath())
...
function FairyList:Update_Setting(petNoStr, notDataUpdate)
  ...
  if nil ~= ItemHpSSW then
    self.Slot_HpItem:ChangeTextureInfoNameAsync("Icon/" .. ItemHpSSW:getIconPath())
  ...
  if nil ~= ItemMpSSW then
    self.Slot_MpItem:ChangeTextureInfoNameAsync("Icon/" .. ItemMpSSW:getIconPath())
...
function FairyCompose_Init()
  ...
  FairyCompose.icon_1:ChangeTextureInfoNameAsync("")
  FairyCompose.icon_2:ChangeTextureInfoNameAsync("")
  FairyCompose.icon_3:ChangeTextureInfoNameAsync("")
...
function PaGlobal_FairyImgChange(fairyNo, index)
  for sealFairyIndex = 0, ToClient_getFairySealedList() - 1 do
    ...
    if fairyNo == _fairyNo then
      ...
      if 0 == index then
        FairyCompose.icon_1:ChangeTextureInfoNameAsync(iconPath)
        FairyCompose.icon_1:SetShow(true)
      elseif 1 == index then
        FairyCompose.icon_2:ChangeTextureInfoNameAsync(iconPath)
  ...
  for skill_idx = 0, skillMaxCount - 1 do
    ...
    if true == isLearn and nil ~= skillStaticStatus and true ~= petSkillCheck[skill_idx] then
      ...
      if nil ~= skillTypeStaticWrapper and skillLearnCount <= #FairyCompose.skillSlot then
        ...
        FairyCompose.skillSlot[uiIndex][skillLearnCount]:ChangeTextureInfoNameAsync("Icon/" .. skillTypeStaticWrapper:getIconPath())
          ...
          for skill_idx = 0, skillMaxCount - 1 do
            ...
            if true == isLearn and nil ~= skillStaticStatus and true ~= fairySkillCheck[skill_idx] then
              ...
              if nil ~= skillTypeStaticWrapper and skillLearnCount <= #FairyCompose.skillSlot then
                ...
                FairyCompose.skillSlot[3][skillLearnCount]:ChangeTextureInfoNameAsync("Icon/" .. skillTypeStaticWrapper:getIconPath())
              end
            end
          end
        end
  ...
  local function fairyIconChange(fairyNo)
    for sealPetIndex = 0, ToClient_getFairySealedList() - 1 do
      ...
      if _fairyNo == fairyNo then
        local iconPath = fairyData:getIconPath()
        FairyCompose.icon_3:ChangeTextureInfoNameAsync(iconPath)
