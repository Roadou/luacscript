...
function PaGlobal_FairyInfo_All:initialize()
  ...
  self._ui.btn_FairyChangeName = UI.getChildControl(self._ui.stc_BasicInfoBG, "Button_NameChange")
...
function PaGlobal_FairyInfo_All:registEventHandler()
  ...
  self._ui.btn_FairyChangeName:addInputEvent("Mouse_On", "HandleEventOnOut_FairyInfo_ChangeNameButton(true)")
  self._ui.btn_FairyChangeName:addInputEvent("Mouse_Out", "HandleEventOnOut_FairyInfo_ChangeNameButton(false)")
  self._ui.btn_FairyChangeName:addInputEvent("Mouse_LUp", "PaGlobal_FairyChangeName_Open_All()")
...
function PaGlobal_FairyInfo_All:update()
  ...
  if false == isUnseal then
    ...
    self._ui.btn_FairyChangeName:SetShow(true)
    self._ui_console.stc_KeyGuide_LTA:SetShow(true)
    self._ui.txt_FairyName:SetPosX(self._ui.btn_FairyChangeName:GetPosX() + 30)
    ...
    self._ui.btn_FairyChangeName:SetShow(false)
    self._ui_console.stc_KeyGuide_LTA:SetShow(false)
    self._ui.txt_FairyName:SetPosX(self._ui.btn_FairyChangeName:GetPosX())
  ...
  if nil ~= skillSSW then
    ...
    if nil ~= skillTypeSSW then
      ...
      self._ui._skillIcon[uiRow]:ChangeTextureInfoNameAsync("Icon/" .. skillTypeSSW:getIconPath())
...
function PaGlobal_FairyInfo_All:updateFairyLook()
  ...
  self._ui.stc_TitleImage:ChangeTextureInfoNameAsync(imagePath)
  local pcFairyData
  if true == isUnseal then
    pcFairyData = ToClient_getFairyUnsealedDataByIndex(0)
  else
...
function PaGlobal_FairyInfo_All:validate()
  ...
  self._ui.btn_FairyChangeName:isValidate()
...
function PaGlobal_FairyInfo_All:SimpleTooltip(isShow, tipType)
  ...
  elseif tipType == 16 then
    name = PAGetString(Defines.StringSheet_GAME, "LUA_PETLIST_TOOLTIP_BTN_CHANGEFAIRYNAME_NAME")
    desc = PAGetString(Defines.StringSheet_GAME, "LUA_PETLIST_TOOLTIP_BTN_CHANGEFAIRYNAME_DESC")
    control = self._ui.btn_FairyChangeName
  end
...
function PaGlobal_FairyInfo_All:openFromDelList(petNo)
  ...
  PaGlobal_FairyInfo_All:prepareOpen()
end
