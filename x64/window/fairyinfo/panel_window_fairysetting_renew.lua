...
function FairySetting_ReNew:UpdateSetting(updateData)
  ...
  if nil ~= ItemHpSSW then
    self._UI._Static_HPItemSlotBig:ChangeTextureInfoNameAsync("Icon/" .. ItemHpSSW:getIconPath())
  ...
  if nil ~= ItemMpSSW then
    self._UI._Static_MPItemSlotBig:ChangeTextureInfoNameAsync("Icon/" .. ItemMpSSW:getIconPath())
