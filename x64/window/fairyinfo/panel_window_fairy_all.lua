...
registerEvent("FromClient_FairyChangeName", "FromClient_FairyChangeName_Finish")
registerEvent("FromClient_CheckFairyNameChangeItemExist", "FromClient_CheckFairyNameChangeItemExist")
