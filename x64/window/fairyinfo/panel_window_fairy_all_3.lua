...
function PaGlobal_FairyGrowth_All:SetUiSetting()
  ...
  self._rdo_Honey[1].icon:ChangeTextureInfoNameAsync("Icon/" .. iconPath)
  ...
  self._rdo_Honey[2].icon:ChangeTextureInfoNameAsync("Icon/" .. iconPath)
  for i = 1, self._MAX_HONEY_COUNT do
...
function PaGlobal_FairyGrowth_All:Clear()
  ...
  self._ui.stc_FeedIcon:ChangeTextureInfoNameAsync("")
...
function PaGlobal_FairyGrowth_All:updateLeftTop()
  ...
  if nil ~= PaGlobal_FairyInfo_GetIconPath_All() then
    self._ui.stc_FairyIcon:ChangeTextureInfoNameAsync(PaGlobal_FairyInfo_GetIconPath_All())
  end
  if true == PaGlobal_FairyInfo_isMaxLevel_All() then
...
function PaGlobal_FairyGrowth_All:setFeedItem(count, slotNo, itemKey)
  ...
  self._ui.stc_FeedIcon:ChangeTextureInfoNameAsync("Icon/" .. itemSSW:getIconPath())
