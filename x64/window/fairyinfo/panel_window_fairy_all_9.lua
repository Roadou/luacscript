...
function PaGlobal_FairyChangeSkill_All:update(skillKeyList)
  ...
  for ii = 0, #self._skillKeyList do
    ...
    if nil ~= key then
      ...
      slot.SkillSlotBg:ChangeTextureInfoNameAsync("Icon/" .. skillTypeSSW:getIconPath())
...
function PaGlobal_FairyChangeSkill_All:selectSkill(key, isPremium)
  ...
  self._ui.stc_HasSkillSlot:ChangeTextureInfoNameAsync("Icon/" .. skillTypeSSW:getIconPath())
...
function PaGlobal_FairyChangeSkill_All:selectPremiumSkill(key)
  ...
  self._ui.stc_GetSkillSlot:ChangeTextureInfoNameAsync("Icon/" .. skillTypeSSW:getIconPath())
...
function PaGlobal_FairyChangeSkill_All:fairyNewSkillKey(newSkillKey)
  ...
  self._ui.stc_GetSkillSlot:SetShow(true)
  self._ui.stc_GetSkillSlot:getBaseTexture():setUV(0, 0, 1, 1)
  self._ui.stc_GetSkillSlot:ChangeTextureInfoNameAsync("Icon/" .. selectSkillTypeSSW:getIconPath())
  self._ui.stc_GetSkillSlot:setRenderTexture(self._ui.stc_GetSkillSlot:getBaseTexture())
...
function PaGlobal_FairyChangeSkill_All:confirmMessageBox()
  ...
  if needCount > itemCount or 0 == itemCount then
    if false == _ContentsGroup_UsePadSnapping then
      PaGlobalFunc_EasyBuy_Open(79, nil, false)
    else
