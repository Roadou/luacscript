...
function PaGlobal_GuildHouse_Auction_Detail_All:controlAll_Init()
  ...
  PaGlobal_GuildHouse_Auction_Detail_All._subFrameBgSizeY = PaGlobal_GuildHouse_Auction_Detail_All._ui.stc_subFrameBg:GetSizeY()
  PaGlobal_GuildHouse_Auction_Detail_All._panelSizeY = Panel_GuildHouse_Auction_Detail_All:GetSizeY()
end
...
function PaGlobal_GuildHouse_Auction_Detail_All:setNoticeDesc()
  ...
  if PaGlobal_GuildHouse_Auction_Detail_All._ui.stc_descBg:GetSizeY() < PaGlobal_GuildHouse_Auction_Detail_All._ui.stc_desc:GetTextSizeY() then
    ...
    Panel_GuildHouse_Auction_Detail_All:SetSize(Panel_GuildHouse_Auction_Detail_All:GetSizeX(), PaGlobal_GuildHouse_Auction_Detail_All._panelSizeY + sizeY)
    ...
    PaGlobal_GuildHouse_Auction_Detail_All._ui.stc_subFrameBg:SetSize(PaGlobal_GuildHouse_Auction_Detail_All._ui.stc_subFrameBg:GetSizeX(), PaGlobal_GuildHouse_Auction_Detail_All._subFrameBgSizeY + sizeY)
  end
  PaGlobal_GuildHouse_Auction_Detail_All._ui.stc_image:ChangeTextureInfoNameAsync(houseAuctionInfo:getGoodsScreenShotPath(0))
