...
function GuildHouseAuctionManager:setHouseData(index)
  ...
  self._houseAuctionList[index]._house_Image:ChangeTextureInfoNameAsync(houseAuctionInfo:getGoodsScreenShotPath(0))
...
function PaGlobal_Auction_GuildHouse_Tooltip_ViewHouse(isShow, index, tabType)
  ...
  GuildHouseAuction.view_house_tooltip:ChangeTextureInfoNameAsync(houseAuctionInfo:getGoodsScreenShotPath(0))
...
function GuildHouseAuctionManager:setBidData(index)
  ...
  self._houseAuctionList[index]._house_Image:ChangeTextureInfoNameAsync(bidAuctionInfo:getGoodsScreenShotPath(0))
