...
function HouseAuctionManager:setHouseData(index)
  ...
  self._houseAuctionList[index]._styleImage:ChangeTextureInfoNameAsync(houseAuctionInfo:getGoodsScreenShotPath(0))
...
function HouseAuctionManager:setBidData(index)
  ...
  self._houseAuctionList[index]._styleImage:ChangeTextureInfoNameAsync(bidAuctionInfo:getGoodsScreenShotPath(0))
