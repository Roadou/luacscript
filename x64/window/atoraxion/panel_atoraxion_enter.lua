PaGlobal_Atoraxion_Enter = {
  ...
  _mapData = {
    ...
    [__eInstanceAtoraxionThorn_Hadum] = {
      _itemKey = 761643,
      _itemContentType = __eContentsType_AtoraxionThornHadumEnter,
      _bgLightTexture = "Combine/Etc/Combine_Etc_Atoraxion_Boss_03.dds",
      _bgLightUV = {
        x1 = 0,
        y1 = 546,
        x2 = 1920,
      ...
      _bgTexture = "Combine/Etc/Combine_Etc_Atoraxion_Boss_03.dds",
      _bgUV = {
        x1 = 0,
        y1 = 0,
        x2 = 1920,
      ...
      _title = PAGetString(Defines.StringSheet_GAME, "LUA_ATORAXION_ENTER_TITLE_3"),
      _desc = PAGetString(Defines.StringSheet_GAME, "LUA_ATORAXION_SEAL_DESC_3"),
      _titleEffect = "fUI_Atoraxion_Title_02A",
      _titleColor = Defines.Color.C_FF58FAFF,
      _reJoinDesc = PAGetString(Defines.StringSheet_GAME, "LUA_ATORAXXTION_ENTER_RE_FOREST"),
      _msgKeyLack = PAGetString(Defines.StringSheet_GAME, "LUA_ATORAXXITON_BOSS_ENTER_MSG_KEY_FOREST"),
      _centerEffect = "fUI_Atoraxion_All_02A",
      _enterEffect = "fUI_Atoraxion_Button_02A"
    },
    [__eInstanceAtoraxionThorn_Normal] = {
      _itemKey = 761642,
      _itemContentType = __eContentsType_AtoraxionThornNormalEnter,
      _bgLightTexture = "Combine/Etc/Combine_Etc_Atoraxion_Boss_03.dds",
      _bgLightUV = {
        x1 = 0,
        y1 = 546,
      ...
      _title = PAGetString(Defines.StringSheet_GAME, "LUA_ATORAXION_ENTER_TITLE_3"),
      _desc = PAGetString(Defines.StringSheet_GAME, "LUA_ATORAXION_SEAL_DESC_4"),
      _titleEffect = "fUI_Atoraxion_Title_02A",
      _titleColor = Defines.Color.C_FF58FAFF,
      _reJoinDesc = PAGetString(Defines.StringSheet_GAME, "LUA_ATORAXXTION_ENTER_RE_FOREST"),
      _msgKeyLack = PAGetString(Defines.StringSheet_GAME, "LUA_ATORAXXITON_BOSS_ENTER_MSG_KEY_FOREST"),
...
function PaGlobal_Atoraxion_Enter:changeMapData()
  ...
  self._ui.stc_topBg:ChangeTextureInfoNameAsync(mapData._bgLightTexture)
  ...
  self._ui.stc_SelectBg:ChangeTextureInfoNameAsync(mapData._bgTexture)
  ...
  self._ui.btn_Close:ChangeTextureInfoNameAsync(mapData._btnTexture)
  self._ui.btn_link:ChangeTextureInfoNameAsync(mapData._btnTexture)
  self._ui.btn_EnterBottom:ChangeTextureInfoNameAsync(mapData._btnTexture)
