...
local CashCustomization = {
  ...
  BTN_ChangeMode = UI.getChildControl(Panel_Cash_Customization, "Button_ChangeCustomizeMode"),
...
function CashCustomization:Initialize()
  ...
  self.BTN_ChangeMode:SetShow(_ContentsGroup_MaidActorSystem == true)
...
function CashCustomization_SetPosition()
  ...
  self.BTN_ChangeMode:ComputePos()
  self.BTN_Apply:ComputePos()
  self.BTN_Close:ComputePos()
end
function CashCustomization:UpdateButtonText()
  if _ContentsGroup_MaidActorSystem == false then
    return
  end
  if getCustomizingManager():isShowMaidActorMode() == true then
    self.BTN_ChangeMode:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_CUSTOMIZE_UI_CHANGE_MODE_BTN_NAME_CHARACTER"))
  else
    self.BTN_ChangeMode:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_CUSTOMIZE_UI_CHANGE_MODE_BTN_NAME_MAIDACTOR"))
  end
end
...
function _ingameCustomization_BuffTooltip(isShow)
  ...
  if true == isShow then
    ...
    local desc = PAGetString(Defines.StringSheet_GAME, "LUA_CASH_CUSTOMIZATION_BUFFTOOLTIP_DESC")
...
function HandleClicked_CashCustomization_ChangeMode()
  if _ContentsGroup_MaidActorSystem == false then
    return
  end
...
function CashCustomization:registEventHandler()
  self.BTN_ChangeMode:addInputEvent("Mouse_LUp", "HandleClicked_CashCustomization_ChangeMode()")
