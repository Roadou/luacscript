...
function PaGlobal_GuildWarInfoSmall_All:updateGuild()
  ...
  for ii = 0, guildCount - 1 do
    ...
    if guildWrapper:getGuildNo_s64() == siegeWrapper:getGuildNo() then
      ...
      if false == isSet then
        self._defenceGuildInfo.stc_GuildIcon:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Default/Default_Buttons.dds")
...
function PaGlobal_GuildWarInfoSmall_All:updateOffenceGuildList(content, index)
  ...
  if false == isSet then
    offenceGuildInfo.stc_GuildIcon:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Default/Default_Buttons.dds")
