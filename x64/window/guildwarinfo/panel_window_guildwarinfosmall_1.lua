...
function PaGlobal_GuildWarInfoSmall:updateGuildWarMain(siegeWrapper, guildCount)
  ...
  for ii = 0, guildCount - 1 do
    ...
    if guildWrapper:getGuildNo_s64() == siegeWrapper:getGuildNo() then
      ...
      if false == isSet then
        PaGlobal_GuildWarInfoSmall._ui._defenceGuildInfo.stc_guildIcon:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Default/Default_Buttons.dds")
...
function PaGlobal_GuildWarInfoSmall_updateListContent(contents, index)
  ...
  if false == isSet then
    attackGuildInfo.stc_guildIcon:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Default/Default_Buttons.dds")
