...
function PaGlobal_Skill:initControl()
  ...
  if (isGameTypeJapan() or isGameTypeNA()) and getContentsServiceType() == CppEnums.ContentsServiceType.eContentsServiceType_CBT then
      ...
      if cell:isSkillType() then
        ...
        if 0 == skillNo or false == isLearn then
          ...
          if nil ~= container[index] and false == isLearn and 0 == skillNo then
            ...
            container[index].icon:ChangeTextureInfoNameAsync("")
