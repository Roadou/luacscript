...
function PaGlobalFunc_SkillGroup_CloseRenderMode()
  if Panel_Window_SkillGroup == nil or Panel_Window_SkillGroup:GetShow() == false then
    return
  end
...
function PaGlobalFunc_PaGlobal_SkillGroup_All_OpenReinforce(skillType, skillNo, skillIndex, index)
...
function PaGlobalFunc_PaGlobal_SkillGroup_All_OpenReinforceNew(skillType, index)
  if PaGlobal_SkillReinforce_All == nil then
    return
  end
  if _ContentsGroup_DarkMoonAdditionalBuff == false then
...
function PaGlobalFunc_PaGlobal_SkillGroup_All_ChangeReinforce(skillType, skillNo, skillIndex, index)
  if PaGlobal_SkillReinforce_All == nil then
    return
  end
  if _ContentsGroup_DarkMoonAdditionalBuff == false then
...
function FromClient_SuccessSkillReinforceInSkillGroup()
  if _ContentsGroup_DarkMoonAdditionalBuff == false then
    return
  end
  local self = PaGlobal_SkillGroup
  ...
  self:selectTab(self.eTabIndex.upgrade)
end
