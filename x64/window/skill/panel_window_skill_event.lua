        ...
        if nil ~= skillStaticWrapper then
          local function changeTextureLockIcon(isBlockSkill, isLearnable, isUseable)
            if isBlockSkill then
              ...
              slot.lockIcon:ChangeTextureInfoNameAsync("renewal/pcremaster/remaster_btn_00.dds")
              ...
              slot.lockIcon:ChangeOnTextureInfoNameAsync("renewal/pcremaster/remaster_btn_00.dds")
              local x1, y1, x2, y2 = setTextureUV_Func(slot.lockIcon, 364, 177, 382, 195)
              slot.lockIcon:getOnTexture():setUV(x1, y1, x2, y2)
              slot.lockIcon:ChangeClickTextureInfoNameAsync("renewal/pcremaster/remaster_btn_00.dds")
