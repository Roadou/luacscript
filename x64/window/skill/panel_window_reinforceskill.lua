...
if isGameServiceTypeDev() or isGameTypeNA() or isGameTypeRussia() then
    ...
    if index < normalReinforceSkillCount then
      if index < normalSkill_ReinforceCount then
        ...
        if nil ~= skillSSW then
          ...
          skillSlot._skillSlot:ChangeTextureInfoNameAsync("Icon/" .. skillTypeSSW:getIconPath())
          skillSlot._skillSlotBg:ChangeTextureInfoNameAsync("Renewal/PcRemaster/Remaster_Common_00.dds")
          ...
          skillSlot._skillBg:ChangeTextureInfoNameAsync("Renewal/PcRemaster/Remater_ETC_Skill_00.dds")
        ...
        if reinforcableSkillCount > index then
          skillSlot._skillNoSetBg:ChangeTextureInfoNameAsync("Renewal/PcRemaster/Remater_ETC_Skill_00.dds")
