...
function PaGlobal_SkillGroup_Controller:controlInit_All()
  ...
  if _ContentsGroup_ShowOtherClassSkill == true then
    Panel_Window_SkillGroup_Controller:SetSize(Panel_Window_SkillGroup_All:GetPosX(), getScreenSizeY())
  else
  ...
  if _ContentsGroup_ShowOtherClassSkill == true then
    ui._txt_skillDesc:SetSize((getScreenSizeX() - Panel_Window_SkillGroup_All:GetSizeX() - ui._txt_skillDesc:GetPosX()) * 0.6, ui._txt_skillDesc:GetSizeY())
  else
...
function PaGlobal_SkillGroup_Controller:open(openPanel)
  ...
  if nil == self._renderMode then
    ...
    if _ContentsGroup_ShowOtherClassSkill == true then
      self._renderMode:setPrefunctor(self._renderMode, PaGlobalFunc_SkillGroup_All_PreRenderMode)
      self._renderMode:setClosefunctor(self._renderMode, PaGlobalFunc_SkillGroup_All_Close)
      Panel_Window_SkillGroup_Controller:addInputEvent("Mouse_On", "PaGlobal_SkillGroup_All:handleMOut_FrameOut()")
    else
      ...
      Panel_Window_SkillGroup_Controller:addInputEvent("Mouse_On", "PaGlobal_SkillGroup:HandleMOut_FrameOut()")
    end
  end
...
function PaGlobal_SkillGroup_Controller:HandleEventLUp_PlaySkill()
  local selectSkillNo
  if _ContentsGroup_ShowOtherClassSkill == true then
    selectSkillNo = PaGlobal_SkillGroup_All._selectedSkillNo
  else
    selectSkillNo = PaGlobal_SkillGroup._selectSkillNo
  end
  PaGlobalFunc_SkillGroup_SkillAction(selectSkillNo)
end
function PaGlobal_SkillGroup_Controller:registEventHandler()
  ...
  if _ContentsGroup_ShowOtherClassSkill == true then
    panel:addInputEvent("Mouse_On", "PaGlobal_SkillGroup_All:handleMOut_FrameOut()")
  else
