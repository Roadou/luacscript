...
function PaGlobal_SkillGroup_SelectType:selectTree(selectTreeType, isAwakenGuide)
  ...
  local isReverseSkillType = false
  if _ContentsGroup_ShowOtherClassSkill == true then
    selectedParam = PaGlobal_SkillGroup_All._selectedSkillType
    isReverseSkillType = PaGlobal_SkillGroup_All._isReverseSkillType
  else
    selectedParam = PaGlobal_SkillGroup._selectedTree
    isReverseSkillType = PaGlobal_SkillGroup._isReverseSkillType
  end
  local function resetSkill()
    local playerSkillType = ToClient_GetCurrentPlayerSkillType()
    if _ContentsGroup_ShowOtherClassSkill == true then
      PaGlobal_SkillGroup_All._targetSkillType = selectTreeType
    else
    ...
    if skillPointInfo._remainPoint == skillPointInfo._acquirePoint then
      if _ContentsGroup_ShowOtherClassSkill == true then
        if isReverseSkillType == false and selectedParam == __eSkillTypeParam_Awaken and playerSkillType == __eSkillTypeParam_Normal or isReverseSkillType == true and selectedParam == __eSkillTypeParam_Inherit and playerSkillType == __eSkillTypeParam_Normal or selectedParam == __eSkillTypeParam_Normal then
          PaGlobalFunc_SkillGroup_All_ClearSkills()
        end
      elseif isReverseSkillType == false and selectedParam == __eSkillTypeParam_Awaken and playerSkillType == __eSkillTypeParam_Normal or isReverseSkillType == true and selectedParam == __eSkillTypeParam_Inherit and playerSkillType == __eSkillTypeParam_Normal then
  ...
  if _ContentsGroup_ShowOtherClassSkill == true then
    if selectTreeType ~= selectedParam then
      if isAwakenGuide ~= nil and isAwakenGuide == true then
        resetSkill()
        return
      end
      ...
      if __eSkillTypeParam_Awaken == selectTreeType then
      ...
      elseif __eSkillTypeParam_Inherit == selectTreeType then
  ...
  elseif __eSkillTypeParam_Normal ~= selectedParam and selectTreeType ~= selectedParam then
...
function PaGlobal_SkillGroup_SelectType:setType(selectTreeType)
  ...
  ui._stc_skillTypeTop:ChangeTextureInfoNameAsync(self._texturePath)
  ui._stc_skillTypeBottom:ChangeTextureInfoNameAsync(self._texturePath)
  ...
  if _ContentsGroup_ShowOtherClassSkill == true then
    self._isAwakenGuide = PaGlobalFunc_SkillGroup_All_IsAwakenGuide()
  elseif PaGlobalFunc_SkillGroup_IsAwakenGuide ~= nil then
...
function PaGlobal_SkillGroup_SelectType:setClass(playerClassType, selectTreeType, skillNo)
  ...
  ui._stc_bigCharacter:ChangeTextureInfoNameAsync(currentData._bigTexture)
...
function PaGlobal_SkillGroup_SelectType:setSkill(skillNo)
  ...
  ui._stc_skillSlot:ChangeTextureInfoNameAsync("Icon/" .. skillTypeSSW:getIconPath())
  ...
  if skillLevelInfo._learnable == false and skillLevelInfo._usable == true and skillTypeStaticWrapper:get()._isSettableQuickSlot == true and (PaGlobal_SkillGroup ~= nil and PaGlobal_SkillGroup._selectedTree == __eSkillTypeParam_Awaken or PaGlobal_SkillGroup_All ~= nil and PaGlobal_SkillGroup_All._selectedSkillType == __eSkillTypeParam_Awaken) then
