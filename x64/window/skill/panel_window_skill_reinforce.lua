...
function skillReinforce:update(skillType, skillNo, optionIndex, reinforceSkillIndex, skillIndex)
  ...
  if nil == skillIndex then
    if nil == skillNo then
      ...
      self.skillListSlot:ChangeTextureInfoNameAsync("Icon/" .. skillTypeSSW:getIconPath())
...
function skillReinforce_SetSkill(skillNo, index)
  ...
  self.effectSkillIconSlot:ChangeTextureInfoNameAsync("Icon/" .. skillTypeSSW:getIconPath())
...
function SkillReinforce_Doit()
  ...
  if nil == skillReinforce._beforeSkillIndex then
    if _isAddOption then
      ToClient_RequestChangeAwakeningBitFlag(__eSkillReinforceType_NonPlayer, skillReinforce._currentSkillIndex, skillReinforce._currentOptionIndex, skillReinforce._currentOptionIndex2)
    else
      ToClient_RequestSkillAwakening(__eSkillReinforceType_NonPlayer, skillReinforce._currentSkillIndex, skillReinforce._currentOptionIndex, skillReinforce._currentOptionIndex2)
    end
  else
    ToClient_RequestChangeAwakeningSkill(__eSkillReinforceType_NonPlayer, skillReinforce._beforeSkillIndex, skillReinforce._currentSkillIndex, skillReinforce._currentOptionIndex, skillReinforce._currentOptionIndex2)
  end
...
function Panel_SkillReinforce_Show(skillType, skillNo, skillIndex)
  ...
  skillReinforce.effectSkillIconSlot:ChangeTextureInfoNameAsync("")
