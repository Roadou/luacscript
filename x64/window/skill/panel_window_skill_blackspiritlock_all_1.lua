function PaGlobal_BlackSpiritSkillLock_All:initialize()
  ...
  PaGlobal_BlackSpiritSkillLock_All._isConsole = _ContentsGroup_UsePadSnapping
...
function PaGlobal_BlackSpiritSkillLock_All:setSkill()
  ...
  if true == self._isConsole and false == _ContentsGroup_UISkillGroupTreeLayOut then
...
function PaGlobal_BlackSpiritSkillLock_All:listUpdate(content, key)
  ...
  if nil ~= skillWrapper then
    ...
    stc_icon:ChangeTextureInfoNameAsync("icon/" .. skillTypeSSW:getIconPath())
