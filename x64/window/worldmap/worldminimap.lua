...
function PaGlobal_WorldMiniMap:resetPanelSize()
  ...
  self._ui.btn_changeScale:ChangeTextureInfoNameAsync(iconPath)
  ...
  self._ui.btn_changeScale:ChangeOnTextureInfoNameAsync(iconPath)
  ...
  self._ui.btn_changeScale:ChangeClickTextureInfoNameAsync(iconPath)
...
function worldMiniMap_updateRegion(isSafeZone, isArenaZone, isDesert, isAtoraxion, regionType, regionKey, areaName, territoryName)
  local self = PaGlobal_WorldMiniMap
  ...
  self._ui.regionName:SetText(areaName)
  ...
  if nil ~= linkSiegeWrapper then
    local villageWarZone = linkSiegeWrapper:isVillageWarZone()
