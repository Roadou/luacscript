  ...
  if nil ~= progressingInfo then
    if progressingInfo:getNeedLop() then
      if false == self._value.isAnimal then
        self._ui.static_Icon_Work1:ChangeTextureInfoNameAsync(self._texture.plantPath)
        ...
        self._ui.static_Icon_Work1:ChangeTextureInfoNameAsync(self._texture.animalPath)
    ...
    if progressingInfo:getNeedPestControl() then
      if false == self._value.isAnimal then
        self._ui.static_Icon_Work2:ChangeTextureInfoNameAsync(self._texture.plantPath)
        ...
        self._ui.static_Icon_Work2:ChangeTextureInfoNameAsync(self._texture.animalPath)
...
function Panel_Window_InstallationMode_Plant_info:changeText()
  if self._value.isAnimal then
    ...
    self._ui.staticText_Work1Dec:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_HOUSEING_FARMINFO_NEW_PRUNINGDESC_ALL"))
    self._ui.staticText_Work2Dec:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_HOUSEING_FARMINFO_NEW_INSECTDAMEGEDESC_ALL"))
  end
end
