...
function Panel_Window_InstallationMode_Farm_info:setFarmInfo()
  ...
  if true == isInstalledWaterWay then
    self._ui.static_Icon_WaterWay:ChangeTextureInfoNameAsync(self._texture.path)
  ...
  if true == isInstalledScarecrow then
    self._ui.static_Icon_Scarecrow:ChangeTextureInfoNameAsync(self._texture.path)
