function PaGlobal_BarterInfoSearch:init()
  ...
  self._ui._keyGuide_LT_A = UI.getChildControl(self._ui._stc_keyGuideBG, "StaticText_KeyGuide_LT_A_ConsoleUI")
  ...
  self._ui._keyGuide_LT_A:SetShow(true == self._isConsole)
  ...
  self._ui._txt_barterPointValue = UI.getChildControl(self._ui._searchBar, "StaticText_BarterPointValue")
  self._ui._txt_totalExchangeCount = UI.getChildControl(self._ui._searchBar, "StaticText_TotalRemainCountTitle")
  self._ui._txt_barterPointValue:SetIgnore(false)
  self._ui._txt_barterPointValue:addInputEvent("Mouse_On", "HandleEventOnOut_BarterInfoSearch_All_BarterPointTooltip(true)")
  self._ui._txt_barterPointValue:addInputEvent("Mouse_Out", "HandleEventOnOut_BarterInfoSearch_All_BarterPointTooltip(false)")
  self._ui._txt_totalExchangeCount:SetIgnore(false)
  self._ui._txt_totalExchangeCount:addInputEvent("Mouse_On", "HandleEventOnOut_BarterInfoSearch_All_ExchangeCountTooltip(true)")
  self._ui._txt_totalExchangeCount:addInputEvent("Mouse_Out", "HandleEventOnOut_BarterInfoSearch_All_ExchangeCountTooltip(false)")
  ...
  self._ui._filter = UI.getChildControl(self._ui._stc_middleGroup, "Combobox_Gender")
  ...
  self._ui._valueLimit = UI.getChildControl(self._ui._stc_middleGroup, "Combobox_Rate")
  ...
  self._ui._category = UI.getChildControl(self._ui._stc_middleGroup, "Combobox_Depth")
  ...
  self._ui._btn_position = UI.getChildControl(self._ui._stc_middleGroup, "Button_Position")
  ...
  self._ui._btn_refresh = UI.getChildControl(self._ui._stc_middleGroup, "Button_Reload")
  if true == self._isConsole then
    Panel_Window_Barter_Search:registerPadEvent(__eConsoleUIPadEvent_Up_Y, "PaGlobal_BarterInfoSearch:refreshAllCheckbox()")
  else
    self._ui._btn_refresh:addInputEvent("Mouse_LUp", "PaGlobal_BarterInfoSearch:refreshAllCheckbox()")
  end
  self._ui._btn_refresh:addInputEvent("Mouse_On", "HandleEventMouseOver_BarterInfoSearch_All_ShowRefreshTooltip(true)")
  self._ui._btn_refresh:addInputEvent("Mouse_Out", "HandleEventMouseOver_BarterInfoSearch_All_ShowRefreshTooltip(false)")
  if true == self._isConsole then
    ...
    Panel_Window_Barter_Search:registerPadEvent(__eConsoleUIPadEvent_LTPress_A, "PaGlobal_BarterInfoSearch:moveToTop()")
  end
  ...
  self._ui._chk_hideComplete = UI.getChildControl(self._ui._stc_checkButtonGroup, "CheckButton_1")
  self._ui._chk_hasServantInventory = UI.getChildControl(self._ui._stc_checkButtonGroup, "CheckButton_2")
  self._ui._stc_consoleChoicePanelGroup = UI.getChildControl(self._ui._mainBg, "Static_ConsoleChoicePanelGroup")
  self._ui._btn_fromItem_console_shipToWarehouse = UI.getChildControl(self._ui._stc_consoleChoicePanelGroup, "Button_FromItemShipToWarehouse")
  self._ui._btn_fromItem_console_warehouseToShip = UI.getChildControl(self._ui._stc_consoleChoicePanelGroup, "Button_FromItemWarehouseToShip")
  self._ui._btn_toItem_console_shipToWarehouse = UI.getChildControl(self._ui._stc_consoleChoicePanelGroup, "Button_TargetItemShipToWarehouse")
  self._ui._btn_toItem_console_warehouseToShip = UI.getChildControl(self._ui._stc_consoleChoicePanelGroup, "Button_TargetItemWarehouseToShip")
  local maxSizeX = self._ui._btn_fromItem_console_shipToWarehouse:GetTextSizeX()
  maxSizeX = math.max(self._ui._btn_fromItem_console_warehouseToShip:GetTextSizeX())
  maxSizeX = math.max(self._ui._btn_toItem_console_shipToWarehouse:GetTextSizeX())
  maxSizeX = math.max(self._ui._btn_toItem_console_warehouseToShip:GetTextSizeX())
  maxSizeX = maxSizeX + 50
  self._ui._stc_consoleChoicePanelGroup:SetSize(maxSizeX * 2, self._ui._stc_consoleChoicePanelGroup:GetSizeY())
  self._ui._btn_fromItem_console_shipToWarehouse:SetSize(maxSizeX, self._ui._btn_fromItem_console_shipToWarehouse:GetSizeY())
  self._ui._btn_fromItem_console_warehouseToShip:SetSize(maxSizeX, self._ui._btn_fromItem_console_warehouseToShip:GetSizeY())
  self._ui._btn_toItem_console_shipToWarehouse:SetSize(maxSizeX, self._ui._btn_toItem_console_shipToWarehouse:GetSizeY())
  self._ui._btn_toItem_console_warehouseToShip:SetSize(maxSizeX, self._ui._btn_toItem_console_warehouseToShip:GetSizeY())
  self._ui._btn_toItem_console_shipToWarehouse:SetPosX(maxSizeX)
  self._ui._btn_toItem_console_warehouseToShip:SetPosX(maxSizeX)
  local rightPointX = maxSizeX * 2 + self._ui._stc_consoleChoicePanelGroup:GetPosX()
  if rightPointX > Panel_Window_Barter_Search:GetSizeX() then
    local gapX = rightPointX - Panel_Window_Barter_Search:GetSizeX()
    self._ui._stc_consoleChoicePanelGroup:SetPosX(self._ui._stc_consoleChoicePanelGroup:GetPosX() - (gapX + 30))
  end
  if true == _ContentsGroup_Barter_Renew then
  ...
  if _ContentsGroup_BarterConvenienceRenewal == true then
    self._ui._chk_hideComplete:addInputEvent("Mouse_On", "PaGlobalFunc_ShowHideCompleteToolTip()")
    self._ui._chk_hideComplete:addInputEvent("Mouse_Out", "TooltipSimple_Hide()")
  end
  self._ui.txt_checkDesc = UI.getChildControl(self._ui._chk_hideComplete, "StaticText_1")
  if _ContentsGroup_BarterConvenienceRenewal == true then
    self._ui.txt_checkDesc:SetShow(false)
  else
  ...
  if _ContentsGroup_BarterConvenienceRenewal == true then
    self._ui._chk_hasServantInventory:addInputEvent("Mouse_LUp", "PaGlobal_BarterInfoSearch:refresh()")
    self._ui._chk_hasServantInventory:addInputEvent("Mouse_On", "PaGlobalFunc_ShowOwnOnlyToolTip()")
    self._ui._chk_hasServantInventory:addInputEvent("Mouse_Out", "TooltipSimple_Hide()")
  end
  self._ui._btnResetBarterSeed = UI.getChildControl(self._ui._searchBar, "Button_BarterRefresh")
  self._ui._btnResetBarterSeed:addInputEvent("Mouse_LUp", "HandleEventLUp_BarterInfoSearch_All_requestChangeBarterList()")
  self._ui._btnResetBarterSeed:addInputEvent("Mouse_On", "HandleEventMouseOver_BarterInfoSearch_All_ShowChangeBarterTooltip(true)")
  self._ui._btnResetBarterSeed:addInputEvent("Mouse_Out", "HandleEventMouseOver_BarterInfoSearch_All_ShowChangeBarterTooltip(false)")
  Panel_Window_Barter_Search:ignorePadSnapMoveToOtherPanelUpdate(true)
  registerEvent("FromClient_ServantInventoryUpdate", "BarterInfoSearch_All_List2UpdateVisible")
  registerEvent("FromClient_WarehouseUpdate", "BarterInfoSearch_All_List2UpdateVisible")
  self._ui._chk_hasServantInventory:SetShow(false)
  if _ContentsGroup_BarterConvenienceRenewal == true then
    self._ui._chk_hasServantInventory:SetShow(true)
  end
  if self._isConsole == true then
    self._ui._keyGuide_DPadL:SetText(PAGetString(Defines.StringSheet_RESOURCE, "COMMON_KEYGUIDE_CONSOLE_OTHERBARTER"))
  end
  self._isInit = true
end
...
function PaGlobal_BarterInfoSearch:open()
  ...
  self._ui._txt_totalExchangeCount:SetSize(self._ui._txt_totalExchangeCount:GetTextSizeX(), self._ui._txt_totalExchangeCount:GetSizeY())
  self:refresh()
  ...
  self._ui._txt_barterPointValue:SetText(PAGetStringParam2(Defines.StringSheet_GAME, "LUA_BARTERINFO_BARTER_REFRESH", "param1", tostring(remainSeedChangeCount), "param2", tostring(maxSeedChangeCount)))
  ...
  if true == _ContentsGroup_RenewUI and true == Panel_Window_CargoLoading_ALL:GetShow() then
    ...
    Panel_Window_CargoLoading_ALL:SetPosX(Panel_Window_Barter_Search:GetPosX() - Panel_Window_CargoLoading_ALL:GetSizeX() - 10)
...
function PaGlobal_BarterInfoSearch:close()
  ...
  self._isOpenedByCargoLoading = false
...
function PaGlobal_BarterInfoSearch:refresh()
  ...
  if true == _ContentsGroup_Barter_Renew then
    ...
    if self._ui._category:GetTextSizeX() > 115 then
      local categoryString = self._ui._category:GetText()
      categoryString = string.sub(categoryString, 1, 12)
      categoryString = categoryString .. "..."
      self._ui._category:SetText(categoryString)
      self._ui._category:addInputEvent("Mouse_On", "HandleEventMouseOver_BarterInfoSearch_All_ShowCategoryTextTooltip(true, " .. self._selectCategoryIndex .. ")")
      self._ui._category:addInputEvent("Mouse_Out", "HandleEventMouseOver_BarterInfoSearch_All_ShowCategoryTextTooltip(false)")
    else
      self._ui._category:addInputEvent("Mouse_On", "")
      self._ui._category:addInputEvent("Mouse_Out", "")
    end
  ...
  if self._ui._valueLimit:GetShow() == false then
    if self._ui._category:GetShow() == false then
      self._ui._filter:SetSpanSize(105, self._ui._filter:GetSpanSize().y)
    else
      self._ui._filter:SetSpanSize(270, self._ui._filter:GetSpanSize().y)
    end
  else
    self._ui._filter:SetSpanSize(435, self._ui._filter:GetSpanSize().y)
  end
  local regionList = {}
  if true == _ContentsGroup_Barter_Renew then
    if __eBarterType_Normal == barterType then
      ...
      regionList = ToClient_barterRegionList(self._ui._edit:GetEditText(), self._selectFilterIndex, self._isOpenedByCargoLoading, self._ui._chk_hasServantInventory:IsCheck())
    end
  else
    regionList = ToClient_barterRegionList(self._ui._edit:GetEditText(), self._selectFilterIndex, self._isOpenedByCargoLoading, self._ui._chk_hasServantInventory:IsCheck())
  end
...
function PaGlobal_BarterInfoSearch:refreshAllCheckbox()
  if Panel_Window_Barter_Search == nil then
    return
  end
  if self._selectFilterIndex == __eItemGradeTypeCount and self._selectValueLimitIndex == 1 and self._selectCategoryIndex == __eBarterCategory_Count then
    Proc_ShowMessage_Ack(PAGetString(Defines.StringSheet_GAME, "LUA_BARTERINFO_BARTER_FILTER_RESET_FAIL"))
    return
  end
  local messageData = {
    title = PAGetString(Defines.StringSheet_GAME, "LUA_ALERT_DEFAULT_TITLE"),
    content = PAGetString(Defines.StringSheet_GAME, "LUA_BARTERINFO_BARTER_FILTER_RESET_MESSAGE"),
    functionApply = PaGlobal_BarterInfoSearch_All_RefreshAllCheckboxConfirm,
    functionNo = MessageBox_Empty_function,
    priority = CppEnums.PAUIMB_PRIORITY.PAUIMB_PRIORITY_LOW
  }
  MessageBox.showMessageBox(messageData)
end
function PaGlobal_BarterInfoSearch:moveToTop()
  if Panel_Window_Barter_Search == nil then
    return
  end
  if self._isConsole == true then
  ...
  self._ui._list2_barterInfoList:moveTopIndex()
end
