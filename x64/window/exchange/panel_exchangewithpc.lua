  ...
  for ii = 1, exchangePC.MAX_SLOT_COUNT do
    if true == isOtherLock then
      if 0 == _otherSlot[ii] then
        exchangePC._otherSlotsBG[ii - 1].BG:ChangeTextureInfoNameAsync("renewal/frame/console_frame_00.dds")
      ...
      exchangePC._otherSlotsBG[ii - 1].BG:ChangeTextureInfoNameAsync("renewal/pcremaster/remaster_common_00.dds")
  ...
  for ii = 1, exchangePC.MAX_SLOT_COUNT do
    if true == isMyLock then
      if 0 == _mySlot[ii] then
        exchangePC._mySlotsBG[ii - 1].BG:ChangeTextureInfoNameAsync("renewal/frame/console_frame_00.dds")
      ...
      exchangePC._mySlotsBG[ii - 1].BG:ChangeTextureInfoNameAsync("renewal/pcremaster/remaster_common_00.dds")
