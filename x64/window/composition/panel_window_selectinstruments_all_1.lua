...
function PaGlobal_SelectInstruments_All:setTextureControl(control, trackType, index)
  ...
  control:ChangeTextureInfoNameAsync("Combine/Etc/Combine_Etc_Concert_00.dds")
  control:ChangeOnTextureInfoNameAsync("Combine/Etc/Combine_Etc_Concert_00.dds")
  control:ChangeClickTextureInfoNameAsync("Combine/Etc/Combine_Etc_Concert_00.dds")
...
function PaGlobal_SelectInstruments_All_ListControlCreate(control, key)
  ...
  btn_Slot:ChangeTextureInfoNameAsync("Combine/Etc/Combine_Etc_Concert_00.dds")
  btn_Slot:ChangeOnTextureInfoNameAsync("Combine/Etc/Combine_Etc_Concert_00.dds")
  btn_Slot:ChangeClickTextureInfoNameAsync("Combine/Etc/Combine_Etc_Concert_00.dds")
