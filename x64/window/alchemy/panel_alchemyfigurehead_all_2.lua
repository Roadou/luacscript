...
function PaGlobal_AlchemyFigureHead_All_StuffFilter(slotNo, itemWrapper, count, inventoryType)
  ...
  if whereType == CppEnums.ItemWhereType.eEnchantInventory then
    return returnValue
  end
...
function FromClient_AlchemyFigureHead_AllUpgrade(itemwhereType, slotNo, exp)
  ...
  ToClient_RequestNakMessageRenewelWithStringAndIcon(__eNakMessage_AlchemyUpgradeFail, mainMsg, subMsg, iconPath, iconUV)
end
function FromClient_AlchemyFigureHead_AllChange(whereType, slotNo)
  ...
  local iconPath = "Icon/" .. itemWrapper:getStaticStatus():getIconPath()
  local iconUV = float4(0, 0, 42, 42)
  ToClient_RequestNakMessageRenewelWithStringAndIcon(__eNakMessage_AlchemyUpgradeSuccess, mainMsg, subMsg, iconPath, iconUV)
  Inventory_SetFunctor(PaGlobal_AlchemyFigureHead_All_FigureHeadFilter, PaGlobal_AlchemyFigureHead_All_FigureHeadRfunction, nil, nil)
end
function FromClient_AlchemyFigureHead_AllChangeFailedByDown(whereType, slotNo)
  ...
  local iconPath = "Icon/" .. itemWrapper:getStaticStatus():getIconPath()
  local iconUV = float4(0, 0, 42, 42)
  ToClient_RequestNakMessageRenewelWithStringAndIcon(__eNakMessage_AlchemyUpgradeDown, mainMsg, subMsg, iconPath, iconUV)
  Inventory_SetFunctor(PaGlobal_AlchemyFigureHead_All_FigureHeadFilter, PaGlobal_AlchemyFigureHead_All_FigureHeadRfunction, nil, nil)
end
