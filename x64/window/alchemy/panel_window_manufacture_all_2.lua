...
function PaGlobal_Manufacture_All:hasNoneStackItem(slotNo)
  ...
  if hasNoneStackItemCount > 0 then
    ...
    if false == self._isConsole then
      self._ui.chk_identicalItem:SetCheck(false)
      if PaGlobal_Manufacture_All._materialSlotNoList[0] ~= PaGlobal_Manufacture_All._defaultSlotNo and PaGlobal_Manufacture_All._materialSlotNoList[1] == PaGlobal_Manufacture_All._defaultSlotNo then
        self._ui.chk_identicalItem:SetShow(true)
      else
        PaGlobal_Manufacture_All._noneStackItemCheck = false
        self._ui.chk_identicalItem:SetShow(false)
      end
    elseif PaGlobal_Manufacture_All._materialSlotNoList[0] ~= PaGlobal_Manufacture_All._defaultSlotNo and PaGlobal_Manufacture_All._materialSlotNoList[1] == PaGlobal_Manufacture_All._defaultSlotNo then
