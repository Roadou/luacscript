...
function PaGlobal_Alchemy_All_StartAlchemy(countProduction)
  ...
  EventProgressBarShow(true, progressBarTimeSec, false, 0, true == PaGlobal_Alchemy_All._isCook and 7 or 9)
...
function FromClient_Alchemy_All_AlchemyFailAck(isSuccess, hint, alchemyType, strErr, bDoingMassProduction)
  ...
  elseif 1 == hint or 2 == hint or 3 == hint then
    if hint == 1 then
      ToClient_RequestNakMessageRenewel(__eNakMessage_AlchemyCookFail1)
    elseif hint == 2 then
      ToClient_RequestNakMessageRenewel(__eNakMessage_AlchemyCookFail2)
    elseif hint == 3 then
      ToClient_RequestNakMessageRenewel(__eNakMessage_AlchemyCookFail3)
    end
