...
registerEvent("FromClient_PetChangeName", "FromClient_PetChangeName_Finish")
registerEvent("FromClient_CheckPetNameChangeItemExist", "FromClient_CheckPetNameChangeItemExist")
function FromClient_PetList_All_Init()
  PaGlobal_PetList_All:initialize()
  PaGlobal_PetRegister_All:initialize()
end
function FromClient_PetChangeName_Finish()
  PaGlobal_PetList_All:updatePetList()
  Proc_ShowMessage_Ack(PAGetString(Defines.StringSheet_GAME, "LUA_PET_CHANGENAME_ACK"))
end
function FromClient_CheckPetNameChangeItemExist(isExist)
  if isExist == true then
    PaGlobal_PetRegister_All:changePetName()
  else
    PaGlobalFunc_EasyBuy_Open(132, nil, false)
  end
end
