  ...
  if unSealPetCount > 0 then
    for index = 0, self._maxUnsealCount - 1 do
      ...
      if nil ~= PetUnSealData then
        ...
        self._petIcons[index]._iconPet:ChangeTextureInfoNameAsync(unsealIconPath)
...
function PaGlobal_PetControl_All:updateCommandButton(index)
  ...
  self._ui.Btn_Play:ChangeTextureInfoNameAsync("Combine/Etc/Combine_Etc_Pet_00.dds")
  local x1, y1, x2, y2
