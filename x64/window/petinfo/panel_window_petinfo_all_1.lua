    ...
    if petNo == PcPetData:getPcPetNo() then
      ...
      for index = 1, self._actionCount do
        ...
        if true == isLearn then
          ...
          self._actionSlot[learnedActionCount]:ChangeTextureInfoNameAsync("Icon/" .. actionStaticStatus:getIconPath())
          if self._isConsole then
      ...
      if nil ~= skillStaticStatus then
        ...
        if nil ~= skillTypeStaticWrapper then
          ...
          self._skillSlot[uiIdx]:ChangeTextureInfoNameAsync("Icon/" .. skillTypeStaticWrapper:getIconPath())
          if self._isConsole then
      ...
      for skill_idx = 0, petSkillMaxCount - 1 do
        ...
        if true == isLearn and nil ~= skillStaticStatus then
          ...
          if nil ~= skillTypeStaticWrapper then
            ...
            self._skillSlot[uiIdx]:ChangeTextureInfoNameAsync("")
      ...
      self._ui.stc_PetIcon:ChangeTextureInfoNameAsync(iconPath)
