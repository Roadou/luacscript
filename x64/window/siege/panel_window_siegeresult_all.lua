PaGlobal_Window_SiegeResult_All = {
  _ui = {
...
runLua("UI_Data/Script/Window/Siege/Panel_Window_SiegeResult_All_1.lua")
runLua("UI_Data/Script/Window/Siege/Panel_Window_SiegeResult_All_2.lua")
registerEvent("FromClient_luaLoadComplete", "FromClient_Window_SiegeResult_All_Init")
function FromClient_Window_SiegeResult_All_Init()
  PaGlobal_Window_SiegeResult_All:initialize()
end
