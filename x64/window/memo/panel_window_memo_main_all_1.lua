function PaGlobal_Memo_All:initialize()
  ...
  if _ContentsGroup_MemoRenewal == true and isGameTypeCH() == false then
    PaGlobal_Memo_All._stickyMinSizeX = 270
    PaGlobal_Memo_All._stickyMinSizeY = 150
  end
end
function PaGlobal_Memo_All:registEventHandler()
  ...
  registerEvent("FromClient_SaveMemo", "FromClient_SaveMemo")
  if _ContentsGroup_MemoRenewal == true then
    registerEvent("FromClient_SubAppUIResize", "HandleEventLUp_Memo_Main_All_StickyEnd")
    registerEvent("FromClient_CheckStickyMemoFontButton", "FromClient_CheckStickyMemoFontButton")
  end
end
...
function PaGlobal_Memo_All:AddMemo()
  ...
  PaGlobal_Memo_All:ListUpdate()
  PaGlobal_Memo_All:StickyClickedContent(newId)
end
function PaGlobal_Memo_All:Save(saveMode, inputId)
  ...
  if content ~= "" and _ContentsOption_CH_CheckProhibitedWord == true and saveMode ~= self._SaveMode.SETTING then
