...
function MarketPlaceSell:setNameAndEnchantLevel(enchantLevel, itemType, itemName, itemClassify, isSpecialEnchantItem, isSpecialAccessory)
  local nameStr = ""
...
function MarketPlaceSell:open(itemKey, enchantLevel, enchantMinLevel, standardPrice_s64, itemCount_s64, isSealed, biddingSellListCount, lastPrice_s64, lastTime_utc, totalCount_s64, minPrice, maxPrice)
  ...
  local itemNameStr = PaGlobalFunc_MarketPlace_setNameAndEnchantLevel(enchantLevel, itemSSW:getItemType(), itemSSW:getName(), itemSSW:getItemClassify(), itemSSW:isSpecialEnchantItem(), itemSSW:isSpecialAccessory())
