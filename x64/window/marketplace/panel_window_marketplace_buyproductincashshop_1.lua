...
function Paglobal_MarketPlace_BuyProductInCashShop_updateListContent(contents, index)
  ...
  if nil == product:getPackageIcon() then
    productUiInfo._img:ChangeTextureInfoNameAsync("New_Icon/09_Cash/03_Product/00021034.dds")
  else
    productUiInfo._img:ChangeTextureInfoNameAsync(product:getPackageIcon())
  end
  ...
  for jj = 0, itemListCount - 1 do
    ...
    productUiInfo._iconList[jj]:ChangeTextureInfoNameAsync("icon/" .. item:getIconPath())
...
function PaGlobal_MarKetPlace_BuyProductInCashShop:borderChange(border, tagType)
  if 7 == tagType then
    border:ChangeTextureInfoNameAsync("new_ui_common_forlua/window/ingamecashshop/CashShop_04.dds")
  else
    border:ChangeTextureInfoNameAsync("new_ui_common_forlua/window/ingamecashshop/CashShop_03.dds")
  end
