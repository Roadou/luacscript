...
function PaGlobalFunc_MarketPlace_Wallet_CreateControlWalletItemList(contents, key)
  ...
  if itemMyWalletInfo ~= nil then
    ...
    if nil ~= itemWrapper then
      ...
      local itemNameStr = PaGlobalFunc_MarketPlace_setNameAndEnchantLevel(itemWrapper:get()._key:getEnchantLevel(), itemWrapper:getItemType(), itemWrapper:getName(), itemWrapper:getItemClassify(), itemWrapper:isSpecialEnchantItem(), itemWrapper:isSpecialAccessory())
...
function PaGlobalFunc_MarketPlace_Wallet_CreateControlMyBiddingList(contents, key)
  ...
  if self._selectedBiddingTabIndex == self._biddingTabIdx.sell then
    ...
    local itemNameStr = PaGlobalFunc_MarketPlace_setNameAndEnchantLevel(chooseEnchantLevel, itemSSW:getItemType(), itemSSW:getName(), itemSSW:getItemClassify(), itemSSW:isSpecialEnchantItem(), itemSSW:isSpecialAccessory())
