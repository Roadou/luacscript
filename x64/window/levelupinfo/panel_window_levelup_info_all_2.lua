...
function HandleEventLUp_Levelup_Info_All_LeftOpen()
  ...
  PaGlobal_Levelup_Info_All._ui._btn_Unfold:ChangeTextureInfoNameAsync("combine/btn/combine_btn_00.dds")
...
function HandleEventLUp_LevelUp_Info_All_LearnableSkillGotoFocusEffect(skillNo)
  ...
  if _ContentsGroup_ShowOtherClassSkill == true then
    PaGlobalFunc_SkillGroup_All_OpenAndSelectTab(PaGlobalFunc_SkillGroup_All_GetConvertTabIndex(skillType))
  ...
  if _ContentsGroup_ShowOtherClassSkill == true then
    PaGlobalFunc_SkillGroup_All_FindSkillGroupAndFocusEffect(skillNo)
  else
...
function HandleEventLUp_LevelUp_Info_All_StudyLearnSkill(skillNo)
  ...
  elseif _ContentsGroup_ShowOtherClassSkill == true then
    PaGlobal_SkillGroup_All:handleEventLUp_LearnSkill(skillNo)
  elseif false == _ContentsGroup_UISkillGroupTreeLayOut then
