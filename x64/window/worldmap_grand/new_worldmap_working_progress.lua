...
function WorkingProgress_Init()
  ...
  for idx = 0, workingcnt - 1 do
    ...
    WorkingProgress._itemicon:ChangeTextureInfoNameAsync("icon/" .. workingIcon)
...
function WorkingProgressUpdate()
  ...
  if 0 == workingcnt and 0 ~= WorkingProgress._saveProgress then
    ...
    WorkingProgress._itemicon:ChangeTextureInfoNameAsync("icon/" .. WorkingProgress._saveIcon)
