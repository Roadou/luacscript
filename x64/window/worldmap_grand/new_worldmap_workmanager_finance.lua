...
function Work_Info:_Update()
  defalut_Control._workInfo_Default._Icon:ChangeTextureInfoNameAsync(self._finance_Icon)
  ...
  for idx = 1, _resource_SlotMax do
    ...
    if nil ~= _data then
      ...
      if gradeType > 0 and gradeType <= #UI.itemSlotConfig.borderTexture then
        defalut_Control._work_Info._Resource_Icon_Border[idx]:ChangeTextureInfoNameAsync(UI.itemSlotConfig.borderTexture[gradeType].texture)
      ...
      defalut_Control._work_Info._Resource_Icon[idx]:ChangeTextureInfoNameAsync(_data._itemIcon)
