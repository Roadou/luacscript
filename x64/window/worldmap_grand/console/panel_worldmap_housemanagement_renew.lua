...
function WorldMapHouseManager:update(houseInfoSSWrapper)
  ...
  self._ui.stc_houseImage:ChangeTextureInfoNameAsync(self._screenShotPath)
...
function WorldMapHouseManager:updateTypeList(houseInfoSSWrapper)
  ...
  for ii = 1, self._houseTypeMax do
    ...
    if ii <= self._receipeCount then
      ...
      txt_name:ChangeTextureInfoNameAsync(CppEnums.HouseIconType_ConsoleFilterTexture.path)
...
function WorldMapHouseManager:updateRentedHouse(rentHouse, houseInfoStaticStatusWrapper)
  ...
  for ii = 1, self._starCountMax do
    ...
    stc_stars[ii]:ChangeTextureInfoNameAsync("renewal/ui_icon/console_icon_worldmap_00.dds")
  ...
  icon:SetShow(true)
  icon:ChangeTextureInfoNameAsync(CppEnums.HouseIconType_ConsoleFilterTexture.path)
...
function Input_WorldMapHouseManager_SetUseType(index)
  ...
  self._ui.txt_manageTitle:ChangeTextureInfoNameAsync(CppEnums.HouseIconType_ConsoleFilterTexture.path)
