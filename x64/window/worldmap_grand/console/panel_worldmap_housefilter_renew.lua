...
function Window_WorldMap_HouseFilterInfo:SetPurposeFilter()
  ...
  if nil == allFilter then
    ...
    allIconControl:ChangeTextureInfoNameAsync(CppEnums.HouseIconType_ConsoleFilterTexture.path)
  ...
  for index = 1, count do
    ...
    filter._icon:ChangeTextureInfoNameAsync(CppEnums.HouseIconType_ConsoleFilterTexture.path)
