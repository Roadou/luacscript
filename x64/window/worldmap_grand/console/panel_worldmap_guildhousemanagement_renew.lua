...
function WorldMapGuildHouseManager:update()
  ...
  for ii = 1, #self._ui.rdo_houseTypes do
    for jj = 1, self._starCountMax do
      ...
      stc_stars[jj]:ChangeTextureInfoNameAsync("renewal/ui_icon/console_icon_worldmap_00.dds")
...
function WorldMapGuildHouseManager:updateHouseImage()
  if nil ~= guildHouse_Img[self._houseKey] then
    self._ui.stc_houseImage:ChangeTextureInfoNameAsync(guildHouse_Img[self._houseKey])
  else
    self._ui.stc_houseImage:ChangeTextureInfoNameAsync("icon/new_icon/03_etc/06_housing/1201.dds")
  end
...
function WorldMapGuildHouseManager:updateTypeList()
  ...
  for ii = 1, self._houseTypeMax do
    ...
    if nil ~= houseInfoCraftWrapper and CppEnums.eHouseUseType.Depot ~= houseInfoCraftWrapper:getGroupType() then
      ...
      txt_name:ChangeTextureInfoNameAsync("renewal/ui_icon/console_icon_worldmap_00.dds")
      local x1, y1, x2, y2
...
function WorldMapGuildHouseManager:updateGuildInfo()
  ...
  if nil ~= markData then
    ...
    self._ui.stc_GuildIconBG:ChangeTextureInfoNameAsync("renewal/commonicon/guildmark/console_icon_guildmark_00.dds")
    ...
    self._ui.stc_GuildIcon:ChangeTextureInfoNameAsync("renewal/commonicon/guildmark/console_icon_guildmark_00.dds")
