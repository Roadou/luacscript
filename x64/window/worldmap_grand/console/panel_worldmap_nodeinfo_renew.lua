...
function Window_WorldMap_NodeInfo:SetNationIcon()
  ...
  if PAGetString(Defines.StringSheet_GAME, "LUA_WORLDMAP_NODE_CONTRY_KALPEON") == tostring(getNodeNationalName(nodeStaticStatus)) then
    nationIcon:ChangeTextureInfoNameAsync("new_ui_common_forlua/widget/dialogue/Dialogue_Etc_00.dds")
...
function Window_WorldMap_NodeInfo:SetTerritoryIcon()
  ...
  if PAGetString(Defines.StringSheet_GAME, "LUA_WORLDMAP_NODE_BALENOS") == tostring(getNodeTerritoryName(nodeStaticStatus)) then
    territoryIcon:ChangeTextureInfoNameAsync("new_ui_common_forlua/widget/dialogue/dialogue_etc_00.dds")
...
function Window_WorldMap_NodeInfo:SetOccupyInfoFromNode()
  ...
  if true == hasOccupantExist then
    ...
    if nil ~= markData then
      self._ui._static_GuildIconBG:ChangeTextureInfoNameAsync("renewal/commonicon/guildmark/console_icon_guildmark_00.dds")
      ...
      self._ui._static_GuildIcon:ChangeTextureInfoNameAsync("renewal/commonicon/guildmark/console_icon_guildmark_00.dds")
    ...
    self._ui._static_GuildIconBG:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Default/Default_Buttons.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(self._ui._static_GuildIconBG, 0, 0, 0, 0)
    self._ui._static_GuildIconBG:getBaseTexture():setUV(x1, y1, x2, y2)
    self._ui._static_GuildIconBG:setRenderTexture(self._ui._static_GuildIconBG:getBaseTexture())
    self._ui._static_GuildIcon:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Default/Default_Buttons.dds")
...
function Window_WorldMap_NodeInfo:SetGuildIcon()
  ...
  if true == isSet then
    ...
    self._ui._static_GuildIcon:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Default/BlankGuildMark.dds")
