...
function OnNodeWithdrawClick(nodeKey)
  ...
  local messageBoxData = {
    ...
    functionNo = FGlobal_Plant_WorkManager_ReOpen,
...
local function FillContryInfo(nodeStaticStatus)
  ...
  if tostring(getNodeNationalName(nodeStaticStatus)) == PAGetString(Defines.StringSheet_GAME, "LUA_WORLDMAP_NODE_CONTRY_KALPEON") then
    countryIcon:ChangeTextureInfoNameAsync("Renewal/ETC/WordMap/territorymark_Calpheon_Small.dds")
  elseif tostring(getNodeNationalName(nodeStaticStatus)) == PAGetString(Defines.StringSheet_GAME, "LUA_WORLDMAP_NODE_CONTRY_BALENCIA") then
    countryIcon:ChangeTextureInfoNameAsync("Renewal/ETC/WordMap/territorymark_valencia_Small.dds")
  elseif tostring(getNodeNationalName(nodeStaticStatus)) == PAGetString(Defines.StringSheet_GAME, "LUA_WORLDMAP_NODE_CONTRY_MEDIA") then
    countryIcon:ChangeTextureInfoNameAsync("Renewal/ETC/WordMap/territorymark_mediah_Small.dds")
  elseif tostring(getNodeNationalName(nodeStaticStatus)) == PAGetString(Defines.StringSheet_GAME, "LUA_CONTRYNAME_6") then
    countryIcon:ChangeTextureInfoNameAsync("Renewal/ETC/WordMap/territorymark_Kamasylvia_Small.dds")
  elseif tostring(getNodeNationalName(nodeStaticStatus)) == PAGetString(Defines.StringSheet_GAME, "LUA_WORLDMAP_TERRITORYSTRING_0") then
    countryIcon:ChangeTextureInfoNameAsync("Renewal/ETC/WordMap/territorymark_valenos_Small.dds")
  elseif tostring(getNodeNationalName(nodeStaticStatus)) == PAGetString(Defines.StringSheet_GAME, "LUA_WORLDMAP_TERRITORYSTRING_1") then
    countryIcon:ChangeTextureInfoNameAsync("Renewal/ETC/WordMap/territorymark_selendia_Small.dds")
  elseif tostring(getNodeNationalName(nodeStaticStatus)) == PAGetString(Defines.StringSheet_GAME, "LUA_TERRITORYNAME_7") then
    countryIcon:ChangeTextureInfoNameAsync("Renewal/ETC/WordMap/territorymark_Drigan_Small.dds")
  elseif tostring(getNodeNationalName(nodeStaticStatus)) == PAGetString(Defines.StringSheet_GAME, "LUA_TERRITORYNAME_8") then
    countryIcon:ChangeTextureInfoNameAsync("Renewal/ETC/WordMap/territorymark_Odyllita_small.dds")
  elseif tostring(getNodeNationalName(nodeStaticStatus)) == PAGetString(Defines.StringSheet_GAME, "LUA_TERRITORYNAME_9") then
    countryIcon:ChangeTextureInfoNameAsync("Renewal/ETC/WordMap/territorymark_SnowMountain_small.dds")
  elseif tostring(getNodeNationalName(nodeStaticStatus)) == PAGetString(Defines.StringSheet_GAME, "LUA_TERRITORYNAME_10") then
    countryIcon:ChangeTextureInfoNameAsync("Renewal/ETC/WordMap/territorymark_MorningLand_small.dds")
  elseif tostring(getNodeNationalName(nodeStaticStatus)) == PAGetString(Defines.StringSheet_GAME, "LUA_TERRITORYNAME_11") then
    countryIcon:ChangeTextureInfoNameAsync("Renewal/ETC/WordMap/territorymark_Ulukita_small.dds")
  elseif tostring(getNodeNationalName(nodeStaticStatus)) == PAGetString(Defines.StringSheet_GAME, "LUA_TERRITORYNAME_12") then
    countryIcon:ChangeTextureInfoNameAsync("Renewal/ETC/WordMap/territorymark_Edania_small.dds")
  end
...
local function FillTerritoryInfo(nodeStaticStatus)
  ...
  if tostring(getNodeTerritoryName(nodeStaticStatus)) == PAGetString(Defines.StringSheet_GAME, "LUA_WORLDMAP_NODE_BALENOS") then
    territoryIcon:ChangeTextureInfoNameAsync("Renewal/ETC/WordMap/territorymark_valenos_Small.dds")
  elseif tostring(getNodeTerritoryName(nodeStaticStatus)) == PAGetString(Defines.StringSheet_GAME, "LUA_WORLDMAP_NODE_SERENDIA") then
    territoryIcon:ChangeTextureInfoNameAsync("Renewal/ETC/WordMap/territorymark_selendia_Small.dds")
  elseif tostring(getNodeTerritoryName(nodeStaticStatus)) == PAGetString(Defines.StringSheet_GAME, "LUA_WORLDMAP_NODE_KALPEON") then
    territoryIcon:ChangeTextureInfoNameAsync("Renewal/ETC/WordMap/territorymark_Calpheon_Small.dds")
  elseif tostring(getNodeTerritoryName(nodeStaticStatus)) == PAGetString(Defines.StringSheet_GAME, "LUA_WORLDMAP_NODE_MEDIA") then
    territoryIcon:ChangeTextureInfoNameAsync("Renewal/ETC/WordMap/territorymark_mediah_Small.dds")
  elseif tostring(getNodeTerritoryName(nodeStaticStatus)) == PAGetString(Defines.StringSheet_GAME, "LUA_WORLDMAP_NODE_BALENCIA") then
    territoryIcon:ChangeTextureInfoNameAsync("Renewal/ETC/WordMap/territorymark_valencia_Small.dds")
  elseif tostring(getNodeTerritoryName(nodeStaticStatus)) == PAGetString(Defines.StringSheet_GAME, "LUA_TERRITORYNAME_6") then
    territoryIcon:ChangeTextureInfoNameAsync("Renewal/ETC/WordMap/territorymark_Kamasylvia_Small.dds")
  elseif tostring(getNodeTerritoryName(nodeStaticStatus)) == PAGetString(Defines.StringSheet_GAME, "LUA_TERRITORYNAME_7") then
    territoryIcon:ChangeTextureInfoNameAsync("Renewal/ETC/WordMap/territorymark_Drigan_Small.dds")
  elseif tostring(getNodeNationalName(nodeStaticStatus)) == PAGetString(Defines.StringSheet_GAME, "LUA_TERRITORYNAME_8") then
    territoryIcon:ChangeTextureInfoNameAsync("Renewal/ETC/WordMap/territorymark_Odyllita_small.dds")
  elseif tostring(getNodeNationalName(nodeStaticStatus)) == PAGetString(Defines.StringSheet_GAME, "LUA_QUESTLIST_HISTORY_TXT_REGION_14") then
    territoryIcon:ChangeTextureInfoNameAsync("Renewal/ETC/WordMap/territorymark_Ulukita_small.dds")
  elseif tostring(getNodeTerritoryName(nodeStaticStatus)) == PAGetString(Defines.StringSheet_RESOURCE, "PANEL_MERCENARY_TERRITORY_11") then
    territoryIcon:ChangeTextureInfoNameAsync("Renewal/ETC/WordMap/territorymark_Edania_small.dds")
  else
...
local function SetNodeType(nodeType)
  ...
  if 0 == tonumber(nodeType) then
    uiControl:ChangeTextureInfoNameAsync("new_ui_common_forlua/widget/worldmap/WorldMap_Etc_05.dds")
...
local function update_ExplorePoint()
  ...
  if isGameTypeNA() or isGameTypeSA() or isGameTypeTH() or isGameTypeASIA() or isGameTypeID() or isGameTypeTR() then
...
function FGlobal_NodeMenu_SetExplorePointBG(isShow)
  Tex_ExplorePoint_BG:SetShow(isShow)
end
...
function FGlobal_ShowInfoNodeMenuPanel(node)
  ...
  for _, param in pairs(CppEnums.MiniGameParam) do
    if plantKey:get() == param and true == node:isPurchased() then
...
function InvestNodeLevelNumpad(wayPointKey)
  ...
  if _ContentsGroup_UseCharacterWp == true and PaGlobalFunc_UseCharacterWp_All_Open ~= nil then
    PaGlobalFunc_UseCharacterWp_All_Open(PaGlobal_UseCharacterWp_All._openType._investNode, wayPointKey)
  else
...
function FromClient_SetCapitalSiegeTentIcon(nodeBtn)
  ...
  nodeBtn:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Widget/worldmap/worldmap_icon_04.dds")
...
function FGlobal_WorldMapGrand_NodeExplorePoint_UpdateWhenShowWorldMap()
...
registerEvent("FromClient_UpdateExplorePointWhenShowWorldMap", "FGlobal_WorldMapGrand_NodeExplorePoint_UpdateWhenShowWorldMap")
if false == _ContentsGroup_RenewUI then
