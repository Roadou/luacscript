  ...
  for index = 0, maxCount do
    ...
    if nil ~= progressingInfo then
      ...
      if nil ~= iconPath and "" ~= iconPath then
        ...
        dataGroup._icon:ChangeTextureInfoNameAsync(iconPath)
      else
      ...
      if installationType == UI_INSTALL.eType_Havest then
        dataGroup._iconPruning:ChangeTextureInfoNameAsync("New_UI_Common_ForLua/Widget/Housing/Housing_TentObjectInfo_00.dds")
        ...
        dataGroup._iconInsectDamege:ChangeTextureInfoNameAsync("New_UI_Common_ForLua/Widget/Housing/Housing_TentObjectInfo_00.dds")
