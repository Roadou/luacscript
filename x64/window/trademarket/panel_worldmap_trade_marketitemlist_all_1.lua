...
function PaGlobal_WorldMap_TradeItemList_All:getItemListByCurrentCategory()
  ...
  if 1 == self._currentNpcType then
    ...
    if self._currentCategoryIdx == enCommerceType.enCommerceType_Max then
  ...
  for itemIdx = 0, commerceCount - 1 do
    ...
    if self._currentCategoryIdx == enCommerceType.enCommerceType_Max then
      ...
      itemKey = npcShop_GetCommerceItemByIndexAndSellOrBuy(self._currentCategoryIdx, self._currentNpcType, itemIdx)
    end
