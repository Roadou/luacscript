...
function NodeWarMenuUpdate()
  ...
  if true == minorSiegeWrapper:isSiegeBeing() then
    ...
    if nil ~= markData then
      self._stc_GuildMarkBG:ChangeTextureInfoNameAsync("renewal/commonicon/guildmark/console_icon_guildmark_00.dds")
      ...
      self._txt_GuildMark:ChangeTextureInfoNameAsync("renewal/commonicon/guildmark/console_icon_guildmark_00.dds")
