...
function PaGlobal_CharInfoCashBuff_All:update()
  ...
  local premiumValueBuff2025 = player:isApplyChargeSkill(CppEnums.UserChargeType.eUserChargeType_ChallengeBuff, 1)
  ...
  local isAppliedMinorSiege = player:isApplyChargeSkill(CppEnums.UserChargeType.eUserChargeType_MinorSiege)
  local isAppliedEdanaDropBuff = false
  ...
  if true == isPremiumPcRoom then
    if not isGameTypeRussia() and not isGameTypeNA() and not isGameTypeSA() and not isGameTypeTR() then
  ...
  flags[self._eBUFF_TYPE.GoldValuePack] = premiumValueBuff == true or premiumValueBuff2025 == true
  ...
  flags[self._eBUFF_TYPE.MinorSiegeBuff] = isAppliedMinorSiege
  flags[self._eBUFF_TYPE.LandScapePainting] = _ContentsGroup_LandscapePainting
  flags[self._eBUFF_TYPE.EdanaDropBuff] = isAppliedEdanaDropBuff
  self._buffData = {}
  self:updateBuffData()
  self._listShowBuff = {}
  local uiIndex = 1
...
function PaGlobal_CharInfoCashBuff_All:updateBuffData()
  ...
  local premiumValueTime2025 = player:getUserChargeTime(CppEnums.UserChargeType.eUserChargeType_ChallengeBuff, 1)
  ...
  local minorSiegeTime = player:getUserChargeTime(CppEnums.UserChargeType.eUserChargeType_MinorSiege)
  ...
  for buffType = 1, self._buffTypeCount do
    ...
    elseif buffType == self._eBUFF_TYPE.GoldValuePack then
      ...
      if premiumValueTime2025 > 0 then
        ...
        desc = desc .. PAGetStringParam1(Defines.StringSheet_GAME, "LUA_SELFPLAYEREXPGAGE_PREMIUMVALUE_2025_ONLY_XB_PS_DESC", "time", convertStringFromDatetime(toInt64(0, premiumValueTime2025)))
        descCount = 2
      end
      leftTime = nil
    ...
    elseif buffType == self._eBUFF_TYPE.MinorSiegeBuff then
      ...
      if minorSiegeBuffType == __eSiegeTerritoryType_Default then
        ...
        desc = PAGetStringParam5(Defines.StringSheet_GAME, "LUA_SIEGEBUFF_TOOLTIP_DESC", "num1", minorSiegeBuff_0, "num2", minorSiegeBuff_1, "num3", minorSiegeBuff_2, "num4", minorSiegeBuff_3, "num5", convertStringFromDatetime(toInt64(0, minorSiegeTime)))
      else
      ...
      leftTime = convertStringFromDatetime(toInt64(0, minorSiegeTime))
    elseif buffType == self._eBUFF_TYPE.LandScapePainting then
      name = PAGetString(Defines.StringSheet_RESOURCE, "PANEL_EXTRADROP_TITLE")
      if PaGlobal_LandscapePainting_getToolTipString ~= nil then
        desc = PaGlobal_LandscapePainting_getToolTipString(false)
      end
      desc = desc .. "\n" .. PAGetString(Defines.StringSheet_GAME, "LUA_DROPITEM_TOOLTIP_DESC")
      leftTime = nil
    elseif buffType == self._eBUFF_TYPE.EdanaDropBuff then
