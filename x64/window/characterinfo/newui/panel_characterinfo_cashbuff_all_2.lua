...
function PaGlobal_CharInfoCashBuff_All_list2Update(content, key)
  ...
  for ii = 1, PaGlobal_CharInfoCashBuff_All._columnCount do
    ...
    if dataIndex <= #PaGlobal_CharInfoCashBuff_All._listShowBuff then
      ...
      stc_buffIcon:ChangeTextureInfoNameAsync("Combine/Icon/Combine_Icon_Buff_00.dds")
...
function HandleEventLUp_CharinfoCashBuff_All_SelectBuff(buffType, key, uiIdx)
  ...
  elseif PaGlobal_CharInfoCashBuff_All._eBUFF_TYPE.LandScapePainting == buffType then
    ToClient_requestToggleLandScapePaintingTotalSwitch()
  end
end
function HandleEventLOut_CharinfoCashBuff_All_TooltipOff(type)
  if type == PaGlobal_CharInfoCashBuff_All._eBUFF_TYPE.FeverBuff or type == PaGlobal_CharInfoCashBuff_All._eBUFF_TYPE.LandScapePainting then
    PaGlobal_CharInfoCashBuff_All._ui.stc_KeyGuide_A:SetShow(true)
  else
    PaGlobal_CharInfoCashBuff_All._ui.stc_KeyGuide_A:SetShow(false)
  end
  local keyguide = {
