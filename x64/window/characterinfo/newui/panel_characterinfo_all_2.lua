...
function HandleEventLUp_ChracterInfo_All_ScaleResizeLPress()
  ...
  if PaGlobalFunc_ChracterInfo_All_GetBgShow(PaGlobal_CharInfo_All._TABINDEX._basic) == true then
  ...
  if PaGlobalFunc_ChracterInfo_All_GetBgShow(PaGlobal_CharInfo_All._TABINDEX._title) == true then
  ...
  if PaGlobalFunc_ChracterInfo_All_GetBgShow(PaGlobal_CharInfo_All._TABINDEX._challenge) == true then
  ...
  if PaGlobalFunc_ChracterInfo_All_GetBgShow(PaGlobal_CharInfo_All._TABINDEX._history) == true then
  ...
  if PaGlobalFunc_ChracterInfo_All_GetBgShow(PaGlobal_CharInfo_All._TABINDEX._footPrint) == true then
  ...
  if PaGlobalFunc_ChracterInfo_All_GetBgShow(PaGlobal_CharInfo_All._TABINDEX._buffDetail) == true then
    PaGlobal_CharacterInfo_BuffDetail_All:resizePanel()
  end
end
...
function PaGlobalFunc_CharacterInfo_All_CheckIntroduceUiEdit(targetUI)
  if Panel_CharacterInfo_All == nil then
    return
  end
  if PaGlobal_CharInfoBasic_All == nil then
    return
  end
  return targetUI ~= nil and targetUI:GetKey() == PaGlobal_CharInfoBasic_All._ui.edit_multiEdit:GetKey()
end
