...
function PaGlobalFunc_InGameEventNotice()
  ...
  if isGameServiceTypeConsole() == true then
    if CppEnums.ServiceResourceType.eServiceResourceType_KR == resourceType then
      url = "https://www.console.playblackdesert.com/News/Notice/Detail?boardNo=18524&countryType=ko-KR"
    elseif CppEnums.ServiceResourceType.eServiceResourceType_DE == resourceType then
      url = "https://www.console.playblackdesert.com/news/notice/detail?boardno=18524&countrytype=de-DE"
    elseif CppEnums.ServiceResourceType.eServiceResourceType_FR == resourceType then
      url = "https://www.console.playblackdesert.com/news/notice/detail?boardno=18524&countrytype=fr-FR"
    elseif CppEnums.ServiceResourceType.eServiceResourceType_JP == resourceType then
      url = "https://www.console.playblackdesert.com/news/notice/detail?boardno=18524&countrytype=ja-JP"
    else
      url = "https://www.console.playblackdesert.com/news/notice/detail?boardno=18524&countrytype=en-US"
    end
