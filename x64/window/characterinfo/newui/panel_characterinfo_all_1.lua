function PaGlobal_CharInfo_All:initialize()
  ...
  self._ui.txt_TitleBg = UI.getChildControl(Panel_CharacterInfo_All, "StaticText_Title")
  ...
  self._ui.btn_StickerUI = UI.getChildControl(self._ui.txt_TitleBg, "CheckButton_PopUp")
  ...
  self._ui.rdo_BuffDetail = UI.getChildControl(self._ui.stc_TabBg, "RadioButton_Tab_BuffDetail")
  ...
  self._ui.stc_BuffDetailBg = UI.getChildControl(Panel_CharacterInfo_All, "Static_BuffDetailBg")
  ...
  self._ui.rdo_tabTable[self._TABINDEX._buffDetail] = self._ui.rdo_BuffDetail
...
function PaGlobal_CharInfo_All:validate()
  ...
  self._ui.rdo_BuffDetail:isValidate()
  ...
  self._ui.stc_BuffDetailBg:isValidate()
...
function PaGlobal_CharInfo_All:switchPlatForm(console)
  ...
  self._ui.rdo_BuffDetail:SetShow(not _ContentsGroup_RenewUI and _ContentsGroup_BuffDetailBoard)
...
function PaGlobal_CharInfo_All:prepareOpen()
  if false == self._initialize then
    ...
    if _ContentsGroup_BuffDetailBoard == true then
      setTabData(self._TABINDEX._buffDetail, self._ui.rdo_BuffDetail, Panel_CharacterInfo_BuffDetail, self._ui.stc_BuffDetailBg, PaGlobalFunc_CharInfoBuffDetail_All_Update)
    end
...
function PaGlobal_CharInfo_All:setKeyGuideAlign(idx)
  ...
  if true == PaGlobalFunc_ChracterInfo_All_GetBgShow(PaGlobal_CharInfo_All._TABINDEX._basic) then
    keyguide = {
      ...
      PaGlobal_CharInfoBasic_All._ui.stc_KeyGuide_LS,
  ...
  elseif true == PaGlobalFunc_ChracterInfo_All_GetBgShow(PaGlobal_CharInfo_All._TABINDEX._buffDetail) then
    keyguide = {
      PaGlobal_CharacterInfo_BuffDetail_All._ui.stc_KeyGuide_A,
      PaGlobal_CharacterInfo_BuffDetail_All._ui.stc_KeyGuide_B
    }
  end
