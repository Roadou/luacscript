...
function CompetitionGame_TeamUi_Round()
  ...
  for Index = 0, teamCount - 1 do
    ...
    for userIndex = 0, teamUserCount - 1 do
      ...
      temp._teamBg:ChangeTextureInfoNameAsync(controlTexture.path)
      ...
      temp._progressBg:ChangeTextureInfoNameAsync(controlTexture.path)
      ...
      temp._progress:ChangeTextureInfoNameAsync(controlTexture.path)
      ...
      temp._border:ChangeTextureInfoNameAsync(controlTexture.path)
...
function CompetitionGame_TeamUI_Setting_Round(teamNo, userCount)
  ...
  for index = 0, userCount - 1 do
    ...
    if userInfo ~= nil and userSlot ~= nil then
      ...
      userSlot._classIcon:ChangeTextureInfoNameAsync(controlTexture.path)
      ...
      userSlot._gaugeBlack:ChangeTextureInfoNameAsync(controlTexture.path3)
        ...
        for idx = 0, skillCount - 1 do
          ...
          if 0 == idx then
            if skillCool <= 0 then
              ...
              userSlot._skillIcon1:ChangeTextureInfoNameAsync("Icon/" .. skillIcon)
          ...
          if 1 == idx then
            if skillCool <= 0 then
              ...
              userSlot._skillIcon2:ChangeTextureInfoNameAsync("Icon/" .. skillIcon)
          ...
          if 2 == idx then
            if skillCool <= 0 then
              ...
              userSlot._skillIcon3:ChangeTextureInfoNameAsync("Icon/" .. skillIcon)
          ...
          if 3 == idx then
            if skillCool <= 0 then
              ...
              userSlot._skillIcon4:ChangeTextureInfoNameAsync("Icon/" .. skillIcon)
