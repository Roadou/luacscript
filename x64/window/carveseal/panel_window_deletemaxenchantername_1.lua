...
function PaGlobal_DeleteMaxEnchanterName:prepareInitialize()
  ...
  self._ui.stc_RemoveItemSlot:ChangeTextureInfoNameAsync("Icon/" .. self._fromItemIconPath)
...
function PaGlobal_DeleteMaxEnchanterName:selectItem(index)
  ...
  self._ui.stc_Slot:ChangeTextureInfoNameAsync("Icon/" .. itemSSW:getIconPath())
