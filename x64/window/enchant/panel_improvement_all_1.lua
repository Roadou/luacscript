...
function PaGlobal_Improvement_All:controlAll_Init()
  ...
  self._ui.rdo_tabGoonWang:SetShow(_ContentsGroup_ItemSkillOption == true)
  ...
  if _ContentsGroup_ReforgeStonePreset == true then
    stc_tabBg:SetShow(false)
    local tabBgSizeY = stc_tabBg:GetSizeY()
    self._ui.stc_leftBg:SetSpanSize(self._ui.stc_leftBg:GetSpanSize().x, self._ui.stc_leftBg:GetSpanSize().y - tabBgSizeY)
    self._ui.stc_itemListBg:SetSpanSize(self._ui.stc_itemListBg:GetSpanSize().x, self._ui.stc_itemListBg:GetSpanSize().y - tabBgSizeY)
    self._ui.stc_leftBtnBg:SetSpanSize(self._ui.stc_leftBtnBg:GetSpanSize().x, self._ui.stc_leftBtnBg:GetSpanSize().y - tabBgSizeY)
    self._ui_console.stc_guideBg:SetSpanSize(self._ui_console.stc_guideBg:GetSpanSize().x, self._ui_console.stc_guideBg:GetSpanSize().y + tabBgSizeY)
    self._ui.txt_itemListTitle:SetPosY(self._ui.txt_itemListTitle:GetPosY() - tabBgSizeY)
    self._ui.stc_enchantItemListBg:SetPosY(self._ui.stc_enchantItemListBg:GetPosY() - tabBgSizeY)
    self._ui.txt_enchantItemListTitle:SetPosY(self._ui.txt_enchantItemListTitle:GetPosY() - tabBgSizeY)
    Panel_Window_Improvement_All:SetSize(Panel_Window_Improvement_All:GetSizeX(), Panel_Window_Improvement_All:GetSizeY() - tabBgSizeY)
  end
end
...
function PaGlobal_Improvement_All:controlConsole_Init()
  ...
  local leftBtnBg = UI.getChildControl(Panel_Window_Improvement_All, "Static_Button")
  self._ui_console.stc_enchantY = UI.getChildControl(leftBtnBg, "StaticText_EnchantButton_C")
