...
function equip:initControl()
    ...
    if true == equip_checkUseableSlot(v) then
      ...
      if 29 == v then
        if __eClassType_ShyWaman == isClassType then
          self.slotBGs[v]:ChangeTextureInfoNameAsync("renewal/pcremaster/remaster_icon_01.dds")
      ...
      if nil ~= self.avataEquipSlotId[v] then
        ...
        elseif v == 45 then
          self.avataSlots[v]:addInputEvent("Mouse_On", "Equipment_SimpleToolTips( true, 9, " .. v .. " )")
          self.avataSlots[v]:addInputEvent("Mouse_Out", "Equipment_SimpleToolTips( false, 9, " .. v .. " )")
        else
  ...
  self.battlePointText:SetShow(false)
