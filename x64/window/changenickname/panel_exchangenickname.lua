...
function PaGlobal_ExchangeNickname:Open()
  ...
  self._ui.SelectedBothIcon:ChangeTextureInfoNameAsync("Renewal/PcRemaster/Remaster_ETC_02.dds")
...
function HandleClicked_ExchangeNickname_Apply()
  ...
  local classLeftNameText = NewClassData.newClass_String[isLeftClassType]._classType2String
  ...
  local classRightNameText = NewClassData.newClass_String[isRightClassType]._classType2String
...
function HandleClicked_ExchangeNickname_Select(list, index)
  ...
  local classNameText = NewClassData.newClass_String[isClassType]._classType2String
  if 0 == list then
...
function PaGlobal_ExchangeNickname_Tooltips(isShow, classType, controlType)
  ...
  local classNameText = NewClassData.newClass_String[classType]._classType2String
