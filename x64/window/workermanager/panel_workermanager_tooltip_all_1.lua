...
function PaGlobal_WorkerManagerTooltip_All:updateWorkerInfo()
  ...
  self._ui.stc_workerImg:ChangeTextureInfoNameAsync(workerIcon)
...
function PaGlobal_WorkerManagerTooltip_All:updateSkillList()
  ...
  if nil ~= defaultSkill then
    ...
    self._defaultSlot.icon:ChangeTextureInfoNameAsync(defaultSkill:getIconPath())
  ...
  for idx = 0, self._maxSkillCount - 1 do
    ...
    if self._maxSkillCount - 1 == idx then
      ...
      elseif workerLevel >= __eWorkerPossibleLevelChangeStorage then
        ...
        self._skill[idx].icon:ChangeTextureInfoNameAsync("new_ui_common_forlua/skill/workerskill/2019.dds")
  ...
  if 0 ~= skillCount then
    workerWrapperLua:foreachSkillList(function(index, skillStaticStatusWrapper)
      ...
      self._skill[index].icon:ChangeTextureInfoNameAsync(skillStaticStatusWrapper:getIconPath())
