...
function FromClient_WorkerManagerChangeSkill_All_ChangeWorkerSkillNoOne(workerNoRaw, workerSkillKeyRaw)
  ...
  PaGlobal_WorkerManagerChangeSkill_All._selectedSkillKeyRaw = nil
  PaGlobal_WorkerManagerChangeSkill_All:update()
  PaGlobal_WorkerManagerChangeSkill_All:setEffectOnNewSkill(workerNoRaw, workerSkillKeyRaw)
end
