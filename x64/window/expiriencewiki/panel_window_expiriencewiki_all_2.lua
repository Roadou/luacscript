...
function PaGlobal_ExpirienceWiki_All_SetHashId(hashId)
  PaGlobal_Expirience_All._hashId = hashId
end
...
function PaGlobalFunc_ExpirienceWiki_WebDetailDescLinkOpen(keyword, hashID)
  local webUrl = ToClient_getWebUrl(__eWebUrl_InGameCashWebDescUrl) .. tostring(keyword)
  InputMLUp_ExpirienceWiki_All_Close()
  PaGlobal_ExpirienceWiki_All_SetIsWiki()
  PaGlobal_ExpirienceWiki_All_SetDirectLink(webUrl)
  PaGlobal_ExpirienceWiki_All_SetHashId(tostring(hashID))
  PaGlobal_ExpirienceWiki_All_Open()
end
