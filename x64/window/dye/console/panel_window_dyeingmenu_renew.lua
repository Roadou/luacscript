...
function DyeingMenu:initialize()
  ...
  self._ui.rdo_subMenu[ROOT_MENU.DYEING] = {
    ...
    [DYEING_SUBMENU.MAIDACTOR] = UI.getChildControl(self._ui.stc_subMenuGroup[ROOT_MENU.DYEING], "RadioButton_MaidActor")
  }
  self._ui.rdo_subMenu[ROOT_MENU.DYEING][DYEING_SUBMENU.CAMEL]:SetShow(ToClient_IsContentsGroupOpen("4"))
  self._ui.rdo_subMenu[ROOT_MENU.DYEING][DYEING_SUBMENU.TENT]:SetShow(_ContentsGroup_isCamp)
  self._ui.rdo_subMenu[ROOT_MENU.DYEING][DYEING_SUBMENU.MAIDACTOR]:SetShow(_ContentsGroup_MaidActorSystem)
