PaGlobal_Dye_All = {
  _ui = {
    ...
    btn_exportString = nil,
    btn_applyString = nil,
    txt_sharingdye = nil,
    btn_applySharingdye = nil,
    btn_closeSharingdye = nil
  },
  _ui_pc = {btn_Dye = nil},
  _ui_console = {
    stc_KeyGuideLB = nil,
  ...
  dyePartString = {
    [0] = {
      ...
      [45] = PAGetString(Defines.StringSheet_GAME, "LUA_EQUIPMENT_AVATAR_BACK")
    },
    {
  ...
  _dyeTargetString = {
    ...
    [7] = PAGetString(Defines.StringSheet_RESOURCE, "PANEL_CUSTOM_MAID_MAIN_TAP")
  },
  _enumCharacterType = {
    Character = 0,
    Horse = 1,
  ...
  _enableMaidActor = ToClient_IsContentsGroupOpen("1984"),
  _characterTypeMin = 999,
  _characterTypeMax = -999,
  _partDyeInfo = {},
