...
function PaGlobal_Dye_Palette_All:prepareOpen(isPalette)
  ...
  if PaGlobalFunc_Inventory_All_EnchantInventoryButtonActive ~= nil and Panel_Window_Dye_Palette_All:GetShow() == false then
...
function PaGlobal_Dye_Palette_All:prepareClose()
  ...
  if PaGlobalFunc_Inventory_All_EnchantInventoryButtonActive ~= nil and Panel_Window_Dye_Palette_All:GetShow() == true then
...
function PaGlobal_Dye_Palette_All:changeSlotTexture(isFill, rowsIdx, colsIdx)
  ...
  slot:ChangeTextureInfoNameAsync("new_ui_common_forlua/default/Default_Buttons_02.dds")
