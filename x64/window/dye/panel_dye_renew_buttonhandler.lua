...
function PaGlobal_DyeReNew_ButtonHandler_Init()
  ...
  if __eClassType_ShyWaman == isClassType then
    dyeCombine._ui.toggleAwakenWeapon:ChangeTextureInfoNameAsync("Renewal/PcRemaster/Remaster_Btn_01.dds")
    ...
    dyeCombine._ui.toggleAwakenWeapon:ChangeOnTextureInfoNameAsync("Renewal/PcRemaster/Remaster_Btn_01.dds")
    ...
    dyeCombine._ui.toggleAwakenWeapon:ChangeClickTextureInfoNameAsync("Renewal/PcRemaster/Remaster_Btn_01.dds")
    ...
    dyeCombine._ui.toggleAwakenWeapon:ChangeTextureInfoNameAsync("Renewal/PcRemaster/Remaster_Btn_00.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(dyeCombine._ui.toggleAwakenWeapon, 202, 242, 234, 274)
    dyeCombine._ui.toggleAwakenWeapon:getBaseTexture():setUV(x1, y1, x2, y2)
    dyeCombine._ui.toggleAwakenWeapon:setRenderTexture(dyeCombine._ui.toggleAwakenWeapon:getBaseTexture())
    dyeCombine._ui.toggleAwakenWeapon:ChangeOnTextureInfoNameAsync("Renewal/PcRemaster/Remaster_Btn_00.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(dyeCombine._ui.toggleAwakenWeapon, 235, 242, 267, 274)
    dyeCombine._ui.toggleAwakenWeapon:getOnTexture():setUV(x1, y1, x2, y2)
    dyeCombine._ui.toggleAwakenWeapon:setRenderTexture(dyeCombine._ui.toggleAwakenWeapon:getOnTexture())
    dyeCombine._ui.toggleAwakenWeapon:ChangeClickTextureInfoNameAsync("Renewal/PcRemaster/Remaster_Btn_00.dds")
