...
function Cannon_ShowThrowFireGuide(show)
  isShowFocus = 9088 == _current_cannonCharacterKey or 31073 == _current_cannonCharacterKey or 31074 == _current_cannonCharacterKey or 31075 == _current_cannonCharacterKey or 31132 == _current_cannonCharacterKey or 31133 == _current_cannonCharacterKey or 62405 == _current_cannonCharacterKey or 62410 == _current_cannonCharacterKey
  isShowFocus = true == isShowFocus and true == show and _ContentsGroup_UpgradeFlameTower == true
