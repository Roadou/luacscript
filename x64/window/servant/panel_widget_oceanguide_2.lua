...
function PaGlobalFunc_OceanGuide_IsShip()
  ...
  if nil ~= servantType and servantType == __eServantTypeShip then
    return true
  end
  return false
end
...
function HandleOnOut_OceanWind_ToolTip(show)
  if show == false then
    TooltipSimple_Hide()
    return
  end
  TooltipSimple_Show(PaGlobal_OceanGuide._oceanWind._ui.stc_BG, "", PAGetString(Defines.StringSheet_GAME, "LUA_SAILCONTROL_WIND_DESC"))
end
