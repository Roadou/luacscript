...
function PaGlobal_OceanGuide:registEventHandler()
  ...
  self._oceanWind._ui.stc_BG:addInputEvent("Mouse_On", "HandleOnOut_OceanWind_ToolTip(true)")
  self._oceanWind._ui.stc_BG:addInputEvent("Mouse_Out", "HandleOnOut_OceanWind_ToolTip(false)")
