function PaGlobal_VehicleInfo_All:initialize()
  ...
  self._ui._stc_levelValue = UI.getChildControl(stc_basicInfo_left, "StaticText_LevelValue")
  self._ui._btn_stackLvUp = UI.getChildControl(stc_basicInfo_left, "Button_Stack_LvUp")
  self._ui._btn_lvDown = UI.getChildControl(stc_basicInfo_left, "Button_LvDown")
  ...
  if self._ui._btn_simulator ~= nil then
    self._ui._btn_simulator:SetTextMode(__eTextMode_LimitText)
    self._ui._btn_simulator:SetText(self._ui._btn_simulator:GetText())
    UI.setLimitTextAndAddTooltip(self._ui._btn_simulator, self._ui._btn_simulator:GetText())
  end
  ...
  self._ui._txt_servantLevelDownTitle = UI.getChildControl(stc_specialInfo_right, "StaticText_LevelDownTitle")
  self._ui._txt_servantLevelDownValue = UI.getChildControl(stc_specialInfo_right, "StaticText_LevelDownValue")
  if self._ui._txt_servantLevelDownTitle ~= nil then
    self._ui._txt_servantLevelDownTitle:SetTextMode(__eTextMode_LimitText)
    self._ui._txt_servantLevelDownTitle:SetText(self._ui._txt_servantLevelDownTitle:GetText())
    UI.setLimitTextAndAddTooltip(self._ui._txt_servantLevelDownTitle, self._ui._txt_servantLevelDownTitle:GetText())
  end
  ...
  self._ui._btn_skillChange = UI.getChildControl(stc_baseInfoGroup, "Button_SkillChange")
...
function PaGlobal_VehicleInfo_All:registEventHandler()
  ...
  if _ContentsGroup_ServantLevelUpRenewal == true then
    self._ui._btn_stackLvUp:addInputEvent("Mouse_LUp", "HandleEventLUp_VehicleInfo_All_StackLvUp()")
    self._ui._btn_lvDown:addInputEvent("Mouse_LUp", "HandleEventLUp_VehicleInfo_All_LevelDecrease()")
    self._ui._txt_expValue:addInputEvent("Mouse_On", "HandleEventOnOut_VehicleInfo_All_ShowStackLvUpTooltip(true)")
    self._ui._txt_expValue:addInputEvent("Mouse_Out", "HandleEventOnOut_VehicleInfo_All_ShowStackLvUpTooltip(false)")
    self._ui._btn_skillChange:addInputEvent("Mouse_LUp", "HandleEventLUp_VehicleInfo_All_SkillChange()")
  end
  ...
  registerEvent("FromClient_ServantLink", "FromClient_VehicleInfo_All_LinkFinish")
  registerEvent("FromClient_DecreaseServantLevel", "FromClient_VehicleInfo_All_UpdateAll")
  registerEvent("FromClient_ServantChangeSkill", "FromClient_VehicleInfo_All_UpdateAll")
...
function PaGlobal_VehicleInfo_All:prepareOpen(viewType, actorKeyRaw)
  ...
  if VehicleType == CppEnums.VehicleType.Type_Horse then
    ...
    self._ui._btn_simulator:SetShow(false)
  end
  ...
  if PaGlobalFunc_Inventory_All_EnchantInventoryButtonActive ~= nil and isShow == false then
...
function PaGlobal_VehicleInfo_All:validate()
  ...
  self._ui._stc_levelValue:isValidate()
  self._ui._btn_stackLvUp:isValidate()
  self._ui._btn_lvDown:isValidate()
...
function PaGlobal_VehicleInfo_All:updateBasicInfo_leftBg_noraml()
  ...
  if servantWrapper:getVehicleType() == __eVehicleType_Elephant then
    self._ui._txt_steminaTitle:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SERVANTINFO_ELEPHANT_MP"))
  elseif servantWrapper:getVehicleType() == __eVehicleType_GuildDragon then
    self._ui._txt_levelValue:SetShow(false)
    self._ui._stc_expBg:SetShow(false)
    self._ui._stc_staminaBg:SetShow(false)
    self._ui._txt_steminaTitle:SetShow(false)
    self._ui._txt_steminaValue:SetShow(false)
  else
...
function PaGlobal_VehicleInfo_All:updateLevel()
  ...
  local expStack_s64 = servantWrapper:getExperienceStack()
  local possibleLevel = servantWrapper:getPossibleLevel()
  ...
  if _ContentsGroup_ServantLevelUpRenewal == true then
    self._ui._stc_levelValue:SetText("Lv." .. tostring(servantWrapper:getLevel()))
    self._ui._txt_expValue:SetText(PAGetStringParam1(Defines.StringSheet_GAME, "LUA_SERVANT_LVUP_EXP", "servantexp", makeDotMoney(expStack_s64)))
  end
  self:setLvUpRenewalSetting()
end
function PaGlobal_VehicleInfo_All:setLvUpRenewalSetting()
  ...
  self._ui._btn_lvDown:SetShow(false)
  self._ui._btn_skillChange:SetShow(false)
  if _ContentsGroup_ServantLevelUpRenewal == true then
    if self._ui._txt_levelValue:GetShow() == true then
      self._ui._txt_levelValue:SetShow(false)
    end
    if self._ui._txt_expTitle:GetShow() == true then
      self._ui._txt_expTitle:SetShow(false)
    end
    if self._ui._stc_expBg:GetShow() == true then
      self._ui._stc_expBg:SetShow(false)
    end
    self._ui._txt_expValue:SetIgnore(false)
    if self._viewType == self._eViewType._normal then
      self._ui._txt_hpTitle:SetSpanSize(self._ui._txt_hpTitle:GetSpanSize().x, 125)
      self._ui._txt_hpValue:SetSpanSize(self._ui._txt_hpValue:GetSpanSize().x, 125)
      self._ui._stc_hpBg:SetSpanSize(self._ui._stc_hpBg:GetSpanSize().x, 150)
      self._ui._txt_steminaTitle:SetSpanSize(self._ui._txt_steminaTitle:GetSpanSize().x, 180)
      self._ui._txt_steminaValue:SetSpanSize(self._ui._txt_steminaValue:GetSpanSize().x, 180)
      self._ui._stc_staminaBg:SetSpanSize(self._ui._stc_staminaBg:GetSpanSize().x, 205)
      self._ui._txt_expTitle:SetSpanSize(self._ui._txt_expTitle:GetSpanSize().x, 55)
      self._ui._txt_expValue:SetSpanSize(self._ui._txt_expValue:GetSpanSize().x, 55)
      self._ui._stc_expBg:SetSpanSize(self._ui._stc_expBg:GetSpanSize().x, 80)
      self._ui._stc_levelValue:SetShow(true)
    elseif self._viewType == self._eViewType._carriage then
      self._ui._txt_hpTitle:SetSpanSize(self._ui._txt_hpTitle:GetSpanSize().x, 55)
      self._ui._txt_hpValue:SetSpanSize(self._ui._txt_hpValue:GetSpanSize().x, 55)
      self._ui._stc_hpBg:SetSpanSize(self._ui._stc_hpBg:GetSpanSize().x, 80)
      self._ui._txt_steminaTitle:SetSpanSize(self._ui._txt_steminaTitle:GetSpanSize().x, 105)
      self._ui._txt_steminaValue:SetSpanSize(self._ui._txt_steminaValue:GetSpanSize().x, 105)
      self._ui._stc_staminaBg:SetSpanSize(self._ui._stc_staminaBg:GetSpanSize().x, 130)
      self._ui._stc_levelValue:SetShow(false)
    end
    if ToClient_IsPossibleServantLevelUpByExpStack(servantNo, true) == true then
      self._ui._btn_stackLvUp:SetShow(true)
      self._ui._txt_expValue:SetShow(true)
    else
      self._ui._txt_expValue:SetShow(false)
    end
    if ToClient_IsPossibleServantLevelDown(servantNo) == true then
      self._ui._btn_lvDown:SetShow(true)
    end
    if ToClient_IsPossibleServantSkillChange(servantNo) == true then
      self._ui._btn_skillChange:SetShow(true)
    end
  else
    ...
    self._ui._txt_steminaValue:SetSpanSize(self._ui._txt_steminaValue:GetSpanSize().x, 105)
    self._ui._stc_staminaBg:SetSpanSize(self._ui._stc_staminaBg:GetSpanSize().x, 130)
    self._ui._txt_expTitle:SetSpanSize(self._ui._txt_expTitle:GetSpanSize().x, 155)
    self._ui._txt_expValue:SetSpanSize(self._ui._txt_expValue:GetSpanSize().x, 155)
    self._ui._stc_expBg:SetSpanSize(self._ui._stc_expBg:GetSpanSize().x, 180)
    self._ui._stc_levelValue:SetShow(false)
  end
end
...
function PaGlobal_VehicleInfo_All:updateBasicInfo_rightBg_normal()
  ...
  if CppEnums.VehicleType.Type_Horse == vehicleType or CppEnums.VehicleType.Type_Donkey == vehicleType then
    ...
    if myservantinfo ~= nil then
      ...
      rentEndTime = myservantinfo:getRentEndDate()
    end
    if true == isRentOwnerFlag then
      ...
      if _ContentsGroup_ServantLevelUpRenewal == true then
        self._ui._txt_rentTime:SetPosXY(270, 62)
        self._ui._txt_rentTime:SetText(tostring(getTimeMonthDayHourMinSecByTTime64(rentEndTime)))
        self._ui._txt_rentTime:SetTextSpan(30, 7)
      else
        self._ui._txt_rentTime:SetPosXY(19, 251)
        self._ui._txt_rentTime:SetText(tostring(getTimeYearMonthDayHourMinSecByTTime64(rentEndTime)))
        self._ui._txt_rentTime:SetTextSpan(35, 5)
      end
    end
  end
  if true == self._isConsole then
...
function PaGlobal_VehicleInfo_All:updateSpecialInfo_leftBg_normal()
  ...
  local isElephant = servantWrapper:getVehicleType() == __eVehicleType_Elephant
  local isGuildDragon = servantWrapper:getVehicleType() == __eVehicleType_GuildDragon
  ...
  if isElephant == true or isGuildDragon == true then
...
function PaGlobal_VehicleInfo_All:updateSpecialInfo_rightBg_normal()
  ...
  if vehicleType == __eVehicleType_Elephant then
    self._ui._txt_sealTitle:SetShow(false)
    self._ui._txt_sealValue:SetShow(false)
  elseif vehicleType == __eVehicleType_GuildDragon then
    if servantWrapper:isPeriodLimit() == true then
...
function PaGlobal_VehicleInfo_All:updateSkill(list2Control, noSkillControl, isNoSkillHide)
  ...
  list2Control:getElementManager():clearKey()
  local maxSearchCount = vehicleSkillStaticStatus_skillCount()
  for ii = 1, maxSearchCount do
    local skillWrapper = servantWrapper:getSkill(ii)
...
function PaGlobal_VehicleInfo_All:updateSkillList(control, key)
  ...
  elseif nil ~= skillWrapperXXX then
    ...
    stc_skillBG:ChangeTextureInfoNameAsync("Icon/" .. skillWrapperXXX:getIconPath())
    ...
    stc_skillBG:ChangeTextureInfoNameAsync("Icon/" .. skillWrapper:getIconPath())
    stc_skillBG:addInputEvent("Mouse_LUp", "")
    if true == self._isConsole then
      stc_skillBG:addInputEvent("Mouse_On", "HandleEventOnOut_VehicleInfo_All_SnappingSkill(true, " .. index .. ")")
      stc_skillBG:addInputEvent("Mouse_Out", "HandleEventOnOut_VehicleInfo_All_SnappingSkill(false)")
...
function PaGlobal_VehicleInfo_All:updateHorseList(control, key)
  ...
  stc_horseIcon:ChangeTextureInfoNameAsync(servantInfo:getIconPath1())
  ...
  if _ContentsGroup_ServantLevelUpRenewal == true then
    ...
    txt_horseExp:SetText(PAGetStringParam1(Defines.StringSheet_GAME, "LUA_SERVANT_LVUP_EXP", "servantexp", makeDotMoney(expStack_s64)))
    txt_horseExp:SetIgnore(false)
    txt_horseExp:addInputEvent("Mouse_On", "HandleEventOnOut_VehicleInfo_All_ShowStackLvUpTooltip(true, true, " .. index .. ")")
    txt_horseExp:addInputEvent("Mouse_Out", "HandleEventOnOut_VehicleInfo_All_ShowStackLvUpTooltip(false)")
    progress_Exp:SetShow(false)
  else
    ...
    txt_horseExp:SetIgnore(true)
    progress_Exp:SetShow(true)
...
function PaGlobal_VehicleInfo_All:isCheckNormal(vehicleType)
  if vehicleType == __eVehicleType_Horse or vehicleType == __eVehicleType_Camel or vehicleType == __eVehicleType_Donkey or vehicleType == __eVehicleType_Elephant or vehicleType == __eVehicleType_Ridable_BabyElephant or vehicleType == __eVehicleType_RaceHorse or vehicleType == __eVehicleType_GuildDragon then
    return true
  end
  return false
end
