...
function HandleEventLUp_ServantMarket_All_ShowBeforeLook(servantIdx, slotIdx)
  ...
  if true == slot._isLookChange then
    slot._stc_HorseImage:ChangeTextureInfoNameAsync(auctionServantInfo:getIconPath1())
  else
    slot._stc_HorseImage:ChangeTextureInfoNameAsync(auctionServantInfo:getBaseIconPath1())
  end
