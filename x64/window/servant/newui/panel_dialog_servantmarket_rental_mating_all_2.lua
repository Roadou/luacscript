...
function HandleEventLUp_ServantMarket_Rental_Mating_All_RecieveMating(slotNo)
  ...
  local price = ToClient_CalculateReceviedMoneyFromServantMarket(slotNo)
  local _title = PAGetString(Defines.StringSheet_GAME, "LUA_ALERT_DEFAULT_TITLE")
  local _desc = PAGetStringParam1(Defines.StringSheet_GAME, "LUA_RENTALMATING_ALL_RECEIVE_MATINGMONEY", "price", makeDotMoney(price))
