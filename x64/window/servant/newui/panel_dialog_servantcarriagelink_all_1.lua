...
function PaGlobal_ServantCarriageLink_All:list2Update_Carriage(content, key)
  ...
  carriage_CarriageIcon:ChangeTextureInfoNameAsync(servantInfo:getIconPath1())
...
function PaGlobal_ServantCarriageLink_All:list2Update_Horse(content, key)
  ...
  if nil ~= tierName then
    horse_Tier:SetText(tierName)
  end
  horse_Icon:ChangeTextureInfoNameAsync(servantInfo:getIconPath1())
