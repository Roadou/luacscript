...
function PaGlobal_ServantExchange_All:list2Update(content, key)
  ...
  if nil ~= self._servantDataTable[key32] then
    ...
    stc_image:ChangeTextureInfoNameAsync(servantInfo:getIconPath1())
    if true == isMale then
      stc_genderIcon:ChangeTextureInfoNameAsync("combine/etc/combine_etc_stable.dds")
...
function PaGlobal_ServantExchange_All:matingUpdate()
  ...
  if nil ~= self._servantNo_Left then
    ...
    if nil ~= servantInfo_Left then
      ...
      self._ui._stc_LeftImage:ChangeTextureInfoNameAsync(servantInfo_Left:getIconPath1())
  ...
  if nil ~= self._servantNo_Right then
    ...
    if nil ~= servantInfo_Right then
      ...
      self._ui._stc_RightImage:ChangeTextureInfoNameAsync(servantInfo_Right:getIconPath1())
