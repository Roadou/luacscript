...
function HandleEventLUp_SimpleInventory_TransportItemToMyBag(itemCount_s64, itemEnchantKey, itemWhereType, isSealed)
  if PaGlobal_SimpleInventory == nil then
    return
  end
  ...
  ToClient_TransportItemToMyBag(PaGlobal_SimpleInventory._selectedCharacterNo, ItemEnchantKey(itemEnchantKey), itemWhereType, itemCount_s64, isSealed)
end
function FromClient_ResponseTransportItem()
  ...
  if Panel_Window_SimpleInventory ~= nil and Panel_Window_SimpleInventory:GetShow() == true then
    ...
    PaGlobal_SimpleInventory:updateSlot()
    PaGlobal_SimpleInventory:updateEquipment()
  end
  if _ContentsGroup_EnchantRemaster == true and PaGlobalFunc_EnchantMain_UpdateEnchantTargetList ~= nil then
    PaGlobalFunc_EnchantMain_UpdateEnchantTargetList()
  end
end
...
function PaGlobalFunc_SimpleInventory_TransportItemToBag(itemEnchantKey, itemWhereType, inventorySlotNo, isSealed, searchIndex)
  PaGlobal_SimpleInventory:itemTooltip_TransportItemToMyBag(itemEnchantKey, itemWhereType, inventorySlotNo, isSealed, searchIndex)
end
