PaGlobal_Inventory_All = {
  _ui = {
    ...
    stc_oceanIcon = nil,
    txt_oceanValue = nil,
    stc_hardCoreIcon = nil,
    txt_hardCoreValue = nil,
    stc_buttonBG = nil,
    ...
    stc_cashProductBg = nil,
    btn_restoreProduct = nil,
    btn_cashProductBgClose = nil,
    stc_categoryBG = nil,
    categoryList = {},
    categorySlotBgList = {},
    categorySlotList = {},
  ...
  _radioButtonSpanXGap = 100,
  _tabAdjustedNeeded = 4,
  _tabStartOffest = 0,
  _filterText = "",
  _isDeleteMode = false,
  _deleteItemList = {},
  ...
  _multiUseSlotNo = nil,
  _isCashProductBlockOpenChcked = false
}
