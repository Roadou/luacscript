...
function PaGlobal_ItemMoveSet:open()
  ...
  self._warehouseFromType = PaGlobal_Warehouse_All_GetFromType()
...
function PaGlobal_ItemMoveSet:close(isShowWarehouse)
  ...
  if true == isShowWarehouse then
    if self._warehouseFromType == CppEnums.WarehoouseFromType.eWarehoouseFromType_Installation then
      FromClient_Warehouse_All_OpenByInstallation(PaGlobal_Warehouse_All_GetInstallationActorKeyRaw(), PaGlobal_Warehouse_All_CurrentWaypointKey())
    elseif self._warehouseFromType == CppEnums.WarehoouseFromType.eWarehoouseFromType_Maid then
      PaGlobal_Warehouse_All_OpenPanelFromMaid(PaGlobalFunc_MaidList_All_IsCheckedUseMultiMaid())
    else
