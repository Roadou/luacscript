...
local servantInventory = {
  _config = {
    ...
    inventoryCount = __eServantTypeCount - 1
  },
  _buttonClose = nil,
  _buttonQuestion = nil,
  _txt_Title = nil,
...
function ServantInventoryOpenWithInventory(actorKeyRaw)
  ...
  if true == _ContentsGroup_RenewUI_Inventory then
    PaGlobalFunc_InventoryInfo_Open(4, false, 0, false)
    return
  end
  local self = servantInventory
  self:clearActorKey()
...
function ServantInventory_Close(isAllPopupClose)
  ...
  if PaGlobalFunc_Inventory_All_EnchantInventoryButtonActive ~= nil and PaGlobal_WareHouse_All_GetShow() == false then
