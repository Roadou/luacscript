  ...
  if isShow == true then
    ...
    if nil ~= itemWrapper then
      ...
      if ToClient_isConsole() == true then
        ...
        local defaultXPos = PaGlobal_NewbieInventory._ui._stc_title:GetParentPosX() - tooltipPanel:GetSizeX() - defaultToolTipGap
        local defaultYPos = PaGlobal_NewbieInventory._ui._stc_title:GetParentPosY()
