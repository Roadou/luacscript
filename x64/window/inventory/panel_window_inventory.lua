...
function inven:init()
  ...
  self.btn_BuyWeight:addInputEvent("Mouse_LUp", "PaGlobalFunc_EasyBuy_Open( 4 )")
  ...
  self.staticCapacity:addInputEvent("Mouse_LUp", "PaGlobalFunc_EasyBuy_Open( 5 )")
...
function inven:setMileageImage()
  self.buttonMileage:ChangeTextureInfoNameAsync("Renewal/PcRemaster/Remaster_Cashshop_00.dds")
...
function inven:setOceanMoneyImage()
  ...
  if true == _ContentsGroup_OceanCurrent then
    ...
    self.buttonMileage:ChangeTextureInfoNameAsync("Combine/Icon/Combine_Cashshop_Icon_00.dds")
...
function _Inventory_updateSlotData_ChangeSilverIcon(money)
  local self = inven
  self.buttonMoney:ChangeTextureInfoNameAsync("Renewal/PcRemaster/Remaster_Icon_00.dds")
  self.buttonMoney:ChangeOnTextureInfoNameAsync("Renewal/PcRemaster/Remaster_Icon_00.dds")
  self.buttonMoney:ChangeClickTextureInfoNameAsync("Renewal/PcRemaster/Remaster_Icon_00.dds")
...
function _Inventory_updateSlotData_ChangeWeightIcon(s64_allWeight, s64_maxWeight_div)
  ...
  if 80 <= Int64toInt32(s64_allWeight / s64_maxWeight_div) then
    self.weightIcon:ChangeTextureInfoNameAsync("Renewal/PcRemaster/Remaster_Icon_00.dds")
...
function Inventory_DropHandler(index)
  ...
  if Panel_Window_Exchange:IsShow() or isManufactureOpen or isAlchemyOpen or MessageBoxGetShow() or false == _ContentsGroup_NewUI_XXX and true == FGlobal_Enchant_SetTargetItem() or Panel_Window_DetectUser:IsShow() or PaGlobal_PetRegister_All_GetShow() or _ContentsGroup_EnchantRemaster == true and Panel_Window_Manufacture_All:GetShow() == true then
    DragManager:clearInfo()
