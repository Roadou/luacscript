...
function FGlobal_ItemMarketRegistItemFromInventory(s64_count, slotNo, inventoryType, waypointKey)
  ...
  elseif enchantLevel > 0 and CppEnums.ItemClassifyType.eItemClassify_Accessory == itemSS:getItemClassify() and (itemSS:isSpecialEnchantItem() == false or itemSSW:isSpecialAccessory() == true) then
