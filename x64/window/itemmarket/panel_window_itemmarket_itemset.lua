...
function ItemmarketItemSet_ListUpdate(contents, key)
  ...
  if nil ~= myItemInfo then
    ...
    if nil ~= iess then
      ...
      elseif enchantLevel > 0 and CppEnums.ItemClassifyType.eItemClassify_Accessory == iess:getItemClassify() and (iess:isSpecialEnchantItem() == false or iess:isSpecialAccessory() == true) then
...
function _ItemMarketItemSet_ChangeBgTexture(bgType, idx)
  ...
  if nil ~= contents then
    local ItemBG = UI.getChildControl(contents, "Template_Static_ItemBG")
    ItemBG:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Window/ItemMarket/ItemMarket_00.dds")
    ItemBG:ChangeOnTextureInfoNameAsync("New_UI_Common_forLua/Window/ItemMarket/ItemMarket_00.dds")
    ItemBG:ChangeClickTextureInfoNameAsync("New_UI_Common_forLua/Window/ItemMarket/ItemMarket_00.dds")
