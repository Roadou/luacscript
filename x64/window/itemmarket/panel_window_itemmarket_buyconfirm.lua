...
function buySecureCodeSetting()
  ...
  self.buyItemSecureCode1:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Window/ItemMarket/" .. rndNo_1 .. ".dds")
  self.buyItemSecureCode2:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Window/ItemMarket/" .. rndNo_2 .. ".dds")
