...
function ItemMarketPreBid:Update()
  ...
  if CppEnums.ItemClassifyType.eItemClassify_Accessory == itemSSW:getItemClassify() and (itemSSW:isSpecialEnchantItem() == false or itemSSW:isSpecialAccessory() == true) then
    self.ui.enchantLevel:SetText(HighRomaEnchantLevel_ReplaceString(enchantLevel + 15))
  elseif enchantLevel > 0 and enchantLevel < 26 then
    self.ui.enchantLevel:SetText(HighRomaEnchantLevel_ReplaceString(enchantLevel))
  end
  self.ui.itemIcon:ChangeTextureInfoNameAsync("Icon/" .. iconPath)
end
