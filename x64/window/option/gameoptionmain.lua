...
function PaGlobal_Option:InitValue(gameOptionSetting)
  ...
  elems_.IsPartyRefuse._initValue = gameOptionSetting:getIsPartyRefuse()
  elems_.IsGuildRefuse._initValue = gameOptionSetting:getIsGuildRefuse()
  ...
  elems_.PetNameTagVisible._initValue = gameOptionSetting:getPetNameTagVisible()
  elems_.FairyNameTagVisible._initValue = gameOptionSetting:getFairyNameTagVisible()
  elems_.MaidActorNameTagVisible._initValue = gameOptionSetting:getMaidActorNameTagVisible()
  ...
  elems_.WorldMapSaveCameraPos._initValue = gameOptionSetting:getWorldMapSaveCameraPos()
  elems_.WorldMapSaveCameraRot._initValue = gameOptionSetting:getWorldMapSaveCameraRot()
  ...
  if _ContentsGroup_SelfPlayerEffectAlpha == true then
    elems_.SelfEffectAlpha._initValue = self:FromRealValueToSliderValue(gameOptionSetting:getSelfEffectAlpha(), 0.3, 1)
  else
    elems_.SelfEffectAlpha._initValue = 1
  end
