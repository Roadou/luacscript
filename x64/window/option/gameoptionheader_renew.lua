...
PaGlobal_Option._elements = {
  ...
  IsPartyRefuse = {
    _defaultValue = false,
    _type = OPTION_TYPE.CHECKBUTTON,
    _title = "PANEL_NEWGAMEOPTION_IsPartyRefuse",
    _desc = "PANEL_NEWGAMEOPTION_FUNCTION_ETC_IsPartuRefuse_DESC"
  },
  IsGuildRefuse = {
    _defaultValue = false,
    _type = OPTION_TYPE.CHECKBUTTON,
    _title = "PANEL_NEWGAMEOPTION_IsGuildRefuse",
    _desc = "PANEL_NEWGAMEOPTION_FUNCTION_ETC_IsGuildRefuse_DESC"
  },
  IsPvpRefuse = {
    _defaultValue = false,
    _type = OPTION_TYPE.CHECKBUTTON,
  ...
  MaidActorNameTagVisible = {
    _defaultValue = 0,
    _type = OPTION_TYPE.RADIOBUTTON,
    _title = "PANEL_NEWGAMEOPTION_FUNCTION_VIEW_MAIDACTOR_NAMETYPETITLE",
    _desc = ""
  },
  ...
  PetNameTagVisible = {
    _defaultValue = 0,
    _type = OPTION_TYPE.RADIOBUTTON,
    _title = "PANEL_GAMEOPTION_PETNAME_VIEW_SUBTITLE",
    _desc = ""
  },
  FairyRender = {
    _defaultValue = true,
  ...
  FairyNameTagVisible = {
    _defaultValue = 0,
    _type = OPTION_TYPE.RADIOBUTTON,
    _title = "PANEL_GAMEOPTION_FAIRYNAME_VIEW_SUBTITLE",
    _desc = ""
  },
  MaidView = {
    _defaultValue = 1,
  ...
  WorldMapSaveCameraPos = {
    _defaultValue = false,
    _type = OPTION_TYPE.CHECKBUTTON,
    _title = "",
    _desc = ""
  },
  WorldMapSaveCameraRot = {
    _defaultValue = false,
    _type = OPTION_TYPE.CHECKBUTTON,
    _title = "",
    _desc = ""
  ...
  AlertGuildCongratulation = {
    _defaultValue = true,
    _type = OPTION_TYPE.CHECKBUTTON,
    _title = "PANEL_NEWGAMEOPTION_GuildAlertCongratulation",
    _desc = "PANEL_NEWGAMEOPTION_FUNCTION_ALERT_GuildAlertCongratulation_DESC"
  },
...
PaGlobal_Option._frames = {
  ...
  Graphic = {
    ...
    Quality = {
      ...
      },
      {
        ...
        _contentsOption = ToClient_isConsole()
      }
    },
    Effect = {
      {
    ...
    HDR = {
      ...
      },
      {
        ...
        _contentsOption = ToClient_isConsolePlatformSpec() and ToClient_isXBoxSeriesX()
      }
    }
  },
  Sound = {
  ...
  Function = {
    ...
    View = {
      ...
      {
        _element = PaGlobal_Option._elements.MaidActorNameTagVisible,
        _contentsOption = _ContentsGroup_MaidActorSystem
      },
      {
      ...
      {
        _element = PaGlobal_Option._elements.FairyNameTagVisible
      },
      {
        _element = PaGlobal_Option._elements.PetRender
      },
      {
        _element = PaGlobal_Option._elements.PetNameTagVisible
      },
      {
    ...
    Alert = {
      ...
      {
        _element = PaGlobal_Option._elements.AlertGuildCongratulation
      },
      {
    ...
    Etc = {
      ...
      {
        _element = PaGlobal_Option._elements.IsPartyRefuse
      },
      {
        _element = PaGlobal_Option._elements.IsGuildRefuse
      },
      {
      ...
      },
      {
        ...
        _contentsOption = _ContentsGroup_MiniGame_YachtDice
      },
      {
      ...
      },
      {
        ...
        _contentsOption = _ContentsGroup_Solare
      },
      {
...
function PaGlobal_Option._elements.IsPartyRefuse:set(value)
  setIsPartyRefuse(value)
end
function PaGlobal_Option._elements.IsGuildRefuse:set(value)
  setIsGuildRefuse(value)
end
...
function PaGlobal_Option._elements.PetNameTagVisible:set(value)
  setPetNameTagVisible(value)
end
function PaGlobal_Option._elements.FairyNameTagVisible:set(value)
  setFairyNameTagVisible(value)
end
function PaGlobal_Option._elements.MaidActorNameTagVisible:set(value)
  setMaidActorNameTagVisible(value)
end
...
function PaGlobal_Option._elements.WorldMapSaveCameraPos:set(value)
  setWorldMapSaveCameraPos(value)
end
function PaGlobal_Option._elements.WorldMapSaveCameraRot:set(value)
  setWorldMapSaveCameraRot(value)
end
...
function PaGlobal_Option._elements.SelfEffectAlpha:set(value)
  if _ContentsGroup_SelfPlayerEffectAlpha == true then
    value = PaGlobal_Option:FromSliderValueToRealValue(value, PaGlobal_Option._elements.SelfEffectAlpha._sliderValueMin, PaGlobal_Option._elements.SelfEffectAlpha._sliderValueMax)
    value = value * 0.01
    setSelfEffectAlpha(value)
  end
end
...
function PaGlobal_Option._elements.AlertGuildCongratulation:set(value)
  ToClient_SetMessageFilter(PaGlobal_Option.ALERT.GuildCongratulation, not value)
end
...
function PaGlobal_Option._elements.IsGuildRefuse:get(wrapper)
  return wrapper:getIsGuildRefuse()
end
function PaGlobal_Option._elements.IsPartyRefuse:get(wrapper)
  return wrapper:getIsPartyRefuse()
end
...
function PaGlobal_Option._elements.PetNameTagVisible:get(wrapper)
  return wrapper:getPetNameTagVisible()
end
function PaGlobal_Option._elements.FairyNameTagVisible:get(wrapper)
  return wrapper:getFairyNameTagVisible()
end
function PaGlobal_Option._elements.MaidActorNameTagVisible:get(wrapper)
  return wrapper:getMaidActorNameTagVisible()
end
...
function PaGlobal_Option._elements.WorldMapSaveCameraPos:get(wrapper)
  return wrapper:getWorldMapSaveCameraPos()
end
function PaGlobal_Option._elements.WorldMapSaveCameraRot:get(wrapper)
  return wrapper:getWorldMapSaveCameraRot()
end
...
function PaGlobal_Option._elements.SelfEffectAlpha:get(wrapper)
  if _ContentsGroup_SelfPlayerEffectAlpha == true then
    return PaGlobal_Option:FromRealValueToSliderValue(wrapper:getSelfEffectAlpha(), 0.3, 1)
  else
    return PaGlobal_Option:FromRealValueToSliderValue(1, 0.3, 1)
  end
end
...
function PaGlobal_Option._elements.AlertGuildCongratulation:get(wrapper)
  return not ToClient_GetMessageFilter(PaGlobal_Option.ALERT.GuildCongratulation)
end
...
elements.PetNameTagVisible._radioButtonMapping = {
  [0] = {
    _string = "PANEL_NEWGAMEOPTION_FUNCTION_VIEW_PetNameTagVisible_DESC_0"
  },
  [1] = {
    _string = "PANEL_NEWGAMEOPTION_FUNCTION_VIEW_PetNameTagVisible_DESC_1"
  },
  ["_count"] = 2
}
...
elements.FairyNameTagVisible._radioButtonMapping = {
  [0] = {
    _string = "PANEL_NEWGAMEOPTION_FUNCTION_VIEW_FairyNameTagVisible_DESC_0"
  },
  [1] = {
    _string = "PANEL_NEWGAMEOPTION_FUNCTION_VIEW_FairyNameTagVisible_DESC_1"
  },
  ["_count"] = 2
}
elements.MaidActorNameTagVisible._radioButtonMapping = {
  [0] = {
    _string = "PANEL_NEWGAMEOPTION_FUNCTION_VIEW_MAIDACTOR_DESC_0"
  },
  [1] = {
    _string = "PANEL_NEWGAMEOPTION_FUNCTION_VIEW_MAIDACTOR_DESC_1"
  },
  ["_count"] = 2
}
