PaGlobal_Option = {
  ...
  _elements = {
    ...
    IsPartyRefuse = {_defaultValue = false, _controlType = __ePAUIControl_CheckButton},
    IsGuildRefuse = {_defaultValue = false, _controlType = __ePAUIControl_CheckButton},
    ...
    HideWindowByAttacked = {_defaultValue = false, _controlType = __ePAUIControl_CheckButton},
    ...
    MaidActorNameTagVisible = {_defaultValue = 0, _controlType = __ePAUIControl_RadioButton},
    ...
    PetNameTagVisible = {_defaultValue = 0, _controlType = __ePAUIControl_RadioButton},
    FairyRender = {_defaultValue = 1, _controlType = __ePAUIControl_RadioButton},
    FairyNameTagVisible = {_defaultValue = 0, _controlType = __ePAUIControl_RadioButton},
    ...
    WorldMapSaveCameraPos = {_defaultValue = false, _controlType = __ePAUIControl_CheckButton},
    WorldMapSaveCameraRot = {_defaultValue = false, _controlType = __ePAUIControl_CheckButton},
    TextureQuality = {
      _defaultValue = 1,
      _controlType = __ePAUIControl_RadioButton,
      _isPictureTooltipOn = true
    },
    GraphicOption = {_defaultValue = 7, _controlType = __ePAUIControl_RadioButton},
    AntiAliasing = {
      _defaultValue = 1,
      _controlType = __ePAUIControl_RadioButton,
      _isPictureTooltipOn = true
...
function PaGlobal_Option._functions.IsPartyRefuse(value)
  setIsPartyRefuse(value)
end
function PaGlobal_Option._functions.IsGuildRefuse(value)
...
function PaGlobal_Option._functions.PetNameTagVisible(value)
  setPetNameTagVisible(value)
end
function PaGlobal_Option._functions.FairyNameTagVisible(value)
  setFairyNameTagVisible(value)
end
function PaGlobal_Option._functions.MaidActorNameTagVisible(value)
...
function PaGlobal_Option._functions.WorldMapSaveCameraPos(value)
  setWorldMapSaveCameraPos(value)
end
function PaGlobal_Option._functions.WorldMapSaveCameraRot(value)
...
function PaGlobal_Option._functions.SelfEffectAlpha(value)
