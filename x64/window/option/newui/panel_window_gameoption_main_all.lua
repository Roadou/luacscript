...
function PaGlobal_GameOption_All:InitValue(gameOptionSetting)
  ...
  ToClient_ChangeColorBlindMode(ToClient_getGameUIManagerWrapper():getLuaCacheDataListNumber(__eColorBlindMode))
end
...
function PaGlobal_GameOption_All:SetPictureTooltip(elementName)
  ...
  control:ChangeTextureInfoNameAsync(textureName)
