...
function PaGlobal_GameOption_All:SetGraphicOption(value, isIncrease)
  ...
  if nil ~= _Tessellation._eventGroup then
    ...
    if nil ~= button and nil ~= title and nil ~= desc then
      if self.GRAPHIC.VeryVeryLow == value or self.GRAPHIC.VeryLow == value or self.GRAPHIC.Low == value or self.GRAPHIC.Medium == value or self.GRAPHIC.High == value or self.GRAPHIC.VeryHigh == value or self.GRAPHIC.VeryVeryHigh == value then
        button:SetIgnore(true)
        title:SetMonoTone(true)
        desc:SetMonoTone(true)
      elseif self.GRAPHIC.UltraHigh == value or self.GRAPHIC.UltraLow == value then
  ...
  elseif self.GRAPHIC.High == value or self.GRAPHIC.VeryHigh == value or self.GRAPHIC.VeryVeryHigh == value then
    if true == isIncrease then
      _SSAO._curValue = true
      self:SetAntialiasingValue(1)
      _Dof._curValue = true
  ...
  elseif (self.GRAPHIC.UltraHigh == value or self.GRAPHIC.UltraLow == value) and true == isIncrease then
    _SSAO._curValue = true
    self:SetAntialiasingValue(1)
    _Dof._curValue = true
  end
