...
function PaGlobal_GameOption_All._elements.UIFontType:get(wrapper)
  ...
  if true == isGameTypeNA() and 2 == fontTypeValue then
    fontTypeValue = 1
  end
...
function PaGlobal_GameOption_All._elements.IsPartyRefuse:get(wrapper)
  return wrapper:getIsPartyRefuse()
end
function PaGlobal_GameOption_All._elements.IsGuildRefuse:get(wrapper)
...
function PaGlobal_GameOption_All._elements.PetNameTagVisible:get(wrapper)
  local realValue = wrapper:getPetNameTagVisible()
  for index = 0, 2 do
    if realValue == PaGlobal_GameOption_All._PetNameTagVisibleValue[index] then
      return index
    end
  end
  return 0
end
function PaGlobal_GameOption_All._elements.FairyNameTagVisible:get(wrapper)
  local realValue = wrapper:getFairyNameTagVisible()
  for index = 0, 2 do
    if realValue == PaGlobal_GameOption_All._FairyNameTagVisibleValue[index] then
      return index
    end
  end
  return 0
end
function PaGlobal_GameOption_All._elements.MaidActorNameTagVisible:get(wrapper)
  local realValue = wrapper:getMaidActorNameTagVisible()
  for index = 0, 2 do
    if realValue == PaGlobal_GameOption_All._MaidActorNameTagVisibleValue[index] then
      return index
    end
  end
  return 0
...
function PaGlobal_GameOption_All._elements.WorldMapSaveCameraPos:get(wrapper)
  return wrapper:getWorldMapSaveCameraPos()
end
function PaGlobal_GameOption_All._elements.WorldMapSaveCameraRot:get(wrapper)
...
function PaGlobal_GameOption_All._elements.SelfEffectAlpha:get(wrapper)
  if _ContentsGroup_SelfPlayerEffectAlpha == true then
    return PaGlobal_GameOption_All:FromRealValueToSliderValue(wrapper:getSelfEffectAlpha(), 0.3, 1)
  else
    return PaGlobal_GameOption_All:FromRealValueToSliderValue(1, 0.3, 1)
  end
end
...
function PaGlobal_GameOption_All._elements.AlertGuildCongratulation:get(wrapper)
  return not ToClient_GetMessageFilter(PaGlobal_GameOption_All.ALERT.GuildCongratulation)
end
