...
PaGlobal_GameOption_All._frames = {
  ...
  Graphic = {
    ...
    Effect = {
      ...
      {
        _element = PaGlobal_GameOption_All._elements.EffectAlphaTitle,
        _contentsOption = _ContentsGroup_SelfPlayerEffectAlpha
      },
      {
        _element = PaGlobal_GameOption_All._elements.SelfEffectAlpha,
        _contentsOption = _ContentsGroup_SelfPlayerEffectAlpha
      },
      {
  ...
  Function = {
    ...
    View = {
      ...
      {
        _element = PaGlobal_GameOption_All._elements.MaidActorNameTagVisible,
      ...
      {
        _subTitle = "PANEL_NEWGAMEOPTION_FUNCTION_VIEW_PETNAMETITLE"
      },
      {
        _element = PaGlobal_GameOption_All._elements.PetRender
      },
      {
        _element = PaGlobal_GameOption_All._elements.PetNameTagVisible
      },
      {
        _subTitle = "PANEL_NEWGAMEOPTION_FUNCTION_VIEW_FAIRYNAMETITLE"
      },
      {
      ...
      {
        _element = PaGlobal_GameOption_All._elements.FairyNameTagVisible
      },
      {
    ...
    Alert = {
      ...
      {
        _element = PaGlobal_GameOption_All._elements.AlertGuildCongratulation
      },
      {
    ...
    Worldmap = {
      ...
      {
        _element = PaGlobal_GameOption_All._elements.WorldMapSaveCameraPos
      },
      {
        _element = PaGlobal_GameOption_All._elements.WorldMapSaveCameraRot
      }
    },
    Nation = {
    ...
    Etc = {
      ...
      {
        _element = PaGlobal_GameOption_All._elements.IsPartyRefuse
      },
      {
        _element = PaGlobal_GameOption_All._elements.IsGuildRefuse
      },
      {
