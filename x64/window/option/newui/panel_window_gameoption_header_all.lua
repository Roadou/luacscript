PaGlobal_GameOption_All = {
  ...
  _PetNameTagVisibleValue = {
    [0] = 0,
    [1] = 2
  },
  _FairyNameTagVisibleValue = {
    [0] = 0,
    [1] = 2
  },
  _MaidActorNameTagVisibleValue = {
    [0] = 0,
    [1] = 2
  },
...
PaGlobal_GameOption_All._elements = {
  ...
  EffectAlphaTitle = {_defaultValue = false, _controlType = __ePAUIControl_RadioButton},
  SelfEffectAlpha = {
    _defaultValue = 1,
    _controlType = __ePAUIControl_Slider,
    _sliderValueMin = 30,
  ...
  EffectAlpha = {
    ...
    _sliderValueMin = 30,
    _sliderValueMax = 100,
    _isSubSlider = _ContentsGroup_SelfPlayerEffectAlpha
  },
  SkillPostEffect = {
    _defaultValue = 1,
    _controlType = __ePAUIControl_Slider,
  ...
  AlertGuildCongratulation = {_defaultValue = true, _controlType = __ePAUIControl_CheckButton},
