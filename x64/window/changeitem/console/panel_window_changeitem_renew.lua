...
function PaGlobal_ChangeItem_ShowTooltip(isShow, isChangeItem)
  if isShow then
    if true == isChangeItem and nil ~= self._changeItemKey and false == doChange then
      local changeItemSSW = getItemChange(self._changeItemKey)
      PaGlobalFunc_TooltipInfo_Open(Defines.TooltipDataType.ItemSSWrapper, changeItemSSW, Defines.TooltipTargetType.Item, 0)
