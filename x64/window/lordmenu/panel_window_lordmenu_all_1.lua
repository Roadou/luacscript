function PaGlobal_LordMenu_All:initialize()
  ...
  self._ui._lordTaxSet._txt_LocalTaxTitle:SetShow(false)
  ...
  self._ui._lordTaxSet._btn_AllTaxRateSet:SetShow(false)
  self._ui._lordTaxSet._btn_AllReset:SetShow(false)
...
function PaGlobal_LordMenu_All:copyLocalTaxSlider()
  ...
  for ii = 0, 4 do
    ...
    localTaxInfo._slider:SetShow(false)
    localTaxInfo._txt_tradeTax:SetShow(false)
    localTaxInfo._txt_LowPercent:SetShow(false)
    localTaxInfo._txt_HighPercent:SetShow(false)
    localTaxInfo._stc_Progress:SetShow(false)
    localTaxInfo._slider_TradeTax:SetShow(false)
    localTaxInfo._btn_slider:SetShow(false)
  end
end
function PaGlobal_LordMenu_All:updateTerritoryInfoTab()
  ...
  if false == self._isConsole then
    ...
    if not isSet then
      self._ui._lordInfoArea._stc_GuildMark:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Default/Default_Buttons.dds")
    ...
    if nil ~= markData then
      ...
      if 0 ~= iconIdx then
        self._ui._lordInfoArea._stc_GuildMarkBack:ChangeTextureInfoNameAsync("renewal/commonicon/guildmark/console_icon_guildmark_00.dds")
      ...
      if 0 ~= iconIdx then
        self._ui._lordInfoArea._stc_GuildMark:ChangeTextureInfoNameAsync("renewal/commonicon/guildmark/console_icon_guildmark_00.dds")
