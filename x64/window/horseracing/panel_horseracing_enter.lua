...
function PaGlobal_HorseRacing_Enter:prepareOpen()
  ...
  PaGlobal_HorseRacing_Enter._ui.stc_descBg:ChangeTextureInfoNameAsync(self._baseTexture)
  ...
  for index = 0, rewardCount do
    ...
    if nil ~= originalItemKeyList[index] then
      ...
      if nil ~= itemSSW then
        self._ui.stc_rewardIcon[index]:ChangeTextureInfoNameAsync("Icon/" .. itemSSW:getIconPath())
...
function HandleEventLUp_HorseRacingEnter_SelectMapList()
  ...
  if nil ~= instanceMapSSW then
    ...
    if nil ~= uiTexturePath and nil ~= fieldName then
      ...
      PaGlobal_HorseRacing_Enter._ui.stc_descBg:ChangeTextureInfoNameAsync(uiTexturePath)
...
function PaGlobalFunc_HorseRacingEnter_Join()
  ...
  if hp == maxHp then
    ...
    if _ContentsGroup_HorseRaceMatch == true then
      ToClient_requestJoinMatching(__eMatchMode_Normal, __eInstanceContentsType_HorseRacing, __eHorseRacingMode_Normal, mapKey, 0)
    else
...
function FromClient_HorseRacing_MatchServerConnectSuccess()
  ToClient_requestJoinMatching(__eMatchMode_Count, __eInstanceContentsType_HorseRacing, 0, -1, 0)
end
