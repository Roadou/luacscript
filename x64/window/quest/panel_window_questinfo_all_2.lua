...
function PaGlobalFunc_QuestInfo_All_Detail(groupId, questId, uiCondition, groupTitle, questGroupCount, fromQuestWidget, isRecommand, isNextQuest, isCleared, isAccepted, uiIdx, ignoreToggle)
  if nil == Panel_Window_QuestInfo_All then
    return
  end
  if true == Panel_Window_QuestInfo_All:IsUISubApp() then
  ...
  if ignoreToggle == false and PaGlobal_QuestInfo_All._OpenInfo._groupId == groupId and PaGlobal_QuestInfo_All._OpenInfo._questId == questId then
    PaGlobalFunc_QuestInfo_All_Close()
    return
  end
