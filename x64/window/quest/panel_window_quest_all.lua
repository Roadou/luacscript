PaGlobal_Quest_All = {
  _ui = {
    ...
    radio_new = nil,
    stc_selectBar = nil,
    combo_questSearchType = nil,
    stc_searchGroup = nil,
    edt_search = nil,
    stc_searchFunction = nil,
    btn_searchUp = nil,
    btn_searchUpDisable = nil,
    btn_searchDown = nil,
    btn_searchDownDisable = nil,
    btn_searchPCUI = nil,
    btn_searchReset = nil,
    txt_searchCount = nil,
    stc_groupTypeBG = nil,
    txt_questCnt = nil,
    combo_questSortType = nil,
    radio_questType = nil,
  ...
  _regionString = {
    ...
    [CppEnums.QuestRegionType.eQuestRegionType_Ulukita] = PAGetString(Defines.StringSheet_GAME, "LUA_QUESTLIST_HISTORY_TXT_REGION_14"),
    [CppEnums.QuestRegionType.eQuestRegionType_PEDU] = PAGetString(Defines.StringSheet_GAME, "LUA_QUESTLIST_HISTORY_TXT_REGION_17")
  },
  _regionOpen = {
    ...
    [CppEnums.QuestRegionType.eQuestRegionType_Ulukita] = {isOpen = true, isLoading = false},
    [CppEnums.QuestRegionType.eQuestRegionType_PEDU] = {isOpen = false, isLoading = false},
  ...
  _typeString = {
    ...
    [__eQuestType_DirectClear] = PAGetString(Defines.StringSheet_GAME, "LUA_QUESTLIST_HISTORY_TXT_REGION_99"),
  ...
  _typeOpen = {
    ...
    [__eQuestType_DirectClear] = {isOpen = true, isLoading = false},
  ...
  _questArrayRegionSort = {
    ...
    [14] = CppEnums.QuestRegionType.eQuestRegionType_Ulukita,
    [15] = CppEnums.QuestRegionType.eQuestRegionType_PEDU,
    [16] = CppEnums.QuestRegionType.eQuestRegionType_None
  },
  _questSortArrayType = {},
