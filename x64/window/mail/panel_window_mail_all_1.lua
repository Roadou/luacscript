...
function PaGlobal_Window_Mail_All:createMailControl()
  ...
  for index = 1, self._rowMax do
    if nil == self._ui._mail[index] then
      ...
      mail.txt_expirateDate:addInputEvent("Mouse_LUp", "HandleEventLUp_Mail_All_GetDetail(" .. index .. ")")
      mail.txt_expirateDate:addInputEvent("Mouse_DownScroll", "HandleEventLUp_Mail_All_ChangePage(true)")
      mail.txt_expirateDate:addInputEvent("Mouse_UpScroll", "HandleEventLUp_Mail_All_ChangePage(false)")
