...
function PaGlobal_TotalReward:dataSet()
  ...
  if rewardCnt > 0 then
    ...
    PaGlobal_TotalReward._ui.btn_receiveAll:ChangeTextureInfoNameAsync("renewal/PcRemaster/Remaster_Common_00.dds")
  ...
  if 0 == PaGlobal_TotalReward.rewardSilver then
    PaGlobal_TotalReward._ui.btn_receive:ChangeTextureInfoNameAsync("renewal/PcRemaster/Remaster_Common_00.dds")
  ...
  if logCount > 0 then
    ...
    for ii = 1, #logTable do
      ...
      if logTable[ii].color ~= nil then
        ...
        control:ChangeTextureInfoNameAsync("renewal/pcremaster/remaster_common_00.dds")
        control:setRenderTexture(control:getBaseTexture())
        nextPosY = nextPosY + 10
        control:SetPosY(nextPosY)
        nextPosY = nextPosY + 5
      else
        control:ChangeTextureInfoNameAsync("")
        control:setRenderTexture(control:getBaseTexture())
      end
