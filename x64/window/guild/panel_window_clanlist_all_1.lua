...
function PaGlobal_ClanList_All:initControl()
  ...
  if true == self._isConsole then
    self._ui.template_memberBG:ChangeOnTextureInfoNameAsync("combine/btn/combine_btn_00.dds")
    ...
    self._ui.template_memberBG:ChangeClickTextureInfoNameAsync("combine/btn/combine_btn_00.dds")
...
function PaGlobal_ClanList_All:listUpdate()
  ...
  for memberIdx = 0, memberCount - 1 do
    ...
    if true == memberData:isOnline() then
      ...
      uiPool.memberClass:SetText(NewClassData.newClass_String[classType]._classType2String)
    else
