...
function AgreementGuild:Initialize()
  ...
  self._chk_AlwaysRefuse:SetCheck(isGuildRefuse)
...
function PaGlobal_AgreementGuild_RefuseOption()
  ...
  setIsGuildRefuse(self._chk_AlwaysRefuse:IsCheck())
end
...
function AgreementGuild:Update()
  ...
  if false == isSet then
    self.GuildMark:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Default/Default_Buttons.dds")
