...
function CreateListContent_GuildBattle_EntryMember(content, index)
  ...
  local classSymbomInfo = NewClassData.newClass_Texture_ID[memberInfo:getClassType()]._symbolTextureTID
  if classSymbomInfo ~= nil then
    static_ClassIcon:ChangeTextureInfoTextureIDAsync(classSymbomInfo, 0)
