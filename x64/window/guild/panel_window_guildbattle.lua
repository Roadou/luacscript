...
function PaGlobal_GuildBattle:SetProgressServer(cancel)
  ...
  if true == isReserve then
    ToClient_RequestNakMessageRenewel(__eNakMessage_GuildBattleReserve)
  elseif true == cancel then
    ToClient_RequestNakMessageRenewel(__eNakMessage_GuildBattleCancel)
  else
    ToClient_RequestNakMessageRenewel(__eNakMessage_GuildBattleEnd)
  end
...
function PaGlobal_GuildBattle:SetGuildMark(guildNo, mark)
  ...
  if false == isSet then
    mark:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Default/Default_Buttons.dds")
...
function PaGlobal_GuildBattle:notifyJoinGuildBattle()
  ToClient_RequestNakMessageRenewel(__eNakMessage_GuildBattleSuccess)
