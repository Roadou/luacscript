...
function PaGlobal_GuildIncentiveOption_All:ControlSetShow()
  ...
  if true == self._isConsole then
    ...
    self._ui.stc_listTemp:ChangeTextureInfoNameAsync("")
...
function PaGlobal_GuildIncentiveOption_All:CreateControl()
  ...
  local function createListInfo(pIndex)
    ...
    if true == self._isConsole then
      ...
      tempMember._btn_IncentiveLevel:ChangeTextureInfoNameAsync("")
    else
...
function PaGlobal_GuildIncentiveOption_All:updateListInfo()
  ...
  for i = 1, memberCount do
    ...
    self._ui._memberlist[index]._grade:ChangeTextureInfoNameAsync("Renewal/PcRemaster/Remaster_ETC_Guild.dds")
    ...
    elseif __eGuildMemberGradeAdviser == gradeType then
      self._ui._memberlist[index]._grade:ChangeTextureInfoNameAsync("Combine/Etc/Combine_Etc_Guild_00.dds")
    ...
    elseif __eGuildMemberGradeJunior == gradeType then
      self._ui._memberlist[index]._grade:ChangeTextureInfoNameAsync("Renewal/PcRemaster/Remaster_ETC_Guild01.dds")
