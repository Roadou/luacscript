...
function PaGlobal_GuildAllianceInvite_All:registEventHandler()
  ...
  registerEvent("FromClient_CheckChinaProhibitedWord_RegistAllianceName", "FromClient_CheckChinaProhibitedWord_RegistAllianceName")
  registerEvent("FromClient_CheckChinaProhibitedWord_RegistGuildNameMakingAlliance", "FromClient_CheckChinaProhibitedWord_RegistGuildNameMakingAlliance")
end
