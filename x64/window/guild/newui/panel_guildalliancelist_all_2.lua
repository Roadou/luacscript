...
function FromClient_GuildAlliance_All_List2MemberUpdate(content, key)
  ...
  local classType = NewClassData.newClass_String[member:getClassType()]._classType2String
  ...
  stc_gradeIcon:ChangeTextureInfoNameAsync("new_ui_common_forlua/window/guild/guild_00.dds")
  stc_gradeIcon:SetIgnore(false)
  if __eGuildMemberGradeMaster == grade then
    stc_gradeIcon:ChangeTextureInfoNameAsync("Combine/Etc/Combine_Etc_Guild_00.dds")
