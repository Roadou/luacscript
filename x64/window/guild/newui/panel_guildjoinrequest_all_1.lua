...
function PaGlobal_GuildJoinRequestList_All:createList(content, index)
  ...
  txt_class:SetText(NewClassData.newClass_String[applicantInfoWrapper:getClassType()]._classType2String)
  ...
  if ToClient_isPS5() == true then
    ...
    stc_platformIcon:ChangeTextureInfoNameAsync(iconTextureName)
