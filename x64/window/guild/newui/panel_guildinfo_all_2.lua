  ...
  if true == isRightDismiss then
    if myGuildInfo:getMemberCount() <= 1 then
      ...
      if _ContentsGroup_GuildRevamp == true then
        local msgData = {
          confirmText = PAGetString(Defines.StringSheet_GAME, "LUA_GUILD_DISPERSE_GUILD"),
          functionYes = GuildDismiss,
          functionNo = nil,
          desc = PAGetString(Defines.StringSheet_GAME, "LUA_GUILD_DISPERSE_GUILD_ASK"),
          bottomRedDesc = "",
          isBlockBgShow = true,
          addPanelSizeX = 70,
    ...
    if _ContentsGroup_GuildRevamp == true then
      local msgData = {
        confirmText = PAGetString(Defines.StringSheet_GAME, "LUA_GUILD_WITHDRAW_GUILD"),
        functionYes = GuildOut,
        functionNo = nil,
        desc = PAGetString(Defines.StringSheet_GAME, "LUA_GUILD_WITHDRAW_GUILD_ASK") .. PAGetString(Defines.StringSheet_GAME, "LUA_GUILD_TEXT_GUILD_MENTINFO"),
        bottomRedDesc = "",
        isBlockBgShow = true,
        addPanelSizeX = 70,
        varyDescTextControlSizeX = 30,
