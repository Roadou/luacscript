...
function HandleEventPadPress_GuildChangeMark_All_SelectBg(idx)
  ...
  PaGlobal_GuildChangeMark_All._ui.stc_CurrentBg:ChangeTextureInfoNameAsync("renewal/commonicon/guildmark/console_icon_guildmark_00.dds")
...
function HandleEventPadPress_GuildChangeMark_All_SelectIcon(idx)
  ...
  PaGlobal_GuildChangeMark_All._ui.stc_CurrentMark:ChangeTextureInfoNameAsync("renewal/commonicon/guildmark/console_icon_guildmark_00.dds")
