PaGlobal_GuildFunctionPanel_All = {
  ...
  _btnString = {
    ...
    PAGetString(Defines.StringSheet_GAME, "PANEL_GUILDQUESTLIST_CHECK_1"),
    PAGetString(Defines.StringSheet_GAME, "PANEL_GUILDQUESTLIST_CHECK_2"),
    PAGetString(Defines.StringSheet_GAME, "PANEL_GUILDQUESTLIST_CHECK_3"),
    PAGetString(Defines.StringSheet_GAME, "PANEL_GUILDQUESTLIST_CHECK_4")
  },
  _eOpenType = {
    INFO = 0,
    LIST = 1,
  ...
  _originPanelSizeX = 0,
  _originPanelSizeY = 0,
  _originKeyGuideSizeX = 0,
  _originKeyGuideSizeY = 0,
  _funcBtnTable1 = {},
  _funcBtnTable2 = {},
  _columnMode = 2,
  _openType = nil,
