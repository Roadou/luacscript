...
function PaGlobal_WorkerRandomSelectOption_All:prepareClose()
  ...
  if false == self._isConsole then
    ...
    if _ContentsGroup_UseCharacterWp == true then
      Panel_Window_UseCharacterWp_All:SetIgnoreChild(false)
      PaGlobalFunc_UseCharacterWp_All_SetIgnoreControl()
    end
  end
...
function PaGlobal_WorkerRandomSelectOption_All:prepareOpen()
  ...
  if false == self._isConsole then
    ...
    if _ContentsGroup_UseCharacterWp == true then
      Panel_Window_UseCharacterWp_All:SetIgnoreChild(true)
    end
  end
  PaGlobal_WorkerRandomSelectOption_All:clearData()
  ...
  if _ContentsGroup_WorkerImprovement == true then
    ...
    self._config._repetitionCount = math.floor(wp / 5)
    self._config._workerGrade = self._ENUM_GRADE._EXPERT
  end
