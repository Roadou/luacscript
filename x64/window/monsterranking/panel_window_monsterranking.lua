...
function FGlobal_MonsterRanking_Open()
  ...
  for listCount = 0, listMaxCount - 1 do
    if true == ToClient_GetShowTimeAttackRankUI(listCount) then
...
function PaGlobal_MonsterRanking:MonsterRanking_Rank_ListControlCreate(content, key)
  ...
  local isGuild = titleInfo:isGuild()
  name:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Default/Default_Buttons.dds")
  ...
  if 0 == index then
    rank:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Default/Default_Etc_03.dds")
  ...
  elseif 2 == index then
    ...
    rank:ChangeTextureInfoNameAsync("")
