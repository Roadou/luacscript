...
function HandleEventLUp_UseItem_All_UseItem()
  ...
  if selfProxy ~= nil and selfProxy:doRideMyVehicle() then
    local itemStatic = PaGlobal_UseItem_All._popupItemWrapper:get()
    if itemStatic:isUseToVehicle() then
      inventoryUseItem(PaGlobal_UseItem_All._popupItem.selectWhereType, PaGlobal_UseItem_All._popupItem.selectSlotNo, PaGlobal_UseItem_All._popupItem.selectEquipNo, false)
      return
    end
  end
