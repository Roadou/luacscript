...
function PaGlobal_BloodAltarGauge_All:registEventHandler()
  ...
  registerEvent("FromClient_JoinBloodAltar", "FromClient_BloodAltarGauge_Open")
...
function PaGlobal_BloodAltarGauge_All:prepareOpen()
  ...
  if _ContentsGroup_bloodAltar_renewal == false then
    return
  end
  if ToClient_IsInstanceFieldPlayerbyContentsType(__eInstanceContentsType_SavageDefence) == false then
    return
  end
