...
if (isGameTypeJapan() or isGameTypeRussia() or isGameTypeNA() or isGameTypeTaiwan()) and getContentsServiceType() == CppEnums.ContentsServiceType.eContentsServiceType_CBT then
  countryType = false
