...
function PaGlobal_Arsha_Replay_Party_All:createTeamUi()
  ...
  for teamNo, teamMemberList in pairs(self._teamMember) do
    ...
    for userIndex = 0, teamUserCount - 1 do
      if self._teamMemberUi[teamNo][userIndex] == nil then
        ...
        temp._circleBg:ChangeTextureInfoNameAsync("Combine/Etc/Combine_Etc_Arsha_00.dds")
  ...
  ReplaySkillCooltime_SetPosY(leftTeamBottomPosY, rightTeamBottomPosY)
end
            ...
            if nil ~= userSlot._buffList[idx + 1] then
              ...
              if true == isExist then
                ...
                if skillCool <= 0 then
                  ...
                  userSlot._buffList[idx + 1]:ChangeTextureInfoNameAsync("Icon/" .. skillIcon)
  ...
  if false == self._isCreatePersonal then
    for teamNo = 1, 2 do
      ...
      if true == isLeftTeam then
        ...
        temp._circleBg = UI.getChildControl(temp._memberBg, "Static_CircleBG")
        temp._circleBg:ChangeTextureInfoNameAsync(replayTemaCirclePath)
