...
function PaGlobal_PartyList_All:controlPc_Init()
  ...
  self._ui_pc.stc_offenceTitle_pc = UI.getChildControl(self._ui_pc.stc_listTitleBg, "StaticText_OffenceTitle")
  self._ui_pc.stc_defenceTitle_pc = UI.getChildControl(self._ui_pc.stc_listTitleBg, "StaticText_DefenceTitle")
end
function PaGlobal_PartyList_All:controlConsole_Init()
  ...
  self._ui_console.stc_LT_Y_ConsoleUI = UI.getChildControl(self._ui_console.stc_bottomBg, "StaticText_LT_Y_ConsoleUI")
  self._ui_console.stc_LT_Y_ConsoleUI:SetText(PAGetString(Defines.StringSheet_GAME, "FRIEND_TEXT_XBOX_PROFILE"))
  ...
  self._ui_console.stc_offenceTitle_console = UI.getChildControl(self._ui_console.stc_listTitleBg, "StaticText_OffenceTitle")
  self._ui_console.stc_defenceTitle_console = UI.getChildControl(self._ui_console.stc_listTitleBg, "StaticText_DefenceTitle")
  ...
  self._keyGuideAlign = {
    self._ui_console.stc_LT_Y_ConsoleUI,
...
function PaGlobal_PartyList_All:controlSetShow()
  ...
  if false == self._isPadSnap then
    ...
    self._ui_pc.stc_offenceTitle_pc:SetShow(_ContentsGroup_PartyMatching_Limit_OtherServerInvite)
    self._ui_pc.stc_defenceTitle_pc:SetShow(_ContentsGroup_PartyMatching_Limit_OtherServerInvite)
  else
    ...
    self._ui_console.stc_LT_Y_ConsoleUI:SetShow(ToClient_isXBoxSeries())
    ...
    self._ui_console.stc_offenceTitle_console:SetShow(_ContentsGroup_PartyMatching_Limit_OtherServerInvite)
    self._ui_console.stc_defenceTitle_console:SetShow(_ContentsGroup_PartyMatching_Limit_OtherServerInvite)
  end
end
...
function PaGlobal_PartyList_All:prepareClose()
  ...
  if _ContentsOption_CH_CheckProhibitedWord == true then
    if self._isPadSnap == false then
      self._ui.btn_search:SetIgnore(false)
...
function PaGlobal_PartyList_All:validate()
  ...
  if false == self._isPadSnap then
    ...
    self._ui_console.stc_LT_Y_ConsoleUI:isValidate()
...
function PaGlobal_PartyList_All:registEventHandler()
  ...
  if false == self._isPadSnap then
    ...
    self._ui_pc.stc_offenceTitle_pc:addInputEvent("Mouse_On", "HandleEventOnOut_PartyList_All_OffDefToolTip(true, 'off')")
    self._ui_pc.stc_offenceTitle_pc:addInputEvent("Mouse_Out", "HandleEventOnOut_PartyList_All_OffDefToolTip(false, 'off')")
    self._ui_pc.stc_defenceTitle_pc:addInputEvent("Mouse_On", "HandleEventOnOut_PartyList_All_OffDefToolTip(true, 'def')")
    self._ui_pc.stc_defenceTitle_pc:addInputEvent("Mouse_Out", "HandleEventOnOut_PartyList_All_OffDefToolTip(false, 'def')")
  else
...
function PaGlobalFunc_PartyList_All_ControlCreate(control, key)
  ...
  local offence = UI.getChildControl(control, "StaticText_Offence")
  local defence = UI.getChildControl(control, "StaticText_Defence")
  ...
  if false == PaGlobal_PartyList_All._isPadSnap then
    ...
    if ToClient_isXBoxSeries() == true then
      control:registerPadEvent(__eConsoleUIPadEvent_LTPress_Y, "PadEventLTYUp_PartyList_All_ShowXboxProfile(" .. tostring(_key) .. ")")
    end
  ...
  offence:SetText(tostring(partyWrapper:getMinOffence()))
  defence:SetText(tostring(partyWrapper:getMinDefence()))
  offence:SetShow(_ContentsGroup_PartyMatching_Limit_OtherServerInvite)
  defence:SetShow(_ContentsGroup_PartyMatching_Limit_OtherServerInvite)
  ...
  if _ContentsGroup_PartyMatching_Limit_OtherServerInvite == false and currentServerNo ~= serverNo then
    local busyState = 0
    local channelCount = getGameChannelServerDataCount(curWorldData._worldNo)
  ...
  elseif myPartyNo == partyNo then
    if isPartyLeader == true then
      if PaGlobal_PartyList_All._isPadSnap == false then
      ...
      offence:SetFontColor(Defines.Color.C_FFFFF3AF)
      defence:SetFontColor(Defines.Color.C_FFFFF3AF)
