...
function PaGlobal_PartyRecruite_All:controlAll_Init()
  ...
  self._ui.stc_offence = UI.getChildControl(self._ui.stc_centerBg, "Static_Offence")
  self._ui.stc_defence = UI.getChildControl(self._ui.stc_centerBg, "Static_Defence")
  ...
  if _ContentsGroup_PartyMatching_Limit_OtherServerInvite == true then
    self._ui.stc_level:SetSize(180, 50)
    self._ui.stc_offence:SetShow(true)
    self._ui.stc_defence:SetShow(true)
    UI.getChildControl(self._ui.stc_centerBg, "StaticText_OffenceTitle"):SetShow(true)
    UI.getChildControl(self._ui.stc_centerBg, "StaticText_DefenceTitle"):SetShow(true)
  end
end
...
function PaGlobal_PartyRecruite_All:registEventHandler()
  ...
  self._ui.stc_offence:addInputEvent("Mouse_LUp", "PaGlobalFunc_PartyRecruite_All_OffenceChange()")
  self._ui.stc_defence:addInputEvent("Mouse_LUp", "PaGlobalFunc_PartyRecruite_All_DefenceChange()")
  self._ui.stc_offence:addInputEvent("Mouse_On", "PaGlobalFunc_PartyRecruite_All_OffDefToolTip('off', true)")
  self._ui.stc_defence:addInputEvent("Mouse_On", "PaGlobalFunc_PartyRecruite_All_OffDefToolTip('def', true)")
  self._ui.stc_offence:addInputEvent("Mouse_Out", "PaGlobalFunc_PartyRecruite_All_OffDefToolTip('off', false)")
  self._ui.stc_defence:addInputEvent("Mouse_Out", "PaGlobalFunc_PartyRecruite_All_OffDefToolTip('def', false)")
  if false == _ContentsGroup_UsePadSnapping then
    ...
    Panel_PartyRecruite_All:registerPadEvent(__eConsoleUIPadEvent_Up_A, "")
    Panel_PartyRecruite_All:registerPadEvent(__eConsoleUIPadEvent_Up_Y, "HandleEventLUp_PartyRecruite_All_Request()")
...
function PaGlobal_PartyRecruite_All:prepareOpen(isGuildParty)
  ...
  self._selectLevel = 1
  self._selectOffence = 0
  self._selectDeffence = 0
  ...
  if nil ~= selfPlayer and false == _ContentsGroup_UsePadSnapping then
    ...
    self._ui.stc_offence:SetText(PAGetStringParam1(Defines.StringSheet_GAME, "LUA_PARTYLISTRECRUITE_MINOFFENCE", "offence", 0))
    self._ui.stc_defence:SetText(PAGetStringParam1(Defines.StringSheet_GAME, "LUA_PARTYLISTRECRUITE_MINDEFENCE", "defence", 0))
  else
    self._ui.stc_level:SetText(tostring(self._selectLevel))
    self._ui.stc_offence:SetText(tostring(self._selectOffence))
    self._ui.stc_defence:SetText(tostring(self._selectDeffence))
  end
...
function PaGlobal_PartyRecruite_All:validate()
  ...
  self._ui.stc_offence:isValidate()
  self._ui.stc_defence:isValidate()
