...
function PaGlobal_DailyStamp_All:dailyInit()
  ...
  for index = 0, self._rewardCount - 1 do
    ...
    if isGameTypeNA() or isGameTypeRussia() then
...
function PaGlobalFunc_DailyStamp_All_StampAnimation(deltaTime)
  ...
  if false == ToClinet_getShowRewardNotice() then
    ...
    if PaGlobal_DailyStamp_All._rewardRemindTime > 1 then
      ToClinet_setShowRewardNotice(true)
...
function PaGlobalFunc_DailyStamp_All_ChangeTexture(index, recieveType, itemGradeType)
  ...
  local function SetDayTexture(baseT, onT, clickT)
    local x1, y1, x2, y2
    PaGlobal_DailyStamp_All._dayControl[index]._dayControl:ChangeTextureInfoNameAsync(baseT.texture)
    ...
    PaGlobal_DailyStamp_All._dayControl[index]._dayControl:ChangeOnTextureInfoNameAsync(onT.texture)
    ...
    PaGlobal_DailyStamp_All._dayControl[index]._dayControl:ChangeClickTextureInfoNameAsync(clickT.texture)
