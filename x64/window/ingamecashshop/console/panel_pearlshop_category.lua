...
function pearlShopCategory:initMainCategory()
  ...
  for i = 0, self._ui._mainCategoryControlListSize - 1 do
    ...
    buttonControl:ChangeTextureInfoNameAsync("renewal/ETC/Console_ETC_CashShop_00.dds")
...
function pearlShopCategory:initBannerArea()
  ...
  for ii = 0, #self._ui.stc_bannerBGs do
    ...
    self._ui.stc_bannerBGs[ii]:registerPadEvent(__eConsoleUIPadEvent_Up_A, "Input_PearlShopCategory_ToWebBanner(\"A\", " .. ii .. ")")
  ...
  if true == _ContentsGroup_Console_WebBanner then
    ...
    if _ContentsGroup_UsingPMAPI == true then
      if nil == domainURL or "" == domainURL then
        ...
        domainURL = "https://" .. domainURL .. "/Console/" .. cultureCode .. "/Game/InGame/PositionBanner?bannerType=1"
      end
