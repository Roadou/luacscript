...
function IngameCashShopCoupon_ListUpdate(contents, key)
  ...
  btn_Coupon:ChangeTextureInfoNameAsync("new_ui_common_forlua/window/ingamecashshop/cashshop_coupon_01.dds")
  ...
  btn_Coupon:ChangeClickTextureInfoNameAsync("new_ui_common_forlua/window/ingamecashshop/cashshop_coupon_01.dds")
  ...
  if nil ~= couponWrapper then
    ...
    if isGameTypeRussia() or isGameTypeNA() or isGameTypeTaiwan() then
...
function IngameCashShopCoupon_MouseOver(isShow, idx)
  ...
  local btn_Coupon = UI.getChildControl(contents, "RadioButton_CouponBG")
  local isCouponSavedIdx = selectKey
  btn_Coupon:ChangeOnTextureInfoNameAsync("new_ui_common_forlua/window/ingamecashshop/cashshop_coupon_01.dds")
