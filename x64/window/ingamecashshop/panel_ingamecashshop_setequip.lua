  ...
  if (true ~= hasEquipment or false ~= hasLantern) and true == hasUsableServant then
    ...
    if self.hasServantType == CppEnums.ServantKind.Type_Horse then
      ...
      elseif productNoRaw == 102091 then
        ...
        getIngameCashMall():clearEquipViewList()
      elseif productNoRaw == 102092 then
        characterKeyRaw = 31539
        getIngameCashMall():clearEquipViewList()
      elseif productNoRaw == 102093 then
        characterKeyRaw = 31619
        getIngameCashMall():clearEquipViewList()
      ...
      elseif productNoRaw == 102097 then
        ...
        getIngameCashMall():clearEquipViewList()
      elseif productNoRaw == 111452 then
        characterKeyRaw = 31611
        getIngameCashMall():clearEquipViewList()
      elseif productNoRaw == 117879 then
        characterKeyRaw = 31595
        getIngameCashMall():clearEquipViewList()
      end
    end
    CashShopController_ForceOffAllButton()
...
function HandleClicked_PercentWebLink_Open()
  PaGlobalFunc_Util_OpenRateView()
end
...
function FGlobal_CashShop_SetEquip_SelectedItem(productNoRaw)
  ...
  if 4 ~= self.savedTabType then
    ...
    elseif 4 == isMainCategory then
      ...
      self.petLookBG:SetShow(false)
      self.cameraControlBG:SetSpanSize(17, 150)
    elseif 9 == isMainCategory and isGameTypeNA() then
      self.static_SetOptionBG:SetShow(true)
      self.petLookBG:SetShow(false)
      self.cameraControlBG:SetSpanSize(17, 150)
    else
...
function HandleClicked_CashShopController_ToggleUnderWear()
  ...
  if selfPlayer ~= nil and (selfPlayer:get():isWearingBack() == true or getIngameCashMall():isWearingBack() == true) then
    ...
    self.btn_ShowUnderwear:SetCheck(not isChecked)
    return
  end
  local isChecked = self.btn_ShowUnderwear:IsCheck()
...
function PaGlobalFunc_IngameCashShopSetEquip_RightTopBtnAlign()
  ...
  if _ContentsGroup_PearlShopMoonBlessingRenew == true and PaGlobal_MoonBlessingRenew_IsOpenCheck() == true then
    CashShopController.btn_Mileage:addInputEvent("Mouse_LUp", "HandleEventLUp_IngameCashShopMoonBlessing_Renew_All_Open()")
    CashShopController.btn_Mileage:SetShow(true)
  else
    CashShopController.btn_Mileage:SetShow(false)
  end
...
function CashShopController:updateButtonImageAwakenWeapon()
  ...
  if __eClassType_ShyWaman == classType then
    self.btn_AwakenWeapon:ChangeTextureInfoNameAsync("Renewal/PcRemaster/Remaster_Btn_01.dds")
    ...
    self.btn_AwakenWeapon:ChangeOnTextureInfoNameAsync("Renewal/PcRemaster/Remaster_Btn_01.dds")
    ...
    self.btn_AwakenWeapon:ChangeClickTextureInfoNameAsync("Renewal/PcRemaster/Remaster_Btn_01.dds")
    ...
    self.btn_AwakenWeapon:ChangeTextureInfoNameAsync("Renewal/PcRemaster/Remaster_Btn_00.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(self.btn_AwakenWeapon, 202, 242, 234, 274)
    self.btn_AwakenWeapon:getBaseTexture():setUV(x1, y1, x2, y2)
    self.btn_AwakenWeapon:ChangeOnTextureInfoNameAsync("Renewal/PcRemaster/Remaster_Btn_00.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(self.btn_AwakenWeapon, 235, 242, 267, 274)
    self.btn_AwakenWeapon:getOnTexture():setUV(x1, y1, x2, y2)
    self.btn_AwakenWeapon:ChangeClickTextureInfoNameAsync("Renewal/PcRemaster/Remaster_Btn_00.dds")
