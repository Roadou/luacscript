function PaGlobal_IngameCashShopMoonBlessing_Renew_All:initialize()
  if self._initialize == true or Panel_IngameCashShop_MoonBlessing_Renew_All == nil then
    return
  end
  if _ContentsGroup_PearlShopMoonBlessingRenew == false then
    return
  end
  self:controlInitialize()
  self._ui._contentsGroup[self.MILEAGE_TYPE.CHARGED] = self._ui._chargedGroup.stc_bg
  ...
  self._ui._tabTypeBtnGroup[self.MILEAGE_TYPE.CHARGED][self.CHALLENGE_TYPE.MONTHLY] = self._ui._chargedGroup.rdo_montly
  self._ui._tabTypeBtnGroup[self.MILEAGE_TYPE.CHARGED][self.CHALLENGE_TYPE.WEEKLY] = self._ui._chargedGroup.rdo_weekly
  self._ui._tabTypeBtnGroup[self.MILEAGE_TYPE.CHARGED][self.CHALLENGE_TYPE.DAILY] = self._ui._chargedGroup.rdo_daily
  ...
  self._saveSize.panelY = Panel_IngameCashShop_MoonBlessing_Renew_All:GetSizeY()
  self._saveSize.centerBgY = self._ui.stc_centerBg:GetSizeY()
  if ToClient_GetCurrentMoonblessingPearlUsed() ~= nil then
    self._nowUsedPearl = ToClient_GetCurrentMoonblessingPearlUsed()
  end
...
function PaGlobal_IngameCashShopMoonBlessing_Renew_All:controlInitialize()
  self._ui.stc_titleBg = UI.getChildControl(Panel_IngameCashShop_MoonBlessing_Renew_All, "Static_TopGroup")
  self._ui.stc_radioBg = UI.getChildControl(Panel_IngameCashShop_MoonBlessing_Renew_All, "Static_RadioGroup")
  ...
  self._ui.stc_tabBg = UI.getChildControl(Panel_IngameCashShop_MoonBlessing_Renew_All, "Static_Tap_Btn_Group")
  ...
  self._ui.txt_nochallenge = UI.getChildControl(Panel_IngameCashShop_MoonBlessing_Renew_All, "StaticText_NoChallenge")
  self._ui.stc_centerBg = UI.getChildControl(Panel_IngameCashShop_MoonBlessing_Renew_All, "Static_Center_Bg")
  self._ui._chargedGroup.stc_bg = UI.getChildControl(Panel_IngameCashShop_MoonBlessing_Renew_All, "Static_Charged_Group")
  self._ui._chargedGroup.stc_rdoBg = UI.getChildControl(self._ui._chargedGroup.stc_bg, "Static_Type_Btn_Group")
  self._ui._chargedGroup.rdo_montly = UI.getChildControl(self._ui._chargedGroup.stc_rdoBg, "RadioButton_Monthly")
  self._ui._chargedGroup.rdo_weekly = UI.getChildControl(self._ui._chargedGroup.stc_rdoBg, "RadioButton_Weekly")
  self._ui._chargedGroup.rdo_daily = UI.getChildControl(self._ui._chargedGroup.stc_rdoBg, "RadioButton_Daily")
  self._ui._list2_mileage[self.MILEAGE_TYPE.CHARGED] = UI.getChildControl(self._ui._chargedGroup.stc_bg, "List2_MileageList")
  self._ui._consumedGroup.stc_bg = UI.getChildControl(Panel_IngameCashShop_MoonBlessing_Renew_All, "Static_Consumed_Group")
  ...
  self._ui.txt_resetInfo = UI.getChildControl(Panel_IngameCashShop_MoonBlessing_Renew_All, "StaticText_ResetInfo")
  self._ui.txt_periodInfo = UI.getChildControl(Panel_IngameCashShop_MoonBlessing_Renew_All, "StaticText_PeriodInfo")
  ...
  self._ui_console.stc_keyGuideBG = UI.getChildControl(Panel_IngameCashShop_MoonBlessing_Renew_All, "Static_KeyGuide")
  ...
  self._ui_console.stc_keyGuideY = UI.getChildControl(self._ui_console.stc_keyGuideBG, "StaticText_YButton")
  self._ui._stc_resetArea = UI.getChildControl(Panel_IngameCashShop_MoonBlessing_Renew_All, "Static_Month_Repeat")
...
function PaGlobal_IngameCashShopMoonBlessing_Renew_All:swichPlatform(isConsole)
  if Panel_IngameCashShop_MoonBlessing_Renew_All == nil then
    return
  end
  if self._isConsole == true then
    ...
    self._ui_console.stc_keyGuideY:SetShow(true)
    ...
    self._ui_console.stc_keyGuideY:SetShow(false)
...
function PaGlobal_IngameCashShopMoonBlessing_Renew_All:prepareOpen()
  if Panel_IngameCashShop_MoonBlessing_Renew_All == nil or _ContentsGroup_PearlShopMoonBlessingRenew == false then
    return
  end
  self._ui.stc_radioBg:SetShow(false)
  self:open()
  self:swichPlatform(self._isConsole)
  self:update(self.MILEAGE_TYPE.CONSUMED)
  self:resize()
end
function PaGlobal_IngameCashShopMoonBlessing_Renew_All:open()
  if Panel_IngameCashShop_MoonBlessing_Renew_All == nil or _ContentsGroup_PearlShopMoonBlessingRenew == false then
    return
  end
  Panel_IngameCashShop_MoonBlessing_Renew_All:SetShow(true)
end
function PaGlobal_IngameCashShopMoonBlessing_Renew_All:prepareClose()
  if Panel_IngameCashShop_MoonBlessing_Renew_All == nil then
    return
  end
  TooltipSimple_Hide()
...
function PaGlobal_IngameCashShopMoonBlessing_Renew_All:close()
  if Panel_IngameCashShop_MoonBlessing_Renew_All == nil then
    return
  end
  Panel_IngameCashShop_MoonBlessing_Renew_All:SetShow(false)
end
function PaGlobal_IngameCashShopMoonBlessing_Renew_All:update(mileageType, tabIndex)
  if Panel_IngameCashShop_MoonBlessing_Renew_All == nil or _ContentsGroup_PearlShopMoonBlessingRenew == false then
    return
  end
  self._nowMileageInfoKey = self.MILEAGE_TYPE.CONSUMED
...
function PaGlobal_IngameCashShopMoonBlessing_Renew_All:refreshRewardInfo(mileageType, challengeType)
  if Panel_IngameCashShop_MoonBlessing_Renew_All == nil then
    return
  end
  self._mileageInfo = Array.new()
  self._mileageStepInfo = Array.new()
  self._mileageInfoCnt = 0
  local tempCnt = 0
  if mileageType == self.MILEAGE_TYPE.CHARGED then
  elseif mileageType == self.MILEAGE_TYPE.CONSUMED then
    tempCnt = ToClient_GetMoonBlessingRewardCount(__eMoonBlessingRewardType_Rewarded)
    for ii = 0, tempCnt - 1 do
      self._mileageInfo[self._mileageInfoCnt] = ToClient_GetMoonBlessingRewardAt(__eMoonBlessingRewardType_Rewarded, ii)
      self._mileageStepInfo[self._mileageInfoCnt] = self.CHALLENGE_STEP.REWARDED
      self._mileageInfoCnt = self._mileageInfoCnt + 1
    end
    self._nowProgressKeyGroup[mileageType] = self._mileageInfoCnt
    tempCnt = ToClient_GetMoonBlessingRewardCount(__eMoonBlessingRewardType_Progress)
    for ii = 0, tempCnt - 1 do
      self._mileageInfo[self._mileageInfoCnt] = ToClient_GetMoonBlessingRewardAt(__eMoonBlessingRewardType_Progress, ii)
      self._mileageStepInfo[self._mileageInfoCnt] = self.CHALLENGE_STEP.PROGRESS
      self._mileageInfoCnt = self._mileageInfoCnt + 1
    end
    tempCnt = ToClient_GetMoonBlessingRewardCount(__eMoonBlessingRewardType_Complete)
    for ii = 0, tempCnt - 1 do
      self._mileageInfo[self._mileageInfoCnt] = ToClient_GetMoonBlessingRewardAt(__eMoonBlessingRewardType_Complete, ii)
      self._mileageStepInfo[self._mileageInfoCnt] = self.CHALLENGE_STEP.COMPLETED
      self._mileageInfoCnt = self._mileageInfoCnt + 1
    end
  end
end
function PaGlobal_IngameCashShopMoonBlessing_Renew_All:setBottomDesc()
  if Panel_IngameCashShop_MoonBlessing_Renew_All == nil then
    return
  end
  if self._isConsole == true then
    local resetInfoText = PAGetString(Defines.StringSheet_GAME, "MOON_BLESSING_RESET_DESC_01") .. "\n" .. PAGetString(Defines.StringSheet_GAME, "MOON_BLESSING_RESET_DESC_02")
    ...
    if self._mileageInfo[0] ~= nil then
      periodInfoText = ToClient_GetMoonBlessingDesc() .. "\n"
    end
    ...
    self._ui.txt_periodInfo:ComputePos()
    Panel_IngameCashShop_MoonBlessing_Renew_All:SetSize(Panel_IngameCashShop_MoonBlessing_Renew_All:GetSizeX(), self._saveSize.panelY + self._ui.txt_resetInfo:GetTextSizeY() + self._ui.txt_periodInfo:GetTextSizeY() + 20)
    ...
    if self._mileageInfo[0] ~= nil then
      resetInfoText = resetInfoText .. ToClient_GetMoonBlessingDesc() .. "\n"
    end
    self._ui.txt_resetInfo:SetTextMode(__eTextMode_AutoWrap)
    self._ui.txt_resetInfo:SetText(resetInfoText)
    self._ui.txt_resetInfo:SetSize(self._ui.txt_resetInfo:GetSizeX(), self._ui.txt_resetInfo:GetTextSizeY())
    self._ui.txt_resetInfo:ComputePos()
    local periodInfoText = PAGetString(Defines.StringSheet_GAME, "LUA_INGAMECASHSHOP_MILEAGE_MONTHLY_PERIODINFO")
...
function PaGlobal_IngameCashShopMoonBlessing_Renew_All:listUpdate()
  if Panel_IngameCashShop_MoonBlessing_Renew_All == nil then
    return
  end
...
function PaGlobal_IngameCashShopMoonBlessing_Renew_All:resetUpdate()
  if Panel_IngameCashShop_MoonBlessing_Renew_All == nil then
    return
  end
  local currentResetCount = ToClient_GetCurrentMoonblessingResetCount()
  local maxResetCount = ToClient_GetCurrentMoonblessingMaxResetCount()
  local currentPossibleResetCount = maxResetCount - currentResetCount
  self._ui._stc_resetDesc:SetShow(true)
  self._ui._stc_resetDesc:SetText(PAGetString(Defines.StringSheet_GAME, "MOON_BLESSING_RESET_COUNT") .. " " .. tostring(currentPossibleResetCount))
end
function PaGlobal_IngameCashShopMoonBlessing_Renew_All:listCreate(content, key)
  if Panel_IngameCashShop_MoonBlessing_Renew_All == nil then
    return
  end
  ...
  txt_title:SetText(self._mileageInfo[key32]:getTitle())
  ...
  stc_contentBg:ChangeTextureInfoNameAsync("combine/frame/combine_frame_00.dds")
  if self._mileageStepInfo[key32] == self.CHALLENGE_STEP.PROGRESS then
    ...
    nowAttainment = Int64toInt32(ToClient_GetCurrentMoonblessingPearlUsed())
    local unitPrice = Int64toInt32(ToClient_GetCurrentMoonblessingMaxUsedPearl()) * ToClient_GetCurrentMoonblessingResetCount()
    local nowGoal = self._mileageInfo[key32]:getTargetUsedPearl()
    ...
    if rate < 100 then
      ...
      btn_reward:addInputEvent("Mouse_LUp", "HandleEvent_IngameCashShopMoonBlessing_Renew_All_ApplyReward(" .. key32 .. ")")
    end
  elseif self._mileageStepInfo[key32] == self.CHALLENGE_STEP.REWARDED then
    local x1, y1, x2, y2 = setTextureUV_Func(stc_contentBg, 307, 1, 357, 51)
    stc_contentBg:getBaseTexture():setUV(x1, y1, x2, y2)
    stc_contentBg:setRenderTexture(stc_contentBg:getBaseTexture())
    btn_reward:SetShow(true)
    btn_reward:SetIgnore(false)
    btn_reward:addInputEvent("Mouse_LUp", "HandleEvent_IngameCashShopMoonBlessing_Renew_All_ApplyReward(" .. key32 .. ")")
  elseif self._mileageStepInfo[key32] == self.CHALLENGE_STEP.COMPLETED then
    local x1, y1, x2, y2 = setTextureUV_Func(stc_contentBg, 256, 1, 306, 51)
    stc_contentBg:getBaseTexture():setUV(x1, y1, x2, y2)
    stc_contentBg:setRenderTexture(stc_contentBg:getBaseTexture())
...
function PaGlobal_IngameCashShopMoonBlessing_Renew_All:setCashMileageRewardShow(contentIndex, slotIndex, reward)
  if Panel_IngameCashShop_MoonBlessing_Renew_All == nil then
    return
  end
  ...
  if nil ~= uiSlot then
    if __eRewardExp == reward._type then
      ...
      uiSlot.icon:ChangeTextureInfoNameAsync("Icon/New_Icon/03_ETC/12_DoApplyDirectlyItem/EXP.dds")
    elseif __eRewardSkillExp == reward._type then
      uiSlot.count:SetText("")
      uiSlot.icon:ChangeTextureInfoNameAsync("Icon/New_Icon/03_ETC/12_DoApplyDirectlyItem/SkillExp.dds")
    ...
    elseif __eRewardItem == reward._type then
      ...
      if true == self._isConsole then
        uiSlot.empty:registerPadEvent(__eConsoleUIPadEvent_Up_X, "HandleEvent_IngameCashShopMoonBlessing_Renew_All_ShowToolTip(" .. contentIndex .. "," .. slotIndex .. ",true)")
      else
        uiSlot.icon:addInputEvent("Mouse_On", "HandleEvent_IngameCashShopMoonBlessing_Renew_All_ShowToolTip(" .. contentIndex .. "," .. slotIndex .. ",true)")
      end
      uiSlot.icon:addInputEvent("Mouse_Out", "HandleEvent_IngameCashShopMoonBlessing_Renew_All_ShowToolTip(" .. contentIndex .. "," .. slotIndex .. ",false)")
    elseif __eRewardIntimacy == reward._type then
      uiSlot.count:SetText("")
      uiSlot.icon:ChangeTextureInfoNameAsync("Icon/New_Icon/00000000_Special_Contributiveness.dds")
    else
      if true == self._isConsole then
...
function PaGlobal_IngameCashShopMoonBlessing_Renew_All:dayChange()
  if Panel_IngameCashShop_MoonBlessing_Renew_All == nil then
    return
  end
  self:update(self._nowMileageInfoKey, self._nowTabInfoKey)
end
function PaGlobal_IngameCashShopMoonBlessing_Renew_All:challengeBtnGroupCheck(mileageType)
  if Panel_IngameCashShop_MoonBlessing_Renew_All == nil then
    return
  end
...
function PaGlobal_IngameCashShopMoonBlessing_Renew_All:checkChallengeCnt(mileageType, challengeType)
  if Panel_IngameCashShop_MoonBlessing_Renew_All == nil then
    return 0
  end
  local tempCnt = 0
  ...
  elseif self.MILEAGE_TYPE.CONSUMED == mileageType then
    tempCnt = tempCnt + ToClient_GetMoonBlessingRewardCount(__eMoonBlessingRewardType_Rewarded)
    tempCnt = tempCnt + ToClient_GetMoonBlessingRewardCount(__eMoonBlessingRewardType_Progress)
    tempCnt = tempCnt + ToClient_GetMoonBlessingRewardCount(__eMoonBlessingRewardType_Complete)
  end
  return tempCnt
end
function PaGlobal_IngameCashShopMoonBlessing_Renew_All:childComputePos()
  if Panel_IngameCashShop_MoonBlessing_Renew_All == nil then
    return
  end
...
function PaGlobal_IngameCashShopMoonBlessing_Renew_All:checkMileageRewarded()
  if Panel_IngameCashShop_MoonBlessing_Renew_All == nil then
    return
  end
  local tempCnt = 0
...
function PaGlobal_IngameCashShopMoonBlessing_Renew_All:registEventHandler()
  if Panel_IngameCashShop_MoonBlessing_Renew_All == nil then
    return
  end
  registerEvent("onScreenResize", "PaGlobalFunc_IngameCashShopMoonBlessing_Renew_All_OnResize")
  registerEvent("FromClient_InventoryUpdate", "FromClient_IngameCashShopMoonBlessing_Renew_All_InventoryUpdate")
  registerEvent("FromClient_NotifyCompleteBuyProduct", "FromClient_IngameCashShopMoonBlessing_Renew_All_NotifyCompleteBuyProduct")
  registerEvent("FromClient_UpdatePearlMileage", "FromClient_IngameCashShopMoonBlessing_Renew_All_UpdatePearlMileage")
  registerEvent("FromClient_SelectRandomItem", "FromClient_IngameCashShopMoonBlessing_Renew_All_SelectRandomItem")
  registerEvent("FromClient_MoonBlessingRewardUpd", "FromClient_IngameCashShopMoonBlessing_Renew_All_ChallengeReward_UpdateText")
  registerEvent("FromClient_AttendanceTimer", "FromClient_IngameCashShopMoonBlessing_Renew_All_AttendanceTimer")
  registerEvent("FromClient_ResetMoonBlessingSuccessNotify", "FromClient_ResetMoonBlessingSuccessNotify")
  self._ui_pc.btn_close:addInputEvent("Mouse_LUp", "HandleEventLUp_IngameCashShopMoonBlessing_Renew_All_Close()")
  self._ui.rdo_charged:addInputEvent("Mouse_LUp", "PaGlobalFunc_IngameCashShopMoonBlessing_Renew_All_Update(" .. self.MILEAGE_TYPE.CHARGED .. ")")
  self._ui.rdo_consumed:addInputEvent("Mouse_LUp", "PaGlobalFunc_IngameCashShopMoonBlessing_Renew_All_Update(" .. self.MILEAGE_TYPE.CONSUMED .. ")")
  self._ui._tabTypeBtnGroup[self.MILEAGE_TYPE.CHARGED][self.CHALLENGE_TYPE.MONTHLY]:addInputEvent("Mouse_LUp", "PaGlobalFunc_IngameCashShopMoonBlessing_Renew_All_Type_Update(" .. self.CHALLENGE_TYPE.MONTHLY .. ")")
  self._ui._tabTypeBtnGroup[self.MILEAGE_TYPE.CHARGED][self.CHALLENGE_TYPE.WEEKLY]:addInputEvent("Mouse_LUp", "PaGlobalFunc_IngameCashShopMoonBlessing_Renew_All_Type_Update(" .. self.CHALLENGE_TYPE.WEEKLY .. ")")
  self._ui._tabTypeBtnGroup[self.MILEAGE_TYPE.CHARGED][self.CHALLENGE_TYPE.DAILY]:addInputEvent("Mouse_LUp", "PaGlobalFunc_IngameCashShopMoonBlessing_Renew_All_Type_Update(" .. self.CHALLENGE_TYPE.DAILY .. ")")
  self._ui._tabTypeBtnGroup[self.MILEAGE_TYPE.CONSUMED][self.CHALLENGE_TYPE.MONTHLY]:addInputEvent("Mouse_LUp", "PaGlobalFunc_IngameCashShopMoonBlessing_Renew_All_Type_Update(" .. self.CHALLENGE_TYPE.MONTHLY .. ")")
  self._ui._tabTypeBtnGroup[self.MILEAGE_TYPE.CONSUMED][self.CHALLENGE_TYPE.WEEKLY]:addInputEvent("Mouse_LUp", "PaGlobalFunc_IngameCashShopMoonBlessing_Renew_All_Type_Update(" .. self.CHALLENGE_TYPE.WEEKLY .. ")")
  self._ui._tabTypeBtnGroup[self.MILEAGE_TYPE.CONSUMED][self.CHALLENGE_TYPE.DAILY]:addInputEvent("Mouse_LUp", "PaGlobalFunc_IngameCashShopMoonBlessing_Renew_All_Type_Update(" .. self.CHALLENGE_TYPE.DAILY .. ")")
  self._ui._radioTabGroup[self.CHALLENGE_TYPE.MONTHLY]:addInputEvent("Mouse_LUp", "PaGlobalFunc_IngameCashShopMoonBlessing_Renew_All_Type_Update(" .. self.CHALLENGE_TYPE.MONTHLY .. ")")
  self._ui._radioTabGroup[self.CHALLENGE_TYPE.WEEKLY]:addInputEvent("Mouse_LUp", "PaGlobalFunc_IngameCashShopMoonBlessing_Renew_All_Type_Update(" .. self.CHALLENGE_TYPE.WEEKLY .. ")")
  self._ui._radioTabGroup[self.CHALLENGE_TYPE.DAILY]:addInputEvent("Mouse_LUp", "PaGlobalFunc_IngameCashShopMoonBlessing_Renew_All_Type_Update(" .. self.CHALLENGE_TYPE.DAILY .. ")")
  for ii = 0, #self._ui._list2_mileage do
    self._ui._list2_mileage[ii]:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobalFunc_IngameCashShopMoonBlessing_Renew_All_ListCreate")
    self._ui._list2_mileage[ii]:createChildContent(__ePAUIList2ElementManagerType_List)
    self._ui._list2_mileage[ii]:ComputePos()
  end
  if self._isConsole == true then
    Panel_IngameCashShop_MoonBlessing_Renew_All:registerPadEvent(__eConsoleUIPadEvent_LB, "HandleEvent_IngameCashShopMoonBlessing_Renew_All_MoveTab(-1)")
    Panel_IngameCashShop_MoonBlessing_Renew_All:registerPadEvent(__eConsoleUIPadEvent_RB, "HandleEvent_IngameCashShopMoonBlessing_Renew_All_MoveTab(1)")
    Panel_IngameCashShop_MoonBlessing_Renew_All:registerPadEvent(__eConsoleUIPadEvent_Up_Y, "HandleEventLUp_ShowMessage_RequestMoonBlessingPearlUsedReset()")
  end
  self._ui._btn_reset:addInputEvent("Mouse_LUp", "HandleEventLUp_RequestMoonBlessingPearlUsedReset()")
end
function PaGlobal_IngameCashShopMoonBlessing_Renew_All:validate()
  if Panel_IngameCashShop_MoonBlessing_Renew_All == nil then
    return
  end
  ...
  self._ui._chargedGroup.stc_bg:isValidate()
  self._ui._chargedGroup.stc_rdoBg:isValidate()
  self._ui._chargedGroup.rdo_montly:isValidate()
  self._ui._chargedGroup.rdo_weekly:isValidate()
  self._ui._chargedGroup.rdo_daily:isValidate()
...
function PaGlobal_IngameCashShopMoonBlessing_Renew_All:resize()
  if Panel_IngameCashShop_MoonBlessing_Renew_All == nil then
    return
  end
  if Panel_IngameCashShop_Coupon ~= nil and Panel_IngameCashShop_Coupon:GetShow() == true then
    Panel_IngameCashShop_MoonBlessing_Renew_All:SetPosX(Panel_IngameCashShop_Coupon:GetPosX() + Panel_IngameCashShop_Coupon:GetSizeX())
    Panel_IngameCashShop_MoonBlessing_Renew_All:SetPosY(getScreenSizeY() / 2 - Panel_IngameCashShop_MoonBlessing_Renew_All:GetSizeY() / 2)
  elseif Panel_IngameCashShop_BuyOrGift:GetShow() == true then
    Panel_IngameCashShop_MoonBlessing_Renew_All:SetPosX(Panel_IngameCashShop_BuyOrGift:GetPosX() + Panel_IngameCashShop_BuyOrGift:GetSizeX())
    Panel_IngameCashShop_MoonBlessing_Renew_All:SetPosY(getScreenSizeY() / 2 - Panel_IngameCashShop_MoonBlessing_Renew_All:GetSizeY() / 2)
  elseif Panel_IngameCashShop_MakePaymentsFromCart:GetShow() == true then
    Panel_IngameCashShop_MoonBlessing_Renew_All:SetPosX(Panel_IngameCashShop_MakePaymentsFromCart:GetPosX() + Panel_IngameCashShop_MakePaymentsFromCart:GetSizeX())
    Panel_IngameCashShop_MoonBlessing_Renew_All:SetPosY(getScreenSizeY() / 2 - Panel_IngameCashShop_MoonBlessing_Renew_All:GetSizeY() / 2)
  elseif self._isConsole == true and Panel_PearlShop_ProductBuy ~= nil and Panel_PearlShop_ProductBuy:GetShow() == true then
    Panel_IngameCashShop_MoonBlessing_Renew_All:SetPosX(Panel_PearlShop_ProductBuy:GetPosX() + Panel_PearlShop_ProductBuy:GetSizeX())
    Panel_IngameCashShop_MoonBlessing_Renew_All:SetPosY(Panel_PearlShop_ProductBuy:GetPosY())
  elseif self._isConsole == true then
    local gap = (getScreenSizeY() - Panel_IngameCashShop_MoonBlessing_Renew_All:GetSizeY()) * 0.5
    Panel_IngameCashShop_MoonBlessing_Renew_All:SetSpanSize(Panel_IngameCashShop_MoonBlessing_Renew_All:GetSpanSize().x, gap)
    Panel_IngameCashShop_MoonBlessing_Renew_All:SetPosX(getScreenSizeX() - Panel_IngameCashShop_MoonBlessing_Renew_All:GetSizeX() - 150)
  else
    Panel_IngameCashShop_MoonBlessing_Renew_All:SetPosX(getScreenSizeX() - Panel_IngameCashShop_MoonBlessing_Renew_All:GetSizeX() - 150)
    Panel_IngameCashShop_MoonBlessing_Renew_All:SetPosY(getScreenSizeY() / 2 - Panel_IngameCashShop_MoonBlessing_Renew_All:GetSizeY() / 2)
  end
  if self._isConsole == false and getScreenSizeX() - Panel_IngameCashShop_MoonBlessing_Renew_All:GetSizeX() < Panel_IngameCashShop_MoonBlessing_Renew_All:GetPosX() then
    Panel_IngameCashShop_MoonBlessing_Renew_All:SetPosX(getScreenSizeX() - Panel_IngameCashShop_MoonBlessing_Renew_All:GetSizeX() - 150)
    Panel_IngameCashShop_MoonBlessing_Renew_All:SetPosY(getScreenSizeY() / 2 - Panel_IngameCashShop_MoonBlessing_Renew_All:GetSizeY() / 2)
  end
end
function PaGlobal_IngameCashShopMoonBlessing_Renew_All:moveTab(moveDir)
  if Panel_IngameCashShop_MoonBlessing_Renew_All == nil then
    return
  end
