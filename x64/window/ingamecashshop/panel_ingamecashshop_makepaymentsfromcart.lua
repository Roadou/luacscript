...
function MakePaymentsFromCart:update()
  ...
  for goods_Idx = 0, cartListCount - 1 do
    ...
    slot.icon:ChangeTextureInfoNameAsync("Icon/" .. cashProductSSW:getIconPath())
...
function FGlobal_IngameCashShop_MakePaymentsFromCart_Open()
  ...
  if _ContentsGroup_PearlShopMoonBlessingRenew == true and PaGlobal_MoonBlessingRenew_IsOpenCheck() == true then
    PaGlobal_MoonBlessing_ChangeConsumePearl(Int64toInt32(MakePaymentsFromCart._totalPrice))
  end
end
