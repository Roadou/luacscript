  ...
  if listCount == 1 then
    ...
    for itemIndex = 0, paramMax do
      ...
      if NoCashType.eCustomizationNoCashType_Deco == listParamType and (NoCashDeco.eCustomizationNoCashDeco_FaceTattoo == listParamIndex or NoCashDeco.eCustomizationNoCashDeco_BodyTattoo == listParamIndex) then
        staticPayMark = UI.getChildControlNoneAssert(tempContentImage, "Static_PayMark_" .. tostring(itemIndex) .. "_" .. tostring(selectedUiId))
        if nil == staticPayMark then
      ...
      tempContentImage:ChangeTextureInfoNameAsync(listTexture)
      ...
      if NoCashType.eCustomizationNoCashType_Deco == listParamType and (NoCashDeco.eCustomizationNoCashDeco_FaceTattoo == listParamIndex or NoCashDeco.eCustomizationNoCashDeco_BodyTattoo == listParamIndex) and nil ~= staticPayMark then
