...
local function radioButtonOnOff(part, on)
  ...
  if on == true then
    selectedButtonControl:ChangeTextureInfoNameAsync(radioButtonTextureName)
    ...
    selectedButtonControl:ChangeOnTextureInfoNameAsync(radioButtonTextureName)
    ...
    selectedButtonControl:ChangeClickTextureInfoNameAsync(radioButtonTextureName)
