...
function CreateCommonPalette(FrameTemplate, ftCollision, paramType, paramIndex, PaletteIndex)
  ...
  for colorIndex = 0, count - 1 do
    ...
    tempStatic:ChangeTextureInfoNameAsync("New_UI_Common_ForLua/Window/Lobby/cus_palette.dds")
  ...
  ftCollision:ChangeTextureInfoNameAsync("New_UI_Common_ForLua/Window/Lobby/cus_palette.dds")
