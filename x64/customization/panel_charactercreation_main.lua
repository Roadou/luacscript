...
local Static_ToggleHelm = UI.getChildControl(Panel_CustomizationStatic, "Static_ToggleHelm")
local CheckButton_ToggleHelm = UI.getChildControl(Static_ToggleHelm, "CheckButton_ToggleHelm")
local Static_ToggleFaceDeco = UI.getChildControl(Panel_CustomizationStatic, "Static_ToggleFaceDeco")
local CheckButton_ToggleFaceDeco = UI.getChildControl(Static_ToggleFaceDeco, "CheckButton_ToggleFaceDeco")
...
local StaticText_ToggleHelm_Title = UI.getChildControl(Static_ToggleHelm, "StaticText_ToggleHelm")
local StaticText_ToggleFaceDeco_Title = UI.getChildControl(Static_ToggleFaceDeco, "StaticText_ToggleFaceDeco")
...
local CustomizationControlGroup_None = -1
...
if true == isDevelopment and nil ~= Button_ProfileScreenShot and nil ~= Button_ProfileScreenShot_Title then
  local gapX = 74
  local textGapY = 74
  local PosX = Static_ToggleHelm:GetPosX()
  local PosY = Static_ToggleHelm:GetPosY() + 110
...
if false then
  ...
  if 12 == getGameServiceResType() then
    link1:ChangeTextureInfoNameAsync("new_ui_common_forlua/Window/Cash_Customization/Apply_base_th.dds")
    ...
    link1:ChangeOnTextureInfoNameAsync("new_ui_common_forlua/Window/Cash_Customization/Apply_over_th.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(link1, 0, 0, 321, 90)
    link1:getOnTexture():setUV(x1, y1, x2, y2)
    link1:ChangeClickTextureInfoNameAsync("new_ui_common_forlua/Window/Cash_Customization/Apply_click_th.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(link1, 0, 0, 321, 90)
    link1:getClickTexture():setUV(x1, y1, x2, y2)
    link2:ChangeTextureInfoNameAsync("new_ui_common_forlua/Window/Cash_Customization/PreOrder_base_th.dds")
    ...
    link2:ChangeOnTextureInfoNameAsync("new_ui_common_forlua/Window/Cash_Customization/PreOrder_over_th.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(link2, 0, 0, 321, 90)
    link2:getOnTexture():setUV(x1, y1, x2, y2)
    link2:ChangeClickTextureInfoNameAsync("new_ui_common_forlua/Window/Cash_Customization/PreOrder_click_th.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(link2, 0, 0, 321, 90)
    link2:getClickTexture():setUV(x1, y1, x2, y2)
  else
    link1:ChangeTextureInfoNameAsync("new_ui_common_forlua/Window/Cash_Customization/Apply_base_en.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(link1, 0, 0, 321, 90)
    link1:getBaseTexture():setUV(x1, y1, x2, y2)
    link1:setRenderTexture(link1:getBaseTexture())
    link1:ChangeOnTextureInfoNameAsync("new_ui_common_forlua/Window/Cash_Customization/Apply_over_en.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(link1, 0, 0, 321, 90)
    link1:getOnTexture():setUV(x1, y1, x2, y2)
    link1:ChangeClickTextureInfoNameAsync("new_ui_common_forlua/Window/Cash_Customization/Apply_click_en.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(link1, 0, 0, 321, 90)
    link1:getClickTexture():setUV(x1, y1, x2, y2)
    link2:ChangeTextureInfoNameAsync("new_ui_common_forlua/Window/Cash_Customization/PreOrder_base_en.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(link2, 0, 0, 321, 90)
    link2:getBaseTexture():setUV(x1, y1, x2, y2)
    link2:setRenderTexture(link2:getBaseTexture())
    link2:ChangeOnTextureInfoNameAsync("new_ui_common_forlua/Window/Cash_Customization/PreOrder_over_en.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(link2, 0, 0, 321, 90)
    link2:getOnTexture():setUV(x1, y1, x2, y2)
    link2:ChangeClickTextureInfoNameAsync("new_ui_common_forlua/Window/Cash_Customization/PreOrder_click_en.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(link2, 0, 0, 321, 90)
    link2:getClickTexture():setUV(x1, y1, x2, y2)
  end
end
...
CheckButton_ToggleHelm:addInputEvent("Mouse_LUp", "PaGlobalFunc_Customization_ToggleHelm()")
CheckButton_ToggleFaceDeco:addInputEvent("Mouse_LUp", "PaGlobalFunc_Customization_ToggleFaceDeco()")
...
function SelectZodiac(zodiacIndex)
  ...
  if zodiacDescription ~= nil then
    ...
    stc_Zodiac:SetSpanSize(zodiacDefalutSpanSizeX, HistoryTable_GetBottomPosY() + 40)
    stc_Zodiac:ComputePosAllChild()
    stc_Zodiac:ComputePos()
  end
  ...
  if zodiacImagePath ~= nil then
    ...
    Static_ZodiacImage:ChangeTextureInfoNameAsync(zodiacImagePath)
...
local function createZodiacGroup(groupInfo, mainButtonIndex)
  ...
  for ii = 1, count do
    ...
    tempStatic_ZodiacIcon:ChangeTextureInfoNameAsync(zodiacIconPath)
...
function TakeScreenShot()
  ...
  CheckButton_ToggleHelm:SetShow(false)
  CheckButton_ImagePreset:SetShow(false)
  ...
  StaticText_ToggleHelm_Title:SetShow(false)
  CheckButton_ImagePreset_Title:SetShow(false)
  Button_ScreenShot_Title:SetShow(false)
  Button_ScreenShotFolder_Title:SetShow(false)
  CheckButton_ToggleFaceDeco:SetShow(false)
  StaticText_ToggleFaceDeco_Title:SetShow(false)
  if InGameMode then
...
function TakeFaceScreenShot()
  ...
  if _ContentsGroup_MaidActorSystem == true and getCustomizingManager():isShowMaidActorMode() == true then
    _title = PAGetString(Defines.StringSheet_GAME, "LUA_MAID_CUSTOMIZATION_FACEPHOTO_MSGTITLE")
    _contenet = PAGetString(Defines.StringSheet_GAME, "LUA_MAID_CUSTOMIZATION_FACEPHOTO_MSGDESC")
  end
...
local function _UIShowInterface()
  ...
  CheckButton_ToggleHelm:SetShow(true)
  ...
  StaticText_ToggleHelm_Title:SetShow(true)
  ...
  CheckButton_ToggleFaceDeco:SetShow(true)
  StaticText_ToggleFaceDeco_Title:SetShow(true)
...
function showStaticUI(show)
  if show == true then
    ...
    Static_ToggleHelm:SetShow(true)
    Static_ToggleHelm:SetAlpha(0)
    UIAni.AlphaAnimation(1, Static_ToggleHelm, 0, 0.2)
    StaticText_ToggleHelm_Title:SetShow(true)
    StaticText_ToggleHelm_Title:SetAlpha(0)
    UIAni.AlphaAnimation(1, StaticText_ToggleHelm_Title, 0, 0.2)
    Static_ToggleFaceDeco:SetShow(true)
    Static_ToggleFaceDeco:SetAlpha(0)
    UIAni.AlphaAnimation(1, Static_ToggleFaceDeco, 0, 0.2)
    StaticText_ToggleFaceDeco_Title:SetShow(true)
    StaticText_ToggleFaceDeco_Title:SetAlpha(0)
    UIAni.AlphaAnimation(1, StaticText_ToggleFaceDeco_Title, 0, 0.2)
  else
    ...
    aniInfo_ScreenShot:SetHideAtEnd(true)
    local aniInfo_ScreenShotFolder = UIAni.AlphaAnimation(0, Button_ScreenShotFolder, 0, 0.2)
    aniInfo_ScreenShotFolder:SetHideAtEnd(true)
    local aniInfo_ToggleHelm = UIAni.AlphaAnimation(0, Static_ToggleHelm, 0, 0.2)
    aniInfo_ToggleHelm:SetHideAtEnd(true)
    local aniInfo_ToggleFaceDeco = UIAni.AlphaAnimation(0, Static_ToggleFaceDeco, 0, 0.2)
    aniInfo_ToggleFaceDeco:SetHideAtEnd(true)
    ...
    aniInfo_ScreenShot_Title:SetHideAtEnd(true)
    local aniInfo_ScreenShotFolder_Title = UIAni.AlphaAnimation(0, Button_ScreenShotFolder_Title, 0, 0.2)
    aniInfo_ScreenShotFolder_Title:SetHideAtEnd(true)
    local aniInfo_ToggleHelm_Title = UIAni.AlphaAnimation(0, StaticText_ToggleHelm_Title, 0, 0.2)
    aniInfo_ToggleHelm_Title:SetHideAtEnd(true)
    local aniInfo_ToggleFaceDeco_Title = UIAni.AlphaAnimation(0, StaticText_ToggleFaceDeco_Title, 0, 0.2)
    aniInfo_ToggleFaceDeco_Title:SetHideAtEnd(true)
  end
end
...
function ShowCharacterCustomization(customizationData, classIndex, isInGame)
  ...
  if isInGame == true then
    ...
    CheckButton_ToggleHelm:SetCheck(true)
    CheckButton_ToggleFaceDeco:SetCheck(true)
    PaGlobalFunc_Customization_ToggleHelm()
    PaGlobalFunc_Customization_ToggleFaceDeco()
  else
    mainButtonNum = 5
    ...
    if isGameTypeNA() and getContentsServiceType() == CppEnums.ContentsServiceType.eContentsServiceType_Pre then
      link1:SetShow(true)
      link2:SetShow(true)
    elseif false then
      if true == usingClassPic[classIndex] then
        japanEventBanner:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Window/Lobby/Customize_EventBanner_" .. classIndex .. ".dds")
        ...
        japanEventBanner:ChangeOnTextureInfoNameAsync("New_UI_Common_forLua/Window/Lobby/Customize_EventBanner_" .. classIndex .. ".dds")
        x1, y1, x2, y2 = setTextureUV_Func(japanEventBanner, 2, 161, 342, 317)
        japanEventBanner:getOnTexture():setUV(x1, y1, x2, y2)
        japanEventBanner:ChangeClickTextureInfoNameAsync("New_UI_Common_forLua/Window/Lobby/Customize_EventBanner_" .. classIndex .. ".dds")
  ...
  if (isGameTypeNA() or isGameTypeTaiwan() or isGameTypeGT() or isGameTypeTR() or isGameTypeTH() or isGameTypeID() or isGameTypeASIA()) and not isInGame then
    btn_Rule:SetShow(true)
  else
    btn_Rule:SetShow(false)
  end
...
function HandleClicked_RandomBeauty()
  ...
  if ToClient_isLobbyProcessor() then
    ...
    if _ContentsGroup_MaidActorSystem == true and getCustomizingManager():isShowMaidActorMode() == true then
      classType = ToClient_GetSummonMaidActorClassTypeRaw()
    end
  end
...
function PaGlobal_CustomizationIsEditable(isEditable, authorUserNo)
  ...
  if ToClient_isConsole() == false then
    ...
    local leafButton
    if mainButtonInfo[custiomizingIdx].tree ~= nil then
      for i = 2, #mainButtonInfo[custiomizingIdx].tree.items do
        leafButton = mainButtonInfo[custiomizingIdx].tree:getItemByIndex(i)
        if leafButton ~= nil then
          if leafButton.control ~= nil then
            leafButton.control:SetIgnore(setIgnore)
            leafButton.control:SetShow(not setIgnore)
          end
          if leafButton.imageStatic ~= nil then
            leafButton.imageStatic:SetShow(not setIgnore)
          end
        end
      end
    end
...
function PaGlobalFunc_Customization_ForceFirstChracterSeason()
  ...
  if curChannelData ~= nil and curChannelData:isMultiNationServer() == true then
    return false
  end
...
function PaGlobalFunc_Customization_SeasonBtnTextureChange()
  ...
  btn_CreateSeason:ChangeTextureInfoNameAsync("renewal/pcremaster/remaster_common_00.dds")
...
function PaGlobalFunc_Customization_ToggleHelm()
  if ToClient_getSelectedCustomizationControlGroupIndex() ~= CustomizationControlGroup_None then
    return
  end
  setShowHelmet(CheckButton_ToggleHelm:IsCheck())
end
function PaGlobalFunc_Customization_ToggleFaceDeco()
  if ToClient_getSelectedCustomizationControlGroupIndex() ~= CustomizationControlGroup_None then
    return
  end
  ToClient_setShowFaceDecoInCustomization(CheckButton_ToggleFaceDeco:IsCheck())
end
