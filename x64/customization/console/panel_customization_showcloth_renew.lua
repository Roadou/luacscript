...
function Customization_ShowClothInfo:CreateClothlist()
  ...
  for itemIdx = 0, count - 1 do
    ...
    tempContentImage:ChangeTextureInfoNameAsync("New_UI_Common_ForLua/Window/Lobby/" .. textureName)
...
function Customization_ShowClothInfo:InitRegister()
  ...
  if ToClient_IsDevelopment() == true then
    registerEvent("PlayGoClickCloth", "FromClient_PlayGoClickCloth")
  end
end
...
function FromClient_PlayGoClickCloth(clothIdx)
  PaGlobalFunc_Customization_ShowCloth_UpdateCloth(clothIdx)
end
