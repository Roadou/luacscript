...
function HandleEventLUp_ServerSelect_All_SelectChannel(key32)
  ...
  if nil == key32 then
    ...
    PaGlobal_ServerSelect_All:closeChannelDesc(PaGlobal_ServerSelect_All._CHANNEL_TYPE.SINGLE_WORLD_SYSTEM)
    return
  end
  ...
  if PaGlobal_ServerSelect_All._BUTTON_STATE.MAINSERVER_SELECT == PaGlobal_ServerSelect_All._currentButtonState then
    ...
    PaGlobal_ServerSelect_All._ui._stc_channelDesc[PaGlobal_ServerSelect_All._CHANNEL_TYPE.HARDCORE_CHANNEL]:SetShow(false)
  ...
  if false == PaGlobal_ServerSelect_All._isConsole and (PaGlobal_ServerSelect_All._selectedWorldIndex ~= worldServerIdx or PaGlobal_ServerSelect_All._selectedChannelIndex ~= channelServerIdx) then
    ...
    elseif channelServerData._isSiegeChannel then
      if channelServerData:getSiegeTerritoryType() == __eSiegeTerritoryType_Ocean then
        channelType = PaGlobal_ServerSelect_All._CHANNEL_TYPE.OCEANSIEGE_CHANNEL
      else
    ...
    elseif channelServerData._roseWarGameNo == true then
      channelType = PaGlobal_ServerSelect_All._CHANNEL_TYPE.ROSEWAR
    end
    PaGlobal_ServerSelect_All:closeChannelDesc(PaGlobal_ServerSelect_All._CHANNEL_TYPE.SINGLE_WORLD_SYSTEM)
