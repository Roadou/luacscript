...
function PaGlobal_TutorialPhase_BasicSkill_RangerMan:startPhaseXXX(stepNo, typeNo)
  ...
  _PA_LOG("\234\179\189\235\175\188\236\154\176", "PaGlobal_TutorialPhase_BasicSkill_RangerMan:startStep() typeNo : " .. tostring(typeNo))
  ...
  if 1 == self._currentType then
    ...
    Panel_UIMain:SetShow(not ToClient_isConsole(), true)
...
function PaGlobal_TutorialPhase_BasicSkill_RangerMan:changeStepTryBasicSkill()
  ...
  elseif 3 == self._currentProgress then
    ...
    PaGlobal_TutorialUiManager:getUiHeadlineMessage():setTextPurposeText(PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_BASECOMBO_RANGERMAN_COMBO_0_1") .. PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_BASECOMBO_RANGERMAN_COMMAND_0_1") .. PAGetString(Defines.StringSheet_GAME, "TUTORIAL_PURPOSE_BATTLE_STEP7") .. " ( " .. self._usedSkillCount .. " / " .. self._totalSkillCount .. " )")
    PaGlobal_TutorialUiManager:getUiKeyButton():setPrevUsingKeyAll(true)
  ...
  elseif 4 == self._currentProgress then
    ...
    PaGlobal_TutorialUiManager:getUiHeadlineMessage():setTextPurposeText(PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_BASECOMBO_RANGERMAN_COMBO_0_2") .. PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_BASECOMBO_RANGERMAN_COMMAND_0_2") .. PAGetString(Defines.StringSheet_GAME, "TUTORIAL_PURPOSE_BATTLE_STEP7") .. " ( " .. self._usedSkillCount .. " / " .. self._totalSkillCount .. " )")
    PaGlobal_TutorialUiManager:getUiKeyButton():setPrevUsingKeyAll(true)
...
function PaGlobal_TutorialPhase_BasicSkill_RangerMan:changeStepTrySkillCombo()
  ...
  PaGlobal_TutorialUiManager:getUiHeadlineMessage()._ui._nextStep_1:SetText(PaGlobal_TutorialManager:getStringResize(PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_BASECOMBO_RANGERMAN_COMBO_0_4"), PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_BASECOMBO_RANGERMAN_COMMAND_0_4"), 1))
  PaGlobal_TutorialUiManager:getUiHeadlineMessage()._ui._nextStep_2:SetText(PaGlobal_TutorialManager:getStringResize(PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_BASECOMBO_RANGERMAN_COMBO_0_3"), PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_BASECOMBO_RANGERMAN_COMMAND_0_3"), 2))
...
function PaGlobal_TutorialPhase_BasicSkill_RangerMan:eventCallUsedSkill_TrySkillCombo(skillWrapper)
  local listNo = 0
  local skillNo = skillWrapper:getSkillNo()
...
function PaGlobal_TutorialPhase_BasicSkill_RangerMan:eventCallAcceptBlackSpiritQuest(isAccept, questGroupNo, questId)
...
function PaGlobal_TutorialPhase_BasicSkill_RangerMan:handleEventQuestUpdateNotify(isAccept, questNoRaw)
