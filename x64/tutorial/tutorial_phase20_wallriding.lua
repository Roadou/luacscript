...
function PaGlobal_TutorialPhase_WallRiding:eventCallStep1RegionChanged(regionKey)
  local currentRegionKey = regionKey
  for index, value in pairs(self._regionKeyRawList) do
...
function PaGlobal_TutorialPhase_WallRiding:handleRegionChanged(regionKey)
  self:eventCallStep1RegionChanged(regionKey)
end
