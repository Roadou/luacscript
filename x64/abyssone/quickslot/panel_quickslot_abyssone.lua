    ...
    do
      ...
      function slot:setItem(slotNo, quickSlotInfo)
        if false == isItemSlot(self.slotType) then
          ...
          if slotNo == 0 then
            self.number:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Widget/QuickSlot/QuickSlot_00.dds")
...
function QuickSlot_GroundClick(whereType, slotIndex)
  ...
  if slotIndex == 0 then
    itemSlot.number:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Widget/QuickSlot/QuickSlot_00.dds")
