PaGlobal_HouseName_All = {
  ...
  _ui = {
    ...
    _btn_showRank = nil,
    _btn_showGuildBuffHistory = nil,
    _chk_setUnderwear = nil,
    _chk_hidePet = nil,
    _chk_hideMaid = nil,
    _chk_hideDurability = nil,
    _stc_hideDurabilityHideIcon = nil,
    _stc_hideDurabilityShowIcon = nil,
  ...
  _prevPoint = 0,
  _isMyHouse = false,
  _baseConsoleInventoryIconSpanX = 0,
  _originPetIconSpanX = 0,
  _originDurabilityIconSpanX = 0,
  _updateWidgetTime = 0,
  _updateTime = 0,
