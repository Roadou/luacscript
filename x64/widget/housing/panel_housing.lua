...
function Panel_Housing_Mode_Click()
  ...
  if false == _ContentsGroup_NewUI_InstallMode_All and ToClient_isConsole() == false then
      ...
      if nil ~= installationItem then
        if nil ~= installationItem._imgPath then
          if 0 < string.len(installationItem._imgPath) then
            slot._staticImgSlot:ChangeTextureInfoNameAsync(installationItem._imgPath)
          else
            slot._staticImgSlot:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Widget/Housing/Object_NoImage.dds")
          end
        end
