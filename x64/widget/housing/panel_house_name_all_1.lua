function PaGlobal_HouseName_All:initialize()
  ...
  self._ui._btn_showGuildBuffHistory = UI.getChildControl(self._ui._pc._stc_btnBg, "Button_GuildBuffHistory")
...
function PaGlobal_HouseName_All:registEventHandler()
  ...
  self._ui._btn_showGuildBuffHistory:addInputEvent("Mouse_LUp", "HandleEventLUp_HouseName_All_ShowGuildBuffHistory()")
  self._ui._btn_showGuildBuffHistory:addInputEvent("Mouse_On", "HandleEventOn_HouseName_All_ButtonTooltip(" .. self._eButtonType.guildBuffHistory .. ")")
  self._ui._btn_showGuildBuffHistory:addInputEvent("Mouse_Out", "TooltipSimple_Hide()")
  ...
  registerEvent("FromClient_UpdateSelfPlayerIsInGuildMansion", "FromClient_UpdateSelfPlayerIsInGuildMansion")
  registerEvent("FromClient_ResponseTeleportToGuildMansion", "FromClient_ResponseTeleportToGuildMansion")
end
...
function PaGlobal_HouseName_All:prepareClose(isAni)
  ...
  self._ui._btn_showGuildBuffHistory:SetShow(false)
  self:close(isAni)
end
...
function PaGlobal_HouseName_All:checkShowGuildBuffInstallationHistory()
  if Panel_House_Name_All == nil then
    return
  end
  if ToClient_IsSelfPlayerInGuildMansion() == false then
    self._ui._btn_showGuildBuffHistory:SetShow(false)
    return
  end
  local isShowHistory = self._ui._btn_installMode:GetShow() == true or self._ui._btn_installGift:GetShow() == true
  self._ui._btn_showGuildBuffHistory:SetShow(isShowHistory)
end
