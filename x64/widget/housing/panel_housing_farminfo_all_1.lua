...
function PaGlobal_FarmInfo_All:updateIcon(key, isOn)
  ...
  targetUI:ChangeTextureInfoNameAsync(uvGroup.url)
...
function PaGlobal_FarmInfo_All:setInstallationMode(actorKeyRaw)
  ...
  if isGameTypeKorea() then
    self._ui._txt_pruningDesc:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_HOUSEING_FARMINFO_NEW_PRUNINGDESC_ALL"))
    self._ui._txt_insectDamegeDesc:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_HOUSEING_FARMINFO_NEW_INSECTDAMEGEDESC_ALL"))
  else
