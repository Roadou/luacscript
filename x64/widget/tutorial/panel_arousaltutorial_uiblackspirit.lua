...
function PaGlobal_ArousalTutorial_UiBlackSpirit:changeBubbleTextureForAni(bWhite)
  if true == Panel_ArousalTutorial:isPlayAnimation() then
    self._ui._obsidian_B:ChangeTextureInfoNameAsync(self._texturePath_Black)
    self._ui._obsidian_B_Left:ChangeTextureInfoNameAsync(self._texturePath_Black)
    return
  end
  ...
  self._ui._obsidian_B:ChangeTextureInfoNameAsync(destTexture)
  self._ui._obsidian_B_Left:ChangeTextureInfoNameAsync(destTexture)
end
