...
function KnowledgeManage:setTabTo(tabIndex)
  ...
  self._ui.stc_currentAssetIcon:ChangeTextureInfoNameAsync("renewal/ui_icon/console_icon_00.dds")
  ...
  self._ui.stc_requiredAssetIcon:ChangeTextureInfoNameAsync("renewal/ui_icon/console_icon_00.dds")
