...
function PaGlobal_MentalGame_All:insertCardList()
  ...
  for index = 0, count - 1 do
    ...
    if nil == self._rightCardList[index].ui.cardText then
      ...
      aControl[index]:ChangeTextureInfoNameAsync(cardWrapper:getPicture())
...
function PaGlobal_MentalGame_All:gameStartInit()
  ...
  if nil ~= zodiacSSW then
    self._ui_zodiac.control:ChangeTextureInfoNameAsync(zodiacSSW:getZodiacImagePath())
  end
...
function PaGlobal_MentalGame_All:giftIconInit()
  ...
  for index = 0, count - 1 do
    ...
    if percent >= 0 and percent <= 1 and ToClient_checkIntimacyInformationFixedState(intimacyInformationData) then
      ...
      target:ChangeTextureInfoNameAsync(IconType.texture)
