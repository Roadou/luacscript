...
local Panel_Widget_Alert_info = {
  ...
  _alramTime = 0,
  _originalSizeX = 24,
  _alertShowContentsShow = {
    [AlertType.eALERT_Hunting] = ToClient_HardCoreChannelWithContensOption() == false,
    [AlertType.eALERT_Coupon] = ToClient_HardCoreChannelWithContensOption() == false,
    [AlertType.eALERT_LearnSkill] = true,
    [AlertType.eALERT_NewStoryKnowledge] = ToClient_HardCoreChannelWithContensOption() == false,
    [AlertType.eALERT_NewKnowledge] = true,
    [AlertType.eALERT_Mail] = ToClient_HardCoreChannelWithContensOption() == false,
    [AlertType.eALERT_ChallengeReward] = ToClient_HardCoreChannelWithContensOption() == false,
    [AlertType.eALERT_NewFriend] = ToClient_HardCoreChannelWithContensOption() == false,
    [AlertType.eALERT_BlackSpiritQuest] = true,
    [AlertType.eALERT_WeightOver] = true,
    [AlertType.eALERT_EndurancePc] = true,
    [AlertType.eALERT_EnduranceHorse] = true,
    [AlertType.eALERT_EnduranceCarriage] = true,
    [AlertType.eALERT_EnduranceShip] = true,
    [AlertType.eALERT_BatterEquipment] = true,
    [AlertType.eALERT_MyBossMonster] = ToClient_HardCoreChannelWithContensOption() == false,
    [AlertType.eALERT_OfflineMode] = true,
    [AlertType.eALERT_TotalReward] = ToClient_HardCoreChannelWithContensOption() == false,
    [AlertType.eALERT_CashProductDiscount] = ToClient_HardCoreChannelWithContensOption() == false,
    [AlertType.eALERT_MarketPlace_MyBiddingUpdate] = ToClient_HardCoreChannelWithContensOption() == false,
    [AlertType.eALERT_Acquire_Title] = ToClient_HardCoreChannelWithContensOption() == false,
    [AlertType.eALERT_BlackSpiritAdventureDice] = true,
    [AlertType.eALERT_SeasonBanner] = ToClient_HardCoreChannelWithContensOption() == false
  },
  _alertShow = {
...
function Panel_Widget_Alert_info:registEventHandler()
  ...
  self._ui.Button_MorningLandQuestBoard:addInputEvent("Mouse_LUp", "PaGlobal_Journal_Select_All_Open()")
...
function Panel_Widget_Alert_info:setButton()
  ...
  if ToClient_HardCoreChannelWithContensOption() == true then
    self._ui.Button_QuestList:SetShow(false)
    self._ui.Button_CashShop:SetShow(false)
  else
    self._ui.Button_QuestList:SetShow(true)
...
function Panel_Widget_Alert_info:setButtonShow(alertType, value, alertOtherText)
  ...
  if nil ~= self._alertShowContentsShow[alertType] and self._alertShowContentsShow[alertType] == false then
    self._alertShow[alertType] = false
    return
  end
...
function PaGlobalFunc_Widget_Alert_Check_LearnSkill()
  ...
  local skillCount = 0
  if _ContentsGroup_ShowOtherClassSkill == true then
    skillCount = PaGlobalFunc_SkillGroup_All_EnableSkillReturn()
  else
    skillCount = FGlobal_EnableSkillReturn()
  end
...
function PaGlobalFunc_Widget_Alert_NewKnowledge(usingType)
  ...
  if newCount > 0 then
    ...
    staticImage:ChangeTextureInfoNameAsync(cardData.imagePath)
