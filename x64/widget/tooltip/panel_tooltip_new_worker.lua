...
function FGlobal_ShowWorkerTooltip(workerData, uiBase, isRight, isPlant)
  ...
  if nil ~= defaultSkill then
    ...
    controlWorkerTooltip._defaultSkillIcon:ChangeTextureInfoNameAsync(defaultSkill:getIconPath())
  ...
  controlWorkerTooltip._icon:ChangeTextureInfoNameAsync(getWorkerIcon(workerStaticStatus))
  ...
  if 0 ~= skillCount then
    for skill_Index = 0, skillCount - 1 do
      ...
      if nil ~= skillSSW then
        ...
        controlWorkerTooltip._skill[skill_Index].icon:ChangeTextureInfoNameAsync(skillSSW:getIconPath())
...
function FGlobal_ShowWorkerTooltipByWorkerNoRaw(workerNoRaw, panel, isRight, isPlant)
  ...
  controlWorkerTooltip._icon:ChangeTextureInfoNameAsync(workerIcon)
  ...
  if 0 ~= skillCount then
    workerWrapperLua:foreachSkillList(function(index, skillStaticStatusWrapper)
      ...
      controlWorkerTooltip._skill[index].icon:ChangeTextureInfoNameAsync(skillStaticStatusWrapper:getIconPath())
