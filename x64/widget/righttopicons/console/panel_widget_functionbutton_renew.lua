...
local FunctionButton = {
  _ui = {
    ...
    _stc_siegeWarReturnCall = UI.getChildControl(Panel_Widget_FunctionButton_Renew, "Button_SiegeWarReturn")
  },
  _button = {
    ...
    [Widget_Function_Type_Renew.SiegeWarReturnCall] = nil
  },
  _buttonShow = {
    ...
    [Widget_Function_Type_Renew.SiegeWarReturnCall] = false
  },
  _isTimeDisplay = {
    [Widget_Function_Type_Renew.SiegeWarCall] = false,
    [Widget_Function_Type_Renew.BusterCall] = false,
...
function FunctionButton:initControl()
  ...
  self._button[Widget_Function_Type_Renew.SiegeWarReturnCall] = self._ui._stc_siegeWarReturnCall
end
...
function FromClient_Widget_FunctionButton_ResponseTeleportFromSiegeTent(sendType)
  local self = FunctionButton
  if 0 == sendType then
    self._isTimeDisplay[Widget_Function_Type_Renew.SiegeWarReturnCall] = true
    luaTimer_AddEvent(PaGlobalFunc_Widget_FunctionButton_Close_SiegeWarReturn, 600000, false, 0)
  else
    self._isTimeDisplay[Widget_Function_Type_Renew.SiegeWarReturnCall] = false
  end
  self:updateAllButton()
end
...
function PaGlobalFunc_Widget_FunctionButton_Check_SiegeWarReturn()
  ...
  if leftTime > 0 then
    luaTimer_AddEvent(PaGlobalFunc_Widget_FunctionButton_Close_SiegeWarReturn, leftTime * 1000, false, 0)
    self._isTimeDisplay[Widget_Function_Type_Renew.SiegeWarReturnCall] = true
    self:updateAllButton()
  else
    self._isTimeDisplay[Widget_Function_Type_Renew.SiegeWarReturnCall] = false
  ...
  self._tooltip._name[Widget_Function_Type_Renew.SiegeWarReturnCall] = name
  self._tooltip._desc[Widget_Function_Type_Renew.SiegeWarReturnCall] = desc
end
...
function FunctionButton:checkButtonStatus(buttonType)
  ...
  elseif buttonType == Widget_Function_Type_Renew.ReturnTown then
    self._buttonShow[buttonType] = self._isTimeDisplay[buttonType]
  elseif buttonType == Widget_Function_Type_Renew.SiegeWarReturnCall then
    self._buttonShow[buttonType] = self._isTimeDisplay[buttonType]
  end
end
