...
function PaGlobal_AutoPlay:SetAutoLevelUpUI()
  ...
  self._ui._newBG:ChangeTextureInfoNameAsync("Combine/Etc/Combine_Etc_BookofLife.dds")
  self._ui._newIcon:ChangeTextureInfoNameAsync("Combine/Etc/Combine_Etc_BookofLife.dds")
