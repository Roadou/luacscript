...
function PaGlobal_NpcNavi_All:initWarehouseBtn()
  ...
  for ii = 1, self._TOWNCOUNT do
    if nil ~= self._territoryTownData[ii] and true == self._territoryTownData[ii]._isOpen then
      ...
      tempTable._btn:ChangeTextureInfoNameAsync(self._territoryTownData[ii]._dds)
      ...
      tempTable._btn:addInputEvent("Mouse_On", "InputMOn_NpcNavi_TownWarehouseTooltip(" .. ii .. ", " .. btnCount .. ")")
