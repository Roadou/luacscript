PaGlobal_NpcNavi_All = {
  ...
  _territoryTownData = {
    ...
    [12] = {
      ...
      _z = 476312,
      _actorKey = 47665,
      _desc = PAGetString(Defines.StringSheet_GAME, "LUA_TOWNNAVI_WAREHOUSE_12"),
      _isOpen = ToClient_IsContentsGroupOpen("2180"),
      _dds = "renewal/etc/wordmap/territorymark_Edania_large.dds",
      _uv = {
        x1 = 0,
        x2 = 256,
        y1 = 0,
