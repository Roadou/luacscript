function InputMLUp_NpcNavi_SetWarehouseNavi(index)
  ...
  if ToClient_WorldMapIsShow() == true then
    PaGlobal_NaviButton_Open()
  end
end
function InputMOn_NpcNavi_TownWarehouseTooltip(dataIndex, btnIndex)
  if PaGlobal_NpcNavi_All._territoryTownData[dataIndex] == nil or PaGlobal_NpcNavi_All._btn_CityList[btnIndex] == nil then
    return
  end
  local name = PaGlobal_NpcNavi_All._territoryTownData[dataIndex]._desc
  local uiControl = PaGlobal_NpcNavi_All._btn_CityList[btnIndex]._btn
  local desc
