...
function Movable_UI()
  ...
  Panel_MainStatus_User_Bar:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Default/window_sample_isWidget.dds")
  ...
  Panel_Window_Servant:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Default/window_sample_isWidget.dds")
  pvpText:SetShow(false)
  Panel_PvpMode:SetIgnore(false)
  _pvpButton:SetIgnore(true)
  Panel_PvpMode:SetDragEnable(true)
  Panel_PvpMode:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Default/window_sample_isWidget.dds")
  ...
  if true == _ContentsGroup_NewUI_PartyWidget_All then
    ...
    Panel_Widget_Party_All:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Default/window_sample_isWidget.dds")
  else
    Panel_Widget_Party:SetDragAll(true)
    Panel_Widget_Party:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Default/window_sample_isWidget.dds")
  end
  FGlobal_Panel_Radar_Movable_UI()
  Panel_CheckedQuest:SetDragEnable(true)
  Panel_CheckedQuest:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Default/window_sample_isWidget.dds")
  ...
  Panel_FieldViewMode:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Default/window_sample_isWidget.dds")
  Panel_SkillCommand:SetIgnore(false)
  Panel_SkillCommand:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Default/window_sample_isWidget.dds")
...
function Movable_UI_Cancel()
  ...
  Panel_MainStatus_User_Bar:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Default/window_sample_empty.dds")
  ...
  Panel_PvpMode:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Default/window_sample_empty.dds")
  Panel_NpcNavi_All:SetDragEnable(false)
  FGlobal_Panel_Radar_Movable_UI_Cancel()
  Panel_CheckedQuest:SetDragEnable(false)
  Panel_CheckedQuest:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Default/window_sample_empty.dds")
  ...
  Panel_Window_Servant:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Default/window_sample_empty.dds")
  local temporaryWrapper = getTemporaryInformationWrapper()
  if nil == temporaryWrapper or nil == temporaryWrapper:getUnsealVehicle(__eServantTypeVehicle) and nil == temporaryWrapper:getUnsealVehicle(__eServantTypeShip) and nil == temporaryWrapper:getUnsealVehicle(__eServantTypePet) then
  ...
  Panel_FieldViewMode:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Default/window_sample_empty.dds")
  if true == _ContentsGroup_NewUI_PartyWidget_All then
    Panel_Widget_Party_All:SetDragEnable(false)
    Panel_Widget_Party_All:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Default/window_sample_empty.dds")
  else
    Panel_Widget_Party:SetDragEnable(false)
    Panel_Widget_Party:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Default/window_sample_empty.dds")
  end
  Panel_SkillCommand:SetIgnore(true)
  Panel_SkillCommand:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Default/window_sample_empty.dds")
