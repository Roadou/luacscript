...
function PaGlobal_ThornCastle_Map:prepareOpen()
  ...
  if 0 == teamNo then
    self._ui._mapTexture:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Widget/Rader/ThornCastle/Combine_Etc_Map_ThornyTree_Ateam.dds")
  else
    self._ui._mapTexture:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Widget/Rader/ThornCastle/Combine_Etc_Map_ThornyTree_Bteam.dds")
  end
