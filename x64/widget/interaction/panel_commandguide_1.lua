function PaGlobal_CommandGuide:initialize()
  ...
  PaGlobal_CommandGuide._maxCommandCount = 7
  ...
  PaGlobal_CommandGuide._ui._txt_commandKey[7] = UI.createAndCopyBasePropertyControl(PaGlobal_CommandGuide._ui._stc_commandBg, "StaticText_Key_E", PaGlobal_CommandGuide._ui._stc_commandBg, "StaticText_CommandKey_7")
  ...
  PaGlobal_CommandGuide._ui._txt_commandKeyDesc[7] = UI.createAndCopyBasePropertyControl(PaGlobal_CommandGuide._ui._stc_commandBg, "StaticText_Big", PaGlobal_CommandGuide._ui._stc_commandBg, "StaticText_Desc_7")
...
function PaGlobal_CommandGuide:setShowCommandKeyDesc(isShow, keyCount)
  for ii = 1, keyCount do
    PaGlobal_CommandGuide._ui._txt_commandKey[ii]:SetShow(isShow)
    PaGlobal_CommandGuide._ui._txt_commandKeyDesc[ii]:SetShow(isShow)
  end
end
function PaGlobal_CommandGuide:setData()
  local isDataType = PaGlobal_CommandGuide._isShowType
  for ii = 1, PaGlobal_CommandGuide._maxCommandCount do
    PaGlobal_CommandGuide._ui._txt_commandKey[ii]:SetShow(false)
    PaGlobal_CommandGuide._ui._txt_commandKeyDesc[ii]:SetShow(false)
  ...
  if 1 == isDataType then
    ...
    PaGlobal_CommandGuide:setShowCommandKeyDesc(true, 6)
  ...
  elseif 3 == isDataType then
    ...
    PaGlobal_CommandGuide._ui._txt_commandKey[1]:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_COMMANDGUIDE_ATTACK_1"))
    PaGlobal_CommandGuide._ui._txt_commandKey[2]:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_COMMANDGUIDE_ATTACK_2"))
    PaGlobal_CommandGuide:setShowCommandKeyDesc(true, 2)
  elseif 4 == isDataType then
    ...
    PaGlobal_CommandGuide:setShowCommandKeyDesc(true, 5)
    local keyDesc = {
    ...
    for ii = 1, 3 do
      ...
      dotControl:SetText("+")
      nextPosX = nextPosX + dotControl:GetSizeX()
      keyControl:SetPosX(nextPosX)
      keyControl:SetPosY(PaGlobal_CommandGuide._ui._txt_commandKey[ii + 2]:GetPosY())
      keyControl:SetText(keyDesc[ii])
      PaGlobal_CommandGuide:setKeySizeByText(keyControl)
      nextPosX = keyControl:GetPosX() + keyControl:GetSizeX()
      resultPosX = math.max(resultPosX, nextPosX)
    end
    for ii = 1, 5 do
      PaGlobal_CommandGuide._ui._txt_commandKeyDesc[ii]:SetPosX(resultPosX + 15)
    end
  ...
  elseif 6 == isDataType then
    local marginY = 30
    PaGlobal_CommandGuide._ui._txt_commandKey[1]:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_COMMANDGUIDE_MOVERIGHT"))
    PaGlobal_CommandGuide._ui._txt_commandKey[2]:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_COMMANDGUIDE_MOVERIGHT"))
    PaGlobal_CommandGuide._ui._txt_commandKey[3]:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_COMMANDGUIDE_KICK"))
    PaGlobal_CommandGuide._ui._txt_commandKey[4]:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_COMMANDGUIDE_MOVEBACK"))
    PaGlobal_CommandGuide._ui._txt_commandKey[5]:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_COMMANDGUIDE_JUMP"))
    PaGlobal_CommandGuide._ui._txt_commandKey[6]:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_COMMANDGUIDE_JUMP"))
    PaGlobal_CommandGuide.keyControl[1]:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_COMMANDGUIDE_MOVELEFT"))
    PaGlobal_CommandGuide.keyControl[2]:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_COMMANDGUIDE_MOVELEFT"))
    PaGlobal_CommandGuide.keyControl[3]:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_COMMANDGUIDE_DASH"))
    PaGlobal_CommandGuide.keyControl[4]:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_COMMANDGUIDE_CROUCHORSKILL"))
    PaGlobal_CommandGuide.keyControl[5]:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_COMMANDGUIDE_GRABORGUARD"))
    PaGlobal_CommandGuide.keyControl[6]:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_COMMANDGUIDE_INTERACTION"))
    if _ContentsGroup_UsePadSnapping == true then
      PaGlobal_CommandGuide._ui._txt_commandKey[3]:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_COMMANDGUIDE_ATTACK_2"))
      PaGlobal_CommandGuide.keyControl[5]:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_COMMANDGUIDE_ATTACK_1"))
      PaGlobal_CommandGuide.keyControl[6]:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_COMMANDGUIDE_GRABORGUARD"))
    end
    PaGlobal_CommandGuide.keyControl[6]:SetPosY(PaGlobal_CommandGuide._ui._txt_commandKey[6]:GetPosY() + marginY)
    PaGlobal_CommandGuide.keyControl[6]:SetShow(true)
    PaGlobal_CommandGuide._ui._txt_commandKeyDesc[1]:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_COMMANDGUIDE_DESC_DIRC"))
    PaGlobal_CommandGuide._ui._txt_commandKeyDesc[2]:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_COMMANDGUIDE_DESC_DRIFT"))
    PaGlobal_CommandGuide._ui._txt_commandKeyDesc[3]:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_COMMANDGUIDE_DESC_ACCEANDDRIFTACCE"))
    PaGlobal_CommandGuide._ui._txt_commandKeyDesc[4]:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_COMMANDGUIDE_DESC_DECEL"))
    PaGlobal_CommandGuide._ui._txt_commandKeyDesc[5]:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_COMMANDGUIDE_DESC_JUMP"))
    PaGlobal_CommandGuide._ui._txt_commandKeyDesc[6]:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_COMMANDGUIDE_DESC_JUMPSKILL"))
    PaGlobal_CommandGuide._ui._txt_commandKeyDesc[7]:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_COMMANDGUIDE_DESC_DROP"))
    PaGlobal_CommandGuide._ui._txt_commandKeyDesc[7]:SetPosY(PaGlobal_CommandGuide._ui._txt_commandKey[6]:GetPosY() + marginY)
    PaGlobal_CommandGuide._ui._txt_commandKeyDesc[7]:SetShow(true)
    for index = 1, 4 do
      PaGlobal_CommandGuide.dotControl[index]:SetText("/")
    end
    PaGlobal_CommandGuide.dotControl[5]:SetText("+")
    local keyCommandGuide = {}
    keyCommandGuide[0] = {
      [0] = PaGlobal_CommandGuide._ui._txt_commandKey[1],
      [1] = PaGlobal_CommandGuide.dotControl[1],
      [2] = PaGlobal_CommandGuide.keyControl[1]
    }
    keyCommandGuide[1] = {
      [0] = PaGlobal_CommandGuide._ui._txt_commandKey[2],
      [1] = PaGlobal_CommandGuide.dotControl[2],
      [2] = PaGlobal_CommandGuide.keyControl[2],
      [3] = PaGlobal_CommandGuide.dotControl[5],
      [4] = PaGlobal_CommandGuide.keyControl[3]
    }
    keyCommandGuide[2] = {
      [0] = PaGlobal_CommandGuide._ui._txt_commandKey[6],
      [1] = PaGlobal_CommandGuide.dotControl[3],
      [2] = PaGlobal_CommandGuide.keyControl[4],
      [3] = PaGlobal_CommandGuide.dotControl[4],
      [4] = PaGlobal_CommandGuide.keyControl[5]
    }
    PaGlobal_CommandGuide:setShowCommandKeyDesc(true, 6)
    for index = 0, 2 do
      local uiPosX = keyCommandGuide[index][0]:GetPosX()
      local uiPosY = keyCommandGuide[index][0]:GetPosY()
      for controlIndex = 0, #keyCommandGuide[index] do
        local control = keyCommandGuide[index][controlIndex]
        control:SetPosXY(uiPosX, uiPosY)
        control:SetShow(true)
        PaGlobal_CommandGuide:setKeySizeByText(control)
        uiPosX = uiPosX + control:GetSizeX()
      end
    end
    for ii = 1, PaGlobal_CommandGuide._maxCommandCount do
      PaGlobal_CommandGuide._ui._txt_commandKeyDesc[ii]:SetPosX(180)
    end
  end
...
function PaGlobal_CommandGuide:setKeySizeByText(control)
  if control == nil or control:GetShow() == false then
    return
  end
  local sizeX = control:GetTextSizeX() + PaGlobal_CommandGuide._textMargin
...
function PaGlobal_CommandGuide:setKeyGuideSize()
  for index = 1, PaGlobal_CommandGuide._maxCommandCount do
    local keyControl = {
      [1] = PaGlobal_CommandGuide._ui._txt_commandKey[index],
      [2] = PaGlobal_CommandGuide.keyControl[index]
    }
    for ii = 1, 2 do
      PaGlobal_CommandGuide:setKeySizeByText(keyControl[ii])
    end
  end
end
