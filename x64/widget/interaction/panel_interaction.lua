...
local BUTTON_ID = {
  ...
  "Button_TakeBackGuildInstallation",
  "Button_WildHorserRegisterCarriage"
}
local UI_BUTTON = {}
...
local otherUIList = {
  ...
  [CppEnums.InteractionType.InteractionType_TakeBackGuildInstallation] = UI.getChildControl(Panel_Interaction, "Button_TakeBackGuildInstallation"),
  [CppEnums.InteractionType.InteractionType_WildHorserRegisterCarriage] = UI.getChildControl(Panel_Interaction, "Button_WildHorserRegisterCarriage")
}
...
otherUIList[CppEnums.InteractionType.InteractionType_TakeBackGuildInstallation]:addInputEvent("Mouse_LUp", "Interaction_ButtonPushed(" .. CppEnums.InteractionType.InteractionType_TakeBackGuildInstallation .. ")")
otherUIList[CppEnums.InteractionType.InteractionType_TakeBackGuildInstallation]:addInputEvent("Mouse_On", "Interaction_ButtonOver(" .. CppEnums.InteractionType.InteractionType_TakeBackGuildInstallation .. ", true)")
otherUIList[CppEnums.InteractionType.InteractionType_TakeBackGuildInstallation]:addInputEvent("Mouse_Out", "Interaction_ButtonOver(" .. CppEnums.InteractionType.InteractionType_TakeBackGuildInstallation .. ", false)")
otherUIList[CppEnums.InteractionType.InteractionType_TakeBackGuildInstallation]:SetShow(true)
otherUIList[CppEnums.InteractionType.InteractionType_WildHorserRegisterCarriage]:addInputEvent("Mouse_LUp", "Interaction_ButtonPushed(" .. CppEnums.InteractionType.InteractionType_WildHorserRegisterCarriage .. ")")
otherUIList[CppEnums.InteractionType.InteractionType_WildHorserRegisterCarriage]:addInputEvent("Mouse_On", "Interaction_ButtonOver(" .. CppEnums.InteractionType.InteractionType_WildHorserRegisterCarriage .. ", true)")
otherUIList[CppEnums.InteractionType.InteractionType_WildHorserRegisterCarriage]:addInputEvent("Mouse_Out", "Interaction_ButtonOver(" .. CppEnums.InteractionType.InteractionType_WildHorserRegisterCarriage .. ", false)")
otherUIList[CppEnums.InteractionType.InteractionType_WildHorserRegisterCarriage]:SetShow(true)
local otherTextList = {
  ...
  [CppEnums.InteractionType.InteractionType_TakeBackGuildInstallation] = PAGetString(Defines.StringSheet_GAME, "LUA_INTERACTION_TAKEBACK_GUILDBUFF_TITLE"),
  [CppEnums.InteractionType.InteractionType_WildHorserRegisterCarriage] = PAGetString(Defines.StringSheet_GAME, "LUA_INTERACTION_WILDHORSE_REGISTER_CARRIAGE_TITLE")
}
local otherFunctionList = {
  ...
  [CppEnums.InteractionType.InteractionType_TakeBackGuildInstallation] = function(actor, index)
    if nil == actor then
      return getDefaultButtonInfo(actor, index)
    end
    if nil == otherUIList[index] or nil == otherTextList[index] then
    ...
    return otherUIList[CppEnums.InteractionType.InteractionType_TakeBackGuildInstallation], otherTextList[CppEnums.InteractionType.InteractionType_TakeBackGuildInstallation]
  end,
  [CppEnums.InteractionType.InteractionType_WildHorserRegisterCarriage] = function(actor, index)
    if nil == actor then
      return getDefaultButtonInfo(actor, index)
    end
    if nil == otherUIList[index] or nil == otherTextList[index] then
    ...
    return otherUIList[CppEnums.InteractionType.InteractionType_WildHorserRegisterCarriage], otherTextList[CppEnums.InteractionType.InteractionType_WildHorserRegisterCarriage]
  end
}
...
function Interaction_Show(actor)
  ...
  if true == houseShow and true == ToClient_IsInstanceFieldPlayerbyContentsType(__eInstanceContentsType_RedBattleField) then
  ...
  for ii = 0, #interactionTargetUIList do
    ...
    if isShow then
      ...
      if ii == CppEnums.InteractionType.InteractionType_Collect and PaGlobal_InteractionGathering_All_Open() == true then
        Panel_Interaction:SetShow(false)
        return
      end
...
function Interaction_isSetInteractableFragLua(actor, index)
  ...
  elseif index == CppEnums.InteractionType.InteractionType_TakeBackGuildInstallation then
    isShow = actor:isSetInteracatbleFrag(__eInteractionType_TakeBackGuildInstallation)
  elseif index == CppEnums.InteractionType.InteractionType_WildHorserRegisterCarriage then
    isShow = actor:isSetInteracatbleFrag(__eInteractionType_WildHorserRegisterCarriage)
...
function Interaction_ButtonPushed(interactionType)
  ...
  if PaGlobal_SkillGroup_All ~= nil and true == Panel_Window_SkillGroup_All:GetShow() and PaGlobal_SkillGroup_All._isWindow == false then
    return
  end
  ...
  elseif CppEnums.InteractionType.InteractionType_Ride == interactionType then
    ...
    if vehicleWrapper ~= nil then
      ...
      if vehicleActorProxy ~= nil then
        ...
        if vehicleWrapper:isOceanShip() == true and vehicleActorProxy:canUseShipLadder() == false then
          Proc_ShowMessage_Ack(PAGetString(Defines.StringSheet_SymbolNo, "eErrNoCantWithPvPMode"))
          return
        end
      end
  ...
  elseif CppEnums.InteractionType.InteractionType_FromClientLuaEvent == interactionType then
    ...
    return
  elseif CppEnums.InteractionType.InteractionType_TakeBackGuildInstallation == interactionType then
    interaction_processInteraction(__eInteractionType_TakeBackGuildInstallation)
    return
  elseif CppEnums.InteractionType.InteractionType_WildHorserRegisterCarriage == interactionType then
    interaction_processInteraction(__eInteractionType_WildHorserRegisterCarriage)
    return
  end
...
function Interaction_UpdatePerFrame_Desc()
  ...
  if Interaction_isSetInteractableFragLua(actor, CppEnums.InteractionType.InteractionType_Ride) == true then
    local vehicleWrapper = getVehicleActor(actor:get():getActorKeyRaw())
    if vehicleWrapper ~= nil then
      local vehicleActorProxy = vehicleWrapper:get()
      local isRidable = true
      if vehicleActorProxy ~= nil and vehicleWrapper:isOceanShip() == true and vehicleActorProxy:canUseShipLadder() == false then
        isRidable = false
      end
      interactionTargetUIList[CppEnums.InteractionType.InteractionType_Ride]:SetMonoTone(not isRidable)
    end
  end
end
function Interaction_UpdateDesc(indteractionType)
  ...
  elseif indteractionType == CppEnums.InteractionType.InteractionType_Ride and FGlobal_Interaction_CheckIsNotMyHorse() == true then
  ...
  elseif indteractionType == CppEnums.InteractionType.InteractionType_TakeBackGuildInstallation then
    interactionDesc = PAGetString(Defines.StringSheet_GAME, "LUA_INTERACTION_TAKEBACK_GUILDBUFF_DESC")
  elseif indteractionType == CppEnums.InteractionType.InteractionType_WildHorserRegisterCarriage then
    interactionDesc = PAGetString(Defines.StringSheet_GAME, "LUA_INTERACTION_WILDHORSE_REGISTER_CARRIAGE_DESC")
  elseif indteractionType == CppEnums.InteractionType.InteractionType_ReturnRentedMansion then
    interactionDesc = PAGetString(Defines.StringSheet_GAME, "INTERACTION_TEXT68")
  end
...
function FromClient_ConfirmInstallationBuff(currentEndurance, skillKey, level)
  ...
  if 0 ~= skillKey and 0 ~= level then
    local buffTimeMs_s64 = Defines.s64_const.s64_0
    ...
    if nil ~= skillWarpper then
      ...
      for buffIdx = 0, skillWarpper:getBuffCount() - 1 do
        ...
        local buffValidityTime_s64 = skillWarpper:getSkillValidityTime(buffIdx)
        if buffTimeMs_s64 < buffValidityTime_s64 then
          buffTimeMs_s64 = buffValidityTime_s64
        end
      end
      ...
      if buffTimeMs_s64 > Defines.s64_const.s64_0 then
        local buffTimeString = ""
        local buffTimeSecond = Int64toInt32(buffTimeMs_s64) / 1000
        local hours = math.floor(buffTimeSecond / 3600)
        local minutes = math.floor(buffTimeSecond % 3600 / 60)
        local seconds = buffTimeSecond % 60
        if hours > 0 then
          buffTimeString = buffTimeString .. tostring(hours) .. PAGetString(Defines.StringSheet_GAME, "LUA_GLOBAL_TIME_HOUR") .. " "
        end
        if minutes > 0 then
          buffTimeString = buffTimeString .. tostring(minutes) .. PAGetString(Defines.StringSheet_GAME, "LUA_GLOBAL_TIME_MINUTE") .. " "
        end
        if seconds > 0 then
          buffTimeString = buffTimeString .. tostring(seconds) .. PAGetString(Defines.StringSheet_GAME, "LUA_GLOBAL_TIME_SECOND") .. " "
        end
        messageboxData.content = messageboxData.content .. "\n" .. PAGetStringParam1(Defines.StringSheet_GAME, "LUA_HOUSING_BUFF_DURATION_TIME", "buffTime", buffTimeString)
      end
    end
  end
  MessageBox.showMessageBox(messageboxData)
...
function FGlobal_Interaction_CheckIsNotMyHorse()
  ...
  if vehicleActorProxy:isOwnerSelfPlayer() == false then
    ...
    if vehicleActorProxy:hasVehicleOwner() == false then
      return false
    end
    return true
  end
...
function Interaction_MatchingIndex(interactionType)
  ...
  elseif __eInteractionType_TakeBackGuildInstallation == interactionType then
    return CppEnums.InteractionType.InteractionType_TakeBackGuildInstallation
  end
