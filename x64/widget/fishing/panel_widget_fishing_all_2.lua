function HandleEventLUp_Fishing_All_SelectGrade(grade)
  ...
  ToClient_getGameUIManagerWrapper():setLuaCacheDataListNumber(__eFishingGrade, grade, CppEnums.VariableStorageType.eVariableStorageType_User)
end
...
function PaGlobal_Fishing_All_UpdatePerFrameFunc(deltaTime)
  ...
  if PaGlobal_Fishing_All._ui._btn_fishUpdateNotice:GetShow() == true and isPadPressed(__eJoyPadInputType_RightTrigger) == true and isPadUp(__eJoyPadInputType_Y) == true then
    PaGlobal_EncyclopediaNotice_Open()
    return
  end
...
function FromClient_Fishing_All_UpdateNotice()
  PaGlobal_Fishing_All:updateNotice()
end
