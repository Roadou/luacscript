function PaGlobal_Fishing_All:initialize()
  ...
  self._ui._btn_fishUpdateNotice = UI.getChildControl(Panel_Widget_Fishing_All, "Button_FishSize_Update")
  self._ui._stc_keyGuide_RT_Y = UI.getChildControl(self._ui._btn_fishUpdateNotice, "StaticText_KeyGuide_RT_Y_ConsoleUI")
  ...
  self._ui._stc_keyGuide_RT_Y:SetShow(self._isConsole)
  ...
  noneIcon:ChangeTextureInfoNameAsync("combine/etc/combine_etc_minigame_01.dds")
  ...
  noneSelectIcon:ChangeTextureInfoNameAsync("combine/etc/combine_etc_minigame_01.dds")
...
function PaGlobal_Fishing_All:registEventHandler()
  ...
  self._ui._btn_fishUpdateNotice:addInputEvent("Mouse_LUp", "PaGlobal_EncyclopediaNotice_Open()")
  registerEvent("FromClient_EventNavigationShow", "PaGlobal_Fishing_All_ShowEventAreaIcon")
  registerEvent("FromClient_UpdateFishEncyclopedia", "FromClient_Fishing_All_UpdateNotice")
end
...
function PaGlobal_Fishing_All:fishing_Start()
  if self._stateValue._isJaksal_0 == false then
    self._stateValue._isJaksal_0 = true
  end
...
function PaGlobal_Fishing_All:jaksal_0()
  if self._stateValue._isFishing_0 == false then
    self._stateValue._isFishing_0 = true
  end
...
function PaGlobal_Fishing_All:updateSpread()
  ...
  if nil ~= texUV then
    self._ui._btn_spread:ChangeTextureInfoNameAsync("combine/btn/combine_btn_00.dds")
...
function PaGlobal_Fishing_All:loadCache()
  self._currentSelectGrade = ToClient_getGameUIManagerWrapper():getLuaCacheDataListNumber(__eFishingGrade)
end
function PaGlobal_Fishing_All:updateNotice()
  self._ui._btn_fishUpdateNotice:SetShow(ToClient_GetEncyclopediaNoticeListSize() ~= 0)
end
