...
function HandleEventLUp_ChatSubMenuInviteParty()
  ...
  if nil ~= PaGlobal_ChatSubMenu._currentPoolIndex and nil ~= PaGlobal_ChatSubMenu._clickedMessageIndex then
    ...
    local isHardCoreChannel = ToClient_HardCoreChannelWithContensOption()
    if isSelfPlayerPlayingPvPMatch == false and isEnterPersonalField == false and isEnterPersonalRelayField == false and isHardCoreChannel == false then
      local nameType = ToClient_getChatNameType()
      local selectName
      if nameType == 0 then
...
function HandleEventLUp_ChatSubMenuBlockVoteRenew()
  if PaGlobal_ChatSubMenu._currentPoolIndex ~= nil and PaGlobal_ChatSubMenu._clickedMessageIndex ~= nil and PaGlobal_ChatSubMenu._clickedMsg ~= nil then
    PaGlobal_Window_Chat_Report_All_Open(PaGlobal_Window_Chat_Report_All._eOpenType.BlockVote, PaGlobal_ChatSubMenu._clickedName, PaGlobal_ChatSubMenu._clickedUserNickName, PaGlobal_ChatSubMenu._senderUserNo, PaGlobal_ChatSubMenu._clickedMsg, PaGlobal_ChatSubMenu._chatType, PaGlobal_ChatSubMenu._chatSendTime, PaGlobal_ChatSubMenu._chatSendServerTime, PaGlobal_ChatSubMenu._clickedUserId)
  end
  PaGlobal_ChatSubMenu:SetShow(false)
end
function HandleEventLUp_ChatSubMenuReportChat()
  if PaGlobal_ChatSubMenu._currentPoolIndex ~= nil and PaGlobal_ChatSubMenu._clickedMessageIndex ~= nil and PaGlobal_ChatSubMenu._clickedMsg ~= nil then
    ...
    elseif PaGlobal_ChatSubMenu._clickedMsg == nil or PaGlobal_ChatSubMenu._clickedMsg == "" then
      ...
      PaGlobal_Window_Chat_Report_All_Open(PaGlobal_Window_Chat_Report_All._eOpenType.Report, PaGlobal_ChatSubMenu._clickedName, PaGlobal_ChatSubMenu._clickedUserNickName, PaGlobal_ChatSubMenu._senderUserNo, PaGlobal_ChatSubMenu._clickedMsg, PaGlobal_ChatSubMenu._chatType, PaGlobal_ChatSubMenu._chatSendTime, PaGlobal_ChatSubMenu._chatSendServerTime, PaGlobal_ChatSubMenu._clickedUserId)
    end
  end
  PaGlobal_ChatSubMenu:SetShow(false)
end
