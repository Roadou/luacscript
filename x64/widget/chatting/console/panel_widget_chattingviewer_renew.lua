...
function ChattingViewer:createPool()
  ...
  local ChatUIPool = {
    ...
    _maxcount_ChattingLinkedQuest = ch._cloneCount,
  ...
  function ChatUIPool:initialize()
    for ii = 1, ch._cloneCount do
      ...
      ChatUIPool._list_ChattingLinkedQuest[ii] = UI.createAndCopyBasePropertyControl(ch._ui.stc_sampleBG, "StaticText_ChatLinkedQuest", ch._ui.stc_sampleBG, "StaticText_ChatLinkedQuest" .. ii)
