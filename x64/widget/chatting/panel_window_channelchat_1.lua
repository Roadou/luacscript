...
function PaGlobal_ChannelChat:controlInit_All()
  ...
  for index = 0, self._serverListCount - 1 do
    ...
    local baseTextureTID = NewClassData.channelChatDataTID[textureKey]
    if baseTextureTID ~= nil then
      clonSlot.btn_bg:ChangeTextureInfoTextureIDAsync(baseTextureTID, 0)
      clonSlot.btn_bg:setRenderTexture(clonSlot.btn_bg:getBaseTexture())
    else
...
function PaGlobal_ChannelChat:clearAll()
  ...
  elseif PaGlobalFunc_ChattingInfo_UpdatePermission ~= nil then
...
function PaGlobal_ChannelChat:setTextureControl(control, stringHashKey)
  ...
  local baseTextureTID = NewClassData.channelChatDataTID[stringHashKey]
  if baseTextureTID ~= nil then
    control:ChangeTextureInfoTextureIDAsync(baseTextureTID, 0)
...
function PaGlobal_ChannelChat:addChannelList(index)
  ...
  local baseTextureTID = NewClassData.channelChatDataTID[textureKey]
  if baseTextureTID ~= nil then
    cloneSlot.btn_bg:ChangeTextureInfoTextureIDAsync(baseTextureTID, 0)
    cloneSlot.btn_bg:setRenderTexture(cloneSlot.btn_bg:getBaseTexture())
  else
    _PA_ASSERT(false, "\236\161\180\236\158\172 \237\149\152\236\167\128 \236\149\138\235\138\148 \235\140\128\237\153\148\234\183\184\235\163\185 Texture\236\158\133\235\139\136\235\139\164")
  end
