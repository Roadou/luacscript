...
function PaGlobal_ChatMain:chattingPoolUpdate(poolCurrentUI, currentPanel, panelIndex, drawPanelIndex, isShow, bgAlpha, isClear)
  ...
  local static_buttonBG = PaGlobal_ChatMain:getStaticButtonBG(poolCurrentUI, panelIndex, drawPanelIndex, isShow, isEnableSimpleUI, isSimpleUI)
  local panel_DragToggle = PaGlobal_ChatMain:getPanelDragToggleButton(poolCurrentUI, panelIndex, drawPanelIndex, isShow, isEnableSimpleUI, isSimpleUI)
  panel_DragToggle:addInputEvent("Mouse_LUp", "HandleClicked_Chatting_ToggleDragMove(" .. drawPanelIndex .. ")")
  panel_DragToggle:addInputEvent("Mouse_On", "HandleEventOnOut_ChatMain_All_ToggleDragToolTip(" .. drawPanelIndex .. ", true)")
  panel_DragToggle:addInputEvent("Mouse_Out", "HandleEventOnOut_ChatMain_All_ToggleDragToolTip(" .. drawPanelIndex .. ", false)")
  PaGlobal_ChatMain:getButtonMove(poolCurrentUI, panelIndex, drawPanelIndex, isShow, isEnableSimpleUI, isSimpleUI)
end
