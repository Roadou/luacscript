...
function PaGlobal_MiniGame_SniperGame_All:setPerfectShotResult(type)
  ...
  if type == 1 then
    ...
    self._ui._crossHairGrid:ChangeTextureInfoTextureIDAsync("Combine_Etc_HuntingGame_CircleAiming_Grid_Re_Good")
    self._ui._crossHairGridGoodText:SetShow(false)
    self._ui._crossHairGridBadText:SetShow(false)
  ...
  elseif type == 2 then
    ...
    self._ui._crossHairGrid:ChangeTextureInfoTextureIDAsync("Combine_Etc_HuntingGame_CircleAiming_Grid_Re_Bad")
    self._ui._crossHairGridGoodText:SetShow(false)
    self._ui._crossHairGridBadText:SetShow(false)
    audioPostEvent_SystemUi(10, 7)
    _AudioPostEvent_SystemUiForXBOX(10, 7)
  else
    self._ui._crossHairGrid:ChangeTextureInfoTextureIDAsync("Combine_Etc_HuntingGame_CircleAiming_Grid_Re")
    self._ui._crossHairGridGoodText:SetShow(false)
    self._ui._crossHairGridBadText:SetShow(false)
  end
