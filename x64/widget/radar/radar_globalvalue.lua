...
if _ContentsGroup_HardCoreChannel == true then
  ...
  area.control = UI.getChildControl(Panel_Radar, "hardcore_blackfield_area")
  area.control:SetIgnore(true)
  area.control:SetColor(Defines.Color.C_FF000000)
  radarMap.hardCoreBlackFieldArea = area
end
...
function FGlobal_Panel_Radar_Movable_UI()
  ...
  Panel_Radar:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Default/window_sample_isWidget.dds")
...
function FGlobal_Panel_Radar_Movable_UI_Cancel()
  ...
  Panel_Radar:ChangeTextureInfoNameAsync("New_UI_Common_forLua/Default/Default_Etc_00.dds")
