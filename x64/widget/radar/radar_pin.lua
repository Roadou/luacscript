...
local Radar_Mine, Pin_Party, Pin_Party_Mine, Pin_Guild, Pin_Guild_Mine, Pin_Guild_Master, Pin_GuideArrow, Ping_Effect
...
local function CalcRadarPostionToWorldPostion()
  ...
  local float3Pos = float3(ToClient_getSelfPlayerPositionX() + intervalX, 0, ToClient_getSelfPlayerPositionZ() + intervalZ)
  return float3Pos
end
...
function SendPingInfo_ToConsole(isForGuild)
  ...
  local float3Pos = float3(ToClient_getSelfPlayerPositionX(), ToClient_getSelfPlayerPositionY(), ToClient_getSelfPlayerPositionZ())
...
function FGlobal_UpdateRadarPin()
  ...
  SelfPosX = ToClient_getSelfPlayerPositionX()
  SelfPosZ = ToClient_getSelfPlayerPositionZ()
