...
function Proc_ShowBigMessage_Ack_WithOut_ChattingMessage(message)
  ...
  ToClient_RequestNakMessageRenewelWithString(__eNakMessage_RewardSelect, messages.main, messages.sub)
end
...
local frameEventMessageIds = {
  ...
  "LUA_FRAMEEVENT_FLY_USED_FAIL",
  "LUA_FRAMEEVENT_RIDE_OFF_HP_LOW"
}
