...
local worldBossControls = {
  stc_worldBossImage = UI.getChildControl(stc_worldBossNewJin, "Static_BossImage"),
  txt_worldBossName = UI.getChildControl(stc_worldBossNewJin, "StaticText_BossName"),
  txt_worldBossDesc = UI.getChildControl(stc_worldBossNewJin, "StaticText_Desc"),
  stc_worldBossEffect = UI.getChildControl(stc_worldBossNewJin, "Static_Effect")
}
...
local stc_guildDragonMainBg = UI.getChildControl(Panel_RewardSelect_NakMessage, "Static_GuildDragon")
...
local roseWarGuild = UI.getChildControl(Panel_RewardSelect_NakMessage, "Static_RoseWar_Leader")
local roseWarMercenary = UI.getChildControl(Panel_RewardSelect_NakMessage, "Static_RoseWar_Mercenary")
local roseWarStart = UI.getChildControl(Panel_RewardSelect_NakMessage, "Static_RoseWar_Start")
local roseWarWin = UI.getChildControl(Panel_RewardSelect_NakMessage, "Static_RoseWar_Result_Win")
local roseWarLose = UI.getChildControl(Panel_RewardSelect_NakMessage, "Static_RoseWar_Result_Lose")
local roseWarTie = UI.getChildControl(Panel_RewardSelect_NakMessage, "Static_RoseWar_Result_Draw")
local siege2024Raffle = UI.getChildControl(Panel_RewardSelect_NakMessage, "Static_NodeWarSelection")
local hardCoreUI = {
  stc_HardCoreBossNak,
  stc_HardCoreBossNakText,
  stc_HardCoreBlackField,
  stc_HardCoreBlackFieldText,
  stc_HardCoreTimeLimit,
  stc_HardCoreRegionChange,
  stc_HardCoreRegionChangeText
}
hardCoreUI.stc_HardCoreBossNak = UI.getChildControl(Panel_RewardSelect_NakMessage, "Static_Hardcore_Boss")
hardCoreUI.stc_HardCoreBossNakText = UI.getChildControl(hardCoreUI.stc_HardCoreBossNak, "MultilineText_Desc")
hardCoreUI.stc_HardCoreBlackField = UI.getChildControl(Panel_RewardSelect_NakMessage, "Static_Hardcore_BlackBarrier")
hardCoreUI.stc_HardCoreBlackFieldText = UI.getChildControl(hardCoreUI.stc_HardCoreBlackField, "MultilineText_Desc")
hardCoreUI.stc_HardCoreBlackFieldText:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_BIGNAK_HARDCOREMESSAGE_1"))
hardCoreUI.stc_HardCoreTimeLimit = UI.getChildControl(Panel_RewardSelect_NakMessage, "Static_Hardcore_TimeLimit")
hardCoreUI.stc_HardCoreRegionChange = UI.getChildControl(Panel_RewardSelect_NakMessage, "Static_Hardcore_Region")
hardCoreUI.stc_HardCoreRegionChangeText = UI.getChildControl(hardCoreUI.stc_HardCoreRegionChange, "MultilineText_Desc")
hardCoreUI.stc_HardCoreRegionChangeText:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_RADER_ISSAFETYZONE_ACK_MAIN"))
local edaniaNak1 = UI.getChildControl(Panel_RewardSelect_NakMessage, "Static_Edania_01")
local edaniaNak2 = UI.getChildControl(Panel_RewardSelect_NakMessage, "Static_Edania_02")
local edaniaNak3 = UI.getChildControl(Panel_RewardSelect_NakMessage, "Static_Edania_03")
local edaniaNak4 = UI.getChildControl(Panel_RewardSelect_NakMessage, "Static_Edania_04")
...
roseWarGuild:SetShow(false)
roseWarMercenary:SetShow(false)
roseWarStart:SetShow(false)
roseWarWin:SetShow(false)
roseWarLose:SetShow(false)
roseWarTie:SetShow(false)
siege2024Raffle:SetShow(false)
edaniaNak1:SetShow(false)
edaniaNak2:SetShow(false)
edaniaNak3:SetShow(false)
edaniaNak4:SetShow(false)
local messageType = {
  safetyArea = 0,
  combatArea = 1,
  challengeComplete = 2,
  ...
  RoseWarApplyGuild = 173,
  RoseWarApplyMercenary = 174,
  RoseWarRaffleGuild = 175,
  RoseWarRaffleMercenary = 176,
  RoseWarStart = 177,
  RoseWarKamasylviaWin = 178,
  RoseWarOdylitaWin = 179,
  RoseWarTie = 180,
  Siege2024Raffle = 181,
  ...
  KingAccessory = 188,
  GuildMansionBuffEvent = 189,
  hardCoreBossNak = 190,
  hardCoreBlackFieldNak = 191,
  hardCoreTimeLimitNak = 192,
  hardCoreTimeRegionChange = 193,
  fantasyMix_Voltarion = 194,
  GoldOrcShow = 195,
  GuildDragonRegist = 196,
  StoneCrabQueen = 197,
  EdaniaNak1 = 198,
  EdaniaNak2 = 199,
  EdaniaNak3 = 200,
...
local messageTexture = {
  ...
  [messageType.GuildMansionBuffEvent] = "New_UI_Common_forLua/Widget/NakMessage/Guild_Call.dds",
  ...
  [messageType.guildMatchNormal] = "New_UI_Common_forLua/Widget/NakMessage/NakBG_GuildwarReservation.dds",
  [messageType.guildMatchStart] = "New_UI_Common_forLua/Widget/NakMessage/NakBG_GuildwarStart.dds",
  [messageType.guildMatchEnd] = "New_UI_Common_forLua/Widget/NakMessage/NakBG_GuildwarEnd.dds",
  ...
  [messageType.RoseWarApplyGuild] = "Combine/Etc/Combine_Etc_Nak_Elfwar_BattleReady_1.dds",
  [messageType.RoseWarApplyMercenary] = "Combine/Etc/Combine_Etc_Nak_Elfwar_BattleReady_2.dds",
  [messageType.RoseWarRaffleGuild] = "Combine/Etc/Combine_Etc_Nak_Elfwar_BattleReady_1.dds",
  [messageType.RoseWarRaffleMercenary] = "Combine/Etc/Combine_Etc_Nak_Elfwar_BattleReady_2.dds",
  [messageType.RoseWarStart] = "Combine/Etc/Combine_Etc_Nak_Elfwar_BattleStart.dds",
  [messageType.RoseWarKamasylviaWin] = "Combine/Etc/Combine_Etc_Nak_Elfwar_Result_1.dds",
  [messageType.RoseWarOdylitaWin] = "Combine/Etc/Combine_Etc_Nak_Elfwar_Result_4.dds",
  [messageType.RoseWarTie] = "Combine/Etc/Combine_Etc_Nak_Elfwar_Result_3.dds",
  ...
  [messageType.fantasyMix_Voltarion] = "new_ui_common_forlua/widget/nakmessage/Nak_Voltarion.dds",
  [messageType.GoldOrcShow] = "Combine/Etc/PersonalRelay_Gold_Orc.dds",
  [messageType.GuildDragonRegist] = "Combine/Etc/Combine_ETC_Nak_StableBG_05.dds",
  [messageType.StoneCrabQueen] = "new_ui_common_forlua/widget/nakmessage/StoneCrabEvent.dds",
  [messageType.EdaniaNak1] = "Combine/Etc/Combine_Etc_Edania_Nak.dds",
  [messageType.EdaniaNak2] = "Combine/Etc/Combine_Etc_Edania_Nak.dds",
  [messageType.EdaniaNak3] = "Combine/Etc/Combine_Etc_Edania_Nak.dds",
  [messageType.EdaniaNak4] = "Combine/Etc/Combine_Etc_Edania_Nak.dds"
}
local npcTexture = {
...
local gameOptionIgnoreMessageType = {
  ...
  messageType.GuildMansionBuffEvent,
  ...
  messageType.militiaReponseMsg,
  messageType.guildMatchNormal,
  messageType.guildMatchStart,
  messageType.guildMatchEnd,
  ...
  messageType.RoseWarApplyGuild,
  messageType.RoseWarApplyMercenary,
  messageType.RoseWarRaffleGuild,
  messageType.RoseWarRaffleMercenary,
  messageType.RoseWarStart,
  messageType.RoseWarKamasylviaWin,
  messageType.RoseWarOdylitaWin,
  messageType.RoseWarTie,
  ...
  messageType.hardCoreBossNak,
  messageType.hardCoreBlackFieldNak,
  messageType.hardCoreTimeLimitNak,
  messageType.GoldOrcShow,
  messageType.GuildDragonRegist,
  messageType.StoneCrabQueen,
  messageType.EdaniaNak1,
  messageType.EdaniaNak2,
  messageType.EdaniaNak3,
  messageType.EdaniaNak4
}
local worldBossName = {
...
function FGlobal_WorldBossShow(message, noticeType, noticeValue)
  ...
  elseif 12 == noticeType then
    ...
    elseif 196 == noticeValue then
      audioPostEvent_SystemUi(19, 51)
      _AudioPostEvent_SystemUiForXBOX(19, 51)
      msgType = messageType.StoneCrabQueen
  ...
  elseif CppEnums.EChatNoticeType.GoldOrcShow == noticeType then
    msgType = messageType.GoldOrcShow
  end
  Proc_ShowMessage_Ack_For_RewardSelect(msg, 6, msgType)
end
function FromClient_ShowGuildMatchPlayNak(matchingType, nakType)
  local msgType
  local msg = {
    main = "",
    sub = "",
  ...
  local matchingTypeString = ""
  if _ContentsGroup_GuildMatchRenewMatching == true and (matchingType == __eGuildMatchMatchingType_Main or matchingType == __eGuildMatchMatchingType_Sub1 or matchingType == __eGuildMatchMatchingType_Sub2) then
    matchingTypeString = "[" .. PAGetString(Defines.StringSheet_GAME, "LUA_GUILDMATCH_MATCHING_TYPE_" .. tostring(matchingType)) .. "] "
  end
  if nakType == __eGuildMatchNakUIType_JoinMatching then
    msg.main = PAGetString(Defines.StringSheet_GAME, "LUA_GUILDMATCH_BIGNAK_1")
    msgType = messageType.guildMatchNormal
  ...
  msg.main = matchingTypeString .. msg.main
  if msgType ~= nil then
    Proc_ShowMessage_Ack_For_RewardSelect(msg, 5, msgType)
  end
end
function FromClient_NotifyInstanceContentsCollectReplay(recordType, notifyType)
  local msgType = messageType.normal
  local msg = {
    main = nil,
    sub = "",
    addMsg = ""
  ...
  if recordType == __eReplayRecordType_Solare then
    if notifyType == __eInstanceContentsReplayNotify_StartRecord then
      msg.main = PAGetString(Defines.StringSheet_GAME, "LUA_INSTANCE_CONTENTS_REPLAY_STARTRECORD")
    elseif notifyType == __eInstanceContentsReplayNotify_EndRecord then
      msg.main = PAGetString(Defines.StringSheet_GAME, "LUA_INSTANCE_CONTENTS_REPLAY_ENDRECORD")
    end
  else
    UI.ASSERT_NAME(false, "\235\185\132\236\160\149\236\131\129\236\158\133\235\139\136\235\139\164. \235\130\152\237\129\172 \237\131\128\236\158\133\236\157\180 \236\160\149\236\157\152\235\144\152\236\167\128 \236\149\138\236\149\152\236\138\181\235\139\136\235\139\164. \236\151\172\234\184\176\235\143\132 \236\158\145\236\151\133\237\149\180\236\163\188\236\133\168\235\130\152\236\154\148?", "\236\157\180\236\163\188")
    return
  end
  if msgType ~= nil and msg.main ~= nil then
    Proc_ShowMessage_Ack_For_RewardSelect(msg, 5, msgType)
  end
end
function Proc_ShowMessage_Ack_For_RewardSelect(message, showRate, msgType, exposure, isSelfPlayer)
  ...
  elseif messageType.guildMatchNormal == msgType or messageType.guildMatchStart == msgType or messageType.guildMatchEnd == msgType then
    chatting_sendMessage("", message.main, CppEnums.ChatType.System)
...
function Proc_ShowMessage_Ack_WithOut_ChattingMessage_For_RewardSelect(message, showRate, msgType, exposure, isSelfPlayer)
  if _ContentsGroup_NakMessageDataCollect == true and msgType >= 0 then
    if nakMessageCollectData.dataList[msgType] == nil then
      nakMessageCollectData.dataList[msgType] = 1
    else
      nakMessageCollectData.dataList[msgType] = nakMessageCollectData.dataList[msgType] + 1
    end
  end
  ...
  if 0 < ToClient_GetMyTeamNoRedBattleField() and (nil == exposure or true == exposure) then
    return
  end
  ...
  local isParticipateInRoseWar = ToClient_IsParticipateInRoseWar()
  if roseWarState == __eRoseWar_Start and isParticipateInRoseWar == true and msgType ~= messageType.RoseWarStart and msgType ~= messageType.RoseWarKamasylviaWin and msgType ~= messageType.RoseWarOdylitaWin and msgType ~= messageType.RoseWarTie and msgType ~= messageType.guildNotify and msgType ~= messageType.GuildMansionBuffEvent then
    return
  end
  if _ContentsGroup_GuildMatch == true and ToClient_IsInstanceFieldPlayerbyContentsType(__eInstanceContentsType_GuildMatch) == true and msgType ~= messageType.guildMatchNormal and msgType ~= messageType.guildMatchStart and msgType ~= messageType.guildMatchEnd and msgType ~= messageType.guildNotify and msgType ~= messageType.GuildMansionBuffEvent then
    return
  end
  if ToClient_HardCoreChannelWithContensOption() == true and msgType ~= messageType.anotherPlayerGotItem and msgType ~= messageType.hardCoreBossNak and msgType ~= messageType.hardCoreBlackFieldNak and msgType ~= messageType.hardCoreTimeLimitNak and msgType ~= messageType.hardCoreTimeRegionChange then
    return
...
function NakMessage_UpdateRewardItemState(titleText, descText, iconPath)
  ...
  stc_rewardItemIcon:ChangeTextureInfoNameAsync(iconPath)
...
local tempMsg
function NakMessage_CheckCondition()
...
function NakMessageUpdate_For_RewardSelect(updateTime)
  if _ContentsGroup_NakMessageDataCollect == true then
    nakMessageCollectData.elapsedTime = nakMessageCollectData.elapsedTime + updateTime
    if nakMessageCollectData.elapsedTime >= 600 then
      nakMessageCollectData.elapsedTime = 0
      local tkeys = {}
      for k in pairs(nakMessageCollectData.dataList) do
        table.insert(tkeys, k)
      end
      table.sort(tkeys)
      _PA_LOG("Nak \235\141\176\236\157\180\237\132\176 \236\136\152\236\167\145", "==================== Nak \236\136\152\236\167\145 \235\141\176\236\157\180\237\132\176 \236\182\156\235\160\165 ====================")
      for _, k in ipairs(tkeys) do
        if value ~= 0 then
          _PA_LOG("Nak \235\141\176\236\157\180\237\132\176 \236\136\152\236\167\145", "NakMsgType = [" .. k .. "],  Frequency = [" .. nakMessageCollectData.dataList[k] .. "]")
        end
      end
    end
  end
  if NakMessage_CheckCondition() == false then
    return
  end
  ...
  if animationEndTime <= elapsedTime then
    if processIndex < curIndex then
      ...
      elseif messageType.worldBossjinKzaka == MessageData._Msg[processIndex].type then
        ...
        eventBossUIOff()
        eventDrawUIOff()
        worldBossControls.stc_worldBossImage:ChangeTextureInfoNameAsync(messageTexture[MessageData._Msg[processIndex].type])
        local x1, y1, x2, y2 = setTextureUV_Func(worldBossControls.stc_worldBossImage, 334, 778, 666, 960)
        worldBossControls.stc_worldBossImage:getBaseTexture():setUV(x1, y1, x2, y2)
        worldBossControls.stc_worldBossImage:setRenderTexture(worldBossControls.stc_worldBossImage:getBaseTexture())
      elseif messageType.worldBossJinNuver == MessageData._Msg[processIndex].type then
        ...
        eventDrawUIOff()
        worldBossControls.stc_worldBossImage:ChangeTextureInfoNameAsync(messageTexture[MessageData._Msg[processIndex].type])
        local x1, y1, x2, y2 = setTextureUV_Func(worldBossControls.stc_worldBossImage, 667, 778, 999, 960)
        worldBossControls.stc_worldBossImage:getBaseTexture():setUV(x1, y1, x2, y2)
        worldBossControls.stc_worldBossImage:setRenderTexture(worldBossControls.stc_worldBossImage:getBaseTexture())
      elseif messageType.worldBossJinKaranda == MessageData._Msg[processIndex].type then
        ...
        eventDrawUIOff()
        worldBossControls.stc_worldBossImage:ChangeTextureInfoNameAsync(messageTexture[MessageData._Msg[processIndex].type])
        local x1, y1, x2, y2 = setTextureUV_Func(worldBossControls.stc_worldBossImage, 1000, 595, 1332, 777)
        worldBossControls.stc_worldBossImage:getBaseTexture():setUV(x1, y1, x2, y2)
        worldBossControls.stc_worldBossImage:setRenderTexture(worldBossControls.stc_worldBossImage:getBaseTexture())
      elseif messageType.fieldBossBlackShadow == MessageData._Msg[processIndex].type then
        ...
        eventDrawUIOff()
        worldBossControls.stc_worldBossImage:ChangeTextureInfoNameAsync(messageTexture[MessageData._Msg[processIndex].type])
        local x1, y1, x2, y2 = setTextureUV_Func(worldBossControls.stc_worldBossImage, 1000, 229, 1332, 411)
        worldBossControls.stc_worldBossImage:getBaseTexture():setUV(x1, y1, x2, y2)
        worldBossControls.stc_worldBossImage:setRenderTexture(worldBossControls.stc_worldBossImage:getBaseTexture())
      ...
      elseif messageType.worldBossJinKutum == MessageData._Msg[processIndex].type then
        ...
        eventDrawUIOff()
        worldBossControls.stc_worldBossImage:ChangeTextureInfoNameAsync(messageTexture[MessageData._Msg[processIndex].type])
        local x1, y1, x2, y2 = setTextureUV_Func(worldBossControls.stc_worldBossImage, 1000, 778, 1332, 960)
        worldBossControls.stc_worldBossImage:getBaseTexture():setUV(x1, y1, x2, y2)
        worldBossControls.stc_worldBossImage:setRenderTexture(worldBossControls.stc_worldBossImage:getBaseTexture())
      elseif messageType.train == MessageData._Msg[processIndex].type or messageType.guildDrillInstall == MessageData._Msg[processIndex].type or messageType.guildDrillComplete == MessageData._Msg[processIndex].type or messageType.guildDrillDelete == MessageData._Msg[processIndex].type or messageType.startVote == MessageData._Msg[processIndex].type or messageType.startVote == MessageData._Msg[processIndex].type then
      ...
      elseif messageType.morningBoss == MessageData._Msg[processIndex].type or messageType.thousandInsam == MessageData._Msg[processIndex].type or messageType.BabyBell == MessageData._Msg[processIndex].type then
        stc_NoticeImage:SetShow(false)
        stc_bossImage:SetShow(false)
        belmornBG:SetShow(false)
        belmornText:SetShow(false)
      ...
      elseif messageType.DragonPalaceCommon == MessageData._Msg[processIndex].type or messageType.CrogdaloStable == MessageData._Msg[processIndex].type or messageType.Telescope == MessageData._Msg[processIndex].type or messageType.ElementalBossBuffSun == MessageData._Msg[processIndex].type or messageType.ElementalBossBuffMoon == MessageData._Msg[processIndex].type or messageType.ElementalBossBuffLand == MessageData._Msg[processIndex].type then
        stc_NoticeImage:SetShow(false)
        stc_bossImage:SetShow(false)
        belmornBG:SetShow(false)
        belmornText:SetShow(false)
        ...
        eventBossUIOff()
        eventDrawUIOff()
      elseif messageType.RoseWarApplyGuild == MessageData._Msg[processIndex].type or messageType.RoseWarApplyMercenary == MessageData._Msg[processIndex].type or messageType.RoseWarRaffleGuild == MessageData._Msg[processIndex].type or messageType.RoseWarRaffleMercenary == MessageData._Msg[processIndex].type or messageType.RoseWarStart == MessageData._Msg[processIndex].type or messageType.RoseWarKamasylviaWin == MessageData._Msg[processIndex].type or messageType.RoseWarOdylitaWin == MessageData._Msg[processIndex].type or messageType.RoseWarTie == MessageData._Msg[processIndex].type or messageType.morningLandWorldBossBulgasal == MessageData._Msg[processIndex].type or messageType.morningLandWorldBossUturi == MessageData._Msg[processIndex].type or messageType.morningLandWorldBossSangun == MessageData._Msg[processIndex].type or messageType.morningLandWorldBossDuoksini == MessageData._Msg[processIndex].type or messageType.morningLandWorldBossGoldenPig == MessageData._Msg[processIndex].type or messageType.KingAccessory == MessageData._Msg[processIndex].type then
        stc_NoticeImage:SetShow(false)
        stc_bossImage:SetShow(false)
        belmornBG:SetShow(false)
        belmornText:SetShow(false)
      ...
      elseif messageType.Siege2024Raffle == MessageData._Msg[processIndex].type then
        ...
        eventBossUIOff()
        eventDrawUIOff()
      elseif messageType.GoldOrcShow == MessageData._Msg[processIndex].type then
        stc_NoticeImage:SetShow(false)
        stc_bossImage:SetShow(false)
        belmornBG:SetShow(false)
        belmornText:SetShow(false)
        ...
        eventBossUIOff()
        eventDrawUIOff()
        local stc_personalRelay = UI.getChildControl(Panel_RewardSelect_NakMessage, "Static_PersonalRelay")
        local txt_personalRelay = UI.getChildControl(stc_personalRelay, "MultilineText_Desc")
        stc_personalRelay:SetShow(true)
        stc_personalRelay:EraseAllEffect()
        stc_personalRelay:AddEffect("fUI_NakMessage_GoldOrcDrop_01A", false, 0, 0)
        txt_personalRelay:SetText(MessageData._Msg[processIndex].msg.main)
        audioPostEvent_SystemUi(13, 29)
        _AudioPostEvent_SystemUiForXBOX(13, 29)
      elseif messageType.hardCoreBossNak == MessageData._Msg[processIndex].type or messageType.hardCoreBlackFieldNak == MessageData._Msg[processIndex].type or messageType.hardCoreTimeLimitNak == MessageData._Msg[processIndex].type or messageType.hardCoreTimeRegionChange == MessageData._Msg[processIndex].type then
        stc_NoticeImage:SetShow(false)
        stc_bossImage:SetShow(false)
        belmornBG:SetShow(false)
        belmornText:SetShow(false)
        ...
        eventBossUIOff()
        eventDrawUIOff()
      elseif messageType.GuildDragonRegist == MessageData._Msg[processIndex].type then
        stc_guildDragonMainBg:SetShow(true)
        local mainText = UI.getChildControl(stc_guildDragonMainBg, "StaticText_Dragon_Main")
        local subText = UI.getChildControl(stc_guildDragonMainBg, "StaticText_Dragon_Sub")
        local effectBG = UI.getChildControl(stc_guildDragonMainBg, "Static_Dragon_Effect")
        effectBG:AddEffect("fUI_Dragon_Succes_01A", false, 0, 0)
        mainText:SetText(MessageData._Msg[processIndex].msg.main)
        subText:SetText(MessageData._Msg[processIndex].msg.sub)
      elseif messageType.StoneCrabQueen == MessageData._Msg[processIndex].type then
        local stc_StoneCrabQueenMainBg = UI.getChildControl(Panel_RewardSelect_NakMessage, "Static_StoneCrabQueen")
        stc_StoneCrabQueenMainBg:SetShow(true)
        local mainText = UI.getChildControl(stc_StoneCrabQueenMainBg, "StaticText_StoneCrabQueen_Main")
        mainText:SetText(MessageData._Msg[processIndex].msg.main)
      elseif messageType.EdaniaNak1 == MessageData._Msg[processIndex].type or messageType.EdaniaNak2 == MessageData._Msg[processIndex].type or messageType.EdaniaNak3 == MessageData._Msg[processIndex].type or messageType.EdaniaNak4 == MessageData._Msg[processIndex].type then
        stc_NoticeImage:SetShow(false)
        stc_bossImage:SetShow(false)
        belmornBG:SetShow(false)
        belmornText:SetShow(false)
      ...
      elseif messageType.servantMarket == MessageData._Msg[processIndex].type then
        ...
        nakItemIcon:ChangeTextureInfoNameAsync(MessageData._Msg[processIndex].msg.addMsg)
      ...
      elseif messageType.worldBossjinKzaka == MessageData._Msg[processIndex].type then
        worldBossControls.txt_worldBossName:SetText(worldBossName[MessageData._Msg[processIndex].type])
        worldBossControls.txt_worldBossDesc:SetText(MessageData._Msg[processIndex].msg.main)
        worldBossControls.stc_worldBossEffect:AddEffect("fUI_JinBoss_Nak_01A", false, 0, 0)
      elseif messageType.worldBossJinNuver == MessageData._Msg[processIndex].type then
        worldBossControls.txt_worldBossName:SetText(worldBossName[MessageData._Msg[processIndex].type])
        worldBossControls.txt_worldBossDesc:SetText(MessageData._Msg[processIndex].msg.main)
        worldBossControls.stc_worldBossEffect:AddEffect("fUI_JinBoss_Nak_01A", false, 0, 0)
      ...
      elseif messageType.StoneCrabQueen == MessageData._Msg[processIndex].type then
        local stc_StoneCrabQueenMainBg = UI.getChildControl(Panel_RewardSelect_NakMessage, "Static_StoneCrabQueen")
        local txt_StoneCrabQueenDesc = UI.getChildControl(stc_StoneCrabQueenMainBg, "StaticText_StoneCrabQueen_Main")
        txt_StoneCrabQueenDesc:SetText(MessageData._Msg[processIndex].msg.main)
      else
        _text_Msg:SetFontColor(Defines.Color.C_FFFFEF82)
        _text_MsgSub:SetFontColor(Defines.Color.C_FFFFEF82)
      end
      ...
      elseif messageType.thousandInsam == MessageData._Msg[processIndex].type then
        ...
        thousandInsamIcon:ChangeTextureInfoNameAsync(MessageData._Msg[processIndex].msg.addMsg)
      ...
      elseif messageType.RoseWarApplyGuild == MessageData._Msg[processIndex].type or messageType.RoseWarApplyMercenary == MessageData._Msg[processIndex].type or messageType.RoseWarRaffleGuild == MessageData._Msg[processIndex].type or messageType.RoseWarRaffleMercenary == MessageData._Msg[processIndex].type or messageType.RoseWarStart == MessageData._Msg[processIndex].type or messageType.RoseWarKamasylviaWin == MessageData._Msg[processIndex].type or messageType.RoseWarOdylitaWin == MessageData._Msg[processIndex].type or messageType.RoseWarTie == MessageData._Msg[processIndex].type then
        PaGlobal_RewardSelect_SetNak_RoseWar(MessageData._Msg[processIndex].type, MessageData._Msg[processIndex].msg)
      elseif messageType.Siege2024Raffle == MessageData._Msg[processIndex].type then
      ...
      elseif messageType.hardCoreBossNak == MessageData._Msg[processIndex].type or messageType.hardCoreBlackFieldNak == MessageData._Msg[processIndex].type or messageType.hardCoreTimeLimitNak == MessageData._Msg[processIndex].type or messageType.hardCoreTimeRegionChange == MessageData._Msg[processIndex].type then
        PaGlobal_RewardSelect_SetNak_HardCore(MessageData._Msg[processIndex])
      elseif messageType.EdaniaNak1 == MessageData._Msg[processIndex].type or messageType.EdaniaNak2 == MessageData._Msg[processIndex].type or messageType.EdaniaNak3 == MessageData._Msg[processIndex].type or messageType.EdaniaNak4 == MessageData._Msg[processIndex].type then
        PaGlobal_RewardSelect_SetNak_Edania(MessageData._Msg[processIndex].type, MessageData._Msg[processIndex].msg)
...
function FromClient_notifyGetItem(notifyType, playerName, fromName, iconPath, param1, itemStaticWrapper, isPickedFromShip, isEnchantDown)
  ...
  if ToClient_namelessPVPServer() == true and ToClient_HardCoreChannelWithContensOption() == false then
  ...
  local isSpecialAccessory = false
  ...
  if nil ~= itemStaticWrapper and itemStaticWrapper:isSet() then
    ...
    isSpecialAccessory = itemStaticWrapper:isSpecialAccessory()
  end
  for index = 1, 5 do
    huntingRanker[index]:SetShow(false)
  end
  ...
  elseif notifyType == __eBroadCastNotifyType_EnchantItem or notifyType == __eBroadCastNotifyType_PromotionItem then
    if nil ~= Int64toInt32(param1) and 0 ~= Int64toInt32(param1) then
      ...
      elseif CppEnums.ItemClassifyType.eItemClassify_Accessory == itemClassify then
        if isSpecialItem == false or isSpecialAccessory == true then
          itemName = HighAccessoryEnchantLevel_ReplaceString(enchantLevel) .. " " .. itemName
        end
      else
        itemName = HighEnchantLevel_ReplaceString(enchantLevel) .. " " .. itemName
      end
      if notifyType == __eBroadCastNotifyType_EnchantItem and CppEnums.ItemClassifyType.eItemClassify_Accessory ~= itemClassify and enchantLevel < 19 then
        isSkipNak = true
      end
    end
    message = PAGetStringParam2(Defines.StringSheet_GAME, "LUA_REWARDSELECT_NAKMESSAGE_NOTIFY_COMMON_MSG", "playerName", playerName, "itemName", itemName)
  ...
  elseif notifyType == __eBroadCastNotifyType_EnchantItemFail then
    ...
    if isSpecialItem == true and isSpecialAccessory == false then
      enchantLevel = 0
    end
  ...
  elseif notifyType == __eBroadCastNotifyType_FantasyMixSuccess then
    ...
    elseif toInt64(0, 31613) == param1 then
      Proc_ShowMessage_Ack_For_RewardSelect(msg, 5, messageType.fantasyMix_Voltarion, nil, isSelfPlayer)
    end
  elseif notifyType == __eBroadCastNotifyType_WinDrawItem then
...
function FromClient_NoticeGuildMansionBuffInstallationEvent(userNickname, itemEnchantKey, historyType)
  local mainStr = ""
  local itemSSW = getItemEnchantStaticStatus(itemEnchantKey)
  if itemSSW == nil then
    return
  end
  if historyType == __eGuildMansionBuffHistoryType_Install then
    mainStr = PAGetStringParam2(Defines.StringSheet_GAME, "LUA_GUILD_MANSION_BUFF_HISTORY_NAK_INSTALL", "userNickName", userNickname, "itemName", itemSSW:getName())
  elseif historyType == __eGuildMansionBuffHistoryType_Use then
    mainStr = PAGetStringParam1(Defines.StringSheet_GAME, "LUA_GUILD_MANSION_BUFF_HISTORY_NAK_USE", "itemName", itemSSW:getName())
  else
    return
  end
  local msg = {
  ...
  Proc_ShowMessage_Ack_WithOut_ChattingMessage_For_RewardSelect(msg, 3.5, messageType.GuildMansionBuffEvent)
end
function FromClient_Notify_VehicleRegister(_noticeSender, characterKey, isMe, fromName, iconPath)
  local selfPlayer = getSelfPlayer()
  if selfPlayer == nil then
    return
  end
  local isSelfPlayer = selfPlayer:getUserNickname() == _noticeSender or selfPlayer:getOriginalName() == _noticeSender
  if isSelfPlayer == false and ToClient_namelessPVPServer() == true then
  ...
  elseif characterKey == 31611 or characterKey == 31612 then
    local msg = {
      main = PAGetStringParam2(Defines.StringSheet_GAME, "LUA_REWARDSELECT_NAKMESSAGE_NOTIFY_HORSE9Tier_MSG", "playerName", _noticeSender, "servantName", fromName),
      sub = "",
      addMsg = iconPath
    }
    Proc_ShowMessage_Ack_WithOut_ChattingMessage_For_RewardSelect(msg, 3.5, messageType.fantasyMix_Voltarion, false)
    if isSelfPlayer == true and false == Panel_Dialog_ServantSwiftResult_All:GetShow() and nil ~= PaGlobalFunc_ServantSwiftResult_All_fantasyVoltarionEffect then
      PaGlobalFunc_ServantSwiftResult_All_fantasyVoltarionEffect()
    end
  else
    local msg = {
...
function FromClient_ElementalMonsterBuffNakMessage(userNickname, monsterKeyRaw)
  ...
  local conquestLevel = elementalStatSS:getLevel()
...
function FromClient_RoseWarNakMessage(roseWarEventType)
  if roseWarEventType == nil then
    return
  end
  local mainStr = ""
  local subStr = ""
  ...
  local showTime = 5
  local msgTypeParam
  if roseWarEventType == __eRoseWarEventType_ApplyGuild then
    mainStr = PAGetString(Defines.StringSheet_GAME, "LUA_ROSEWAR_NAK_READER_RECRUIT")
    msgTypeParam = messageType.RoseWarApplyGuild
  elseif roseWarEventType == __eRoseWarEventType_ApplyMercenary then
    mainStr = PAGetString(Defines.StringSheet_GAME, "LUA_ROSEWAR_NAK_MERCENARY_RECRUIT")
    msgTypeParam = messageType.RoseWarApplyMercenary
  elseif roseWarEventType == __eRoseWarEventType_RaffleGuild then
    local guildName1 = ToClient_GetRoseWarGuildName(__eRoseWarTeam_Kamasylvia)
    local guildName2 = ToClient_GetRoseWarGuildName(__eRoseWarTeam_Odyllita)
    ...
    msgTypeParam = messageType.RoseWarRaffleGuild
  elseif roseWarEventType == __eRoseWarEventType_RaffleMercenary then
    mainStr = PAGetString(Defines.StringSheet_GAME, "LUA_ROSEWAR_NAK_MERCENARY_PICK")
    msgTypeParam = messageType.RoseWarRaffleMercenary
  elseif roseWarEventType == __eRoseWarEventType_Start then
    mainStr = PAGetString(Defines.StringSheet_GAME, "LUA_ROSEWAR_NAK_WARSTART")
    msgTypeParam = messageType.RoseWarStart
  elseif roseWarEventType == __eRoseWarEventType_KamasylviaWin then
    local guildName = ToClient_GetRoseWarGuildName(__eRoseWarTeam_Kamasylvia)
    if guildName == "" then
    ...
    msgTypeParam = messageType.RoseWarKamasylviaWin
  elseif roseWarEventType == __eRoseWarEventType_OdylitaWin then
    local guildName = ToClient_GetRoseWarGuildName(__eRoseWarTeam_Odyllita)
    if guildName == "" then
    ...
    msgTypeParam = messageType.RoseWarOdylitaWin
  elseif roseWarEventType == __eRoseWarEventType_Tie then
    mainStr = PAGetString(Defines.StringSheet_GAME, "LUA_ROSEWAR_NAK_DRAW")
    msgTypeParam = messageType.RoseWarTie
  else
    UI.ASSERT_NAME(false, "RoseWarEventType\236\157\180 \236\182\148\234\176\128\235\144\152\235\169\180 \236\151\172\234\184\176\235\143\132 \236\158\145\236\151\133\237\149\180\236\163\188\236\132\184\236\154\148!", "\236\157\180\236\163\188")
    return
  end
  local msg = {
    main = mainStr,
...
function FromClient_EdaniaNakMessage(nakMessageType, mainStr, subStr, addStr)
  if nakMessageType == nil then
    return
  end
  local mainStr = mainStr
  local subStr = subStr
  local addStr = addStr
  local showTime = 5
  local msgTypeParam
  if nakMessageType == __eNakMessage_EdanaChange then
    msgTypeParam = messageType.EdaniaNak1
  elseif nakMessageType == __eNakMessage_EdanaChallenge then
    msgTypeParam = messageType.EdaniaNak2
  elseif nakMessageType == __eNakMessage_EdanaFail then
    msgTypeParam = messageType.EdaniaNak3
  elseif nakMessageType == __eNakMessage_EdanaBuff then
    msgTypeParam = messageType.EdaniaNak4
  end
  local msg = {
    main = mainStr,
    sub = subStr,
...
function FromClient_RegistGuildServant(vehicleType, guildName)
  ...
  if vehicleType == CppEnums.VehicleType.Type_Elephant then
    msg = {
      main = PAGetStringParam1(Defines.StringSheet_GAME, "LUA_REGISTGUILDSERVANT_ELEPHANT_MAIN", "guildName", guildName),
      sub = PAGetString(Defines.StringSheet_GAME, "LUA_REGISTGUILDSERVANT_DEFAULT_COMMON"),
      addMsg = ""
    }
  elseif vehicleType == CppEnums.VehicleType.Type_SailingBoat then
    msg = {
      main = PAGetStringParam1(Defines.StringSheet_GAME, "LUA_REGISTGUILDSERVANT_SAILINGBOAT_MAIN", "guildName", guildName),
      sub = PAGetString(Defines.StringSheet_GAME, "LUA_REGISTGUILDSERVANT_DEFAULT_COMMON"),
      addMsg = ""
    }
  elseif vehicleType == CppEnums.VehicleType.Type_GuildDragon then
    msg = {
      main = PAGetStringParam1(Defines.StringSheet_GAME, "LUA_REGISTGUILDSERVANT_DRAGON_MAIN", "guildName", guildName),
      sub = PAGetString(Defines.StringSheet_GAME, "LUA_REGISTGUILDSERVANT_DEFAULT_COMMON"),
      addMsg = ""
    }
    Proc_ShowMessage_Ack_For_RewardSelect(msg, 5, messageType.GuildDragonRegist)
  else
    msg = {
      main = PAGetStringParam1(Defines.StringSheet_GAME, "LUA_REGISTGUILDSERVANT_DEFAULT_MAIN", "guildName", guildName),
      sub = PAGetString(Defines.StringSheet_GAME, "LUA_REGISTGUILDSERVANT_DEFAULT_COMMON"),
...
function FromClient_notifyRegisterWorkerAtAuction(workerKey, gradeType, price, iconPath, workerName, regionKeyRaw, workerRegionName)
  ...
  if _ContentsGroup_WorkerImprovement == true then
    workerName = workerName .. "(" .. workerRegionName .. ")"
    ...
    subMessage = PAGetString(Defines.StringSheet_GAME, "LUA_NAKMESSAGE_WORKERMARKET_REGISTER_MSG")
  else
    message = PAGetStringParam2(Defines.StringSheet_GAME, "LUA_NAKMESSAGE_WORKERMARKET_REGISTER_PRICE_MSG", "workerName", workerName, "price", tostring(makeDotMoney(price)))
...
function FromClient_SolareStartEndMessage(isSolareEnter)
  if _ContentsGroup_SolareRankSeason == false and _ConstentsGroup_SolareNormalMatching == false then
    return
  end
...
function PaGlobal_RewardSelect_SetNak_morningLand(msg)
  ...
  if bossListUV[msg.groupIdx] ~= nil then
    ...
    stc_morningBoss:ChangeTextureInfoNameAsync(bossTexture)
...
function PaGlobal_RewardSelect_SetNak_Telescope(msg)
  ...
  telescope._icon:ChangeTextureInfoNameAsync(msg.addMsg)
  telescope._icon:SetShow(false)
...
function PaGlobal_RewardSelect_SetNak_ElementalBossBuffSun(msg)
  ...
  elementalBossBuff._bg:ChangeTextureInfoNameAsync(messageTexture[messageType.ElementalBossBuffSun])
...
function PaGlobal_RewardSelect_SetNak_ElementalBossBuffMoon(msg)
  ...
  elementalBossBuff._bg:ChangeTextureInfoNameAsync(messageTexture[messageType.ElementalBossBuffMoon])
  elementalBossBuff._bg:EraseAllEffect()
...
function PaGlobal_RewardSelect_SetNak_ElementalBossBuffLand(msg)
  ...
  elementalBossBuff._bg:ChangeTextureInfoNameAsync(messageTexture[messageType.ElementalBossBuffLand])
  elementalBossBuff._bg:EraseAllEffect()
...
function PaGlobal_RewardSelect_SetNak_Siege2024Raffle(msgType, msg)
  ...
  parentUI:ChangeTextureInfoNameAsync(messageTexture[messageType.Siege2024Raffle])
...
function PaGlobal_RewardSelect_SetNak_Crogdalo(msg)
  ...
  crogdalog._icon:ChangeTextureInfoNameAsync(msg.addMsg)
...
function PaGlobal_RewardSelect_SetNak_RichMerchantRing(type, message)
  ...
  if nil ~= texutreInfo.leftNPC.texture then
    txt_leftNPCIcon:ChangeTextureInfoNameAsync(texutreInfo.leftNPC.texture)
  end
  if nil ~= texutreInfo.rightNPC.texture then
    txt_rightNPCIcon:ChangeTextureInfoNameAsync(texutreInfo.rightNPC.texture)
  end
...
function PaGlobal_RewardSelect_SetNak_Solare(type, title, desc)
  if _ContentsGroup_SolareRankSeason == false then
    return
  end
  audioPostEvent_SystemUi(3, 20)
  _AudioPostEvent_SystemUiForXBOX(3, 20)
...
function PaGlobal_RewardSelect_SetNak_HardCoreBoss(randomSpawnCharacterKey, isPositionNak)
  if randomSpawnCharacterKey == nil then
    return
  end
  local msg = {
    main = "",
    sub = "",
    addMsg = "",
    characterKey = randomSpawnCharacterKey,
    positionNak = isPositionNak
  }
  Proc_ShowMessage_Ack_For_RewardSelect(msg, 5, messageType.hardCoreBossNak)
end
function PaGlobal_RewardSelect_SetNak_HardCoreBlackField()
  local msg = {
    main = "",
    sub = "",
    addMsg = ""
  }
  Proc_ShowMessage_Ack_For_RewardSelect(msg, 5, messageType.hardCoreBlackFieldNak)
end
function PaGlobal_RewardSelect_SetNak_HardCoreChangeRegion(beforeHardCoreRegionType, hardCoreRegionType)
  if ToClient_HardCoreChannelWithContensOption() == false then
    return
  end
  local safeTexture = "new_ui_common_forlua/widget/nakmessage/battleroyal_safearea.dds"
  local battleTexture = "new_ui_common_forlua/widget/nakmessage/battleroyal_warningarea.dds"
  local nonPenaltyTexture = "new_ui_common_forlua/widget/nakmessage/battleroyal_blackspiritarea.dds"
  local texture = safeTexture
  local string = ""
  local fontColor = Defines.Color.C_FFFFEF82
  if hardCoreRegionType == __eHardCoreChannelRegionPlay then
    texture = battleTexture
    string = PAGetString(Defines.StringSheet_GAME, "LUA_HARDCORE_BATTLE_REGION")
    fontColor = Defines.Color.C_FFFFBB00
  elseif hardCoreRegionType == __eHardCoreChannelRegionPrison or hardCoreRegionType == __eHardCoreChannelRegionSafe then
    texture = safeTexture
    string = PAGetString(Defines.StringSheet_GAME, "LUA_RADER_ISSAFETYZONE_ACK_MAIN")
    fontColor = Defines.Color.C_FF00D8FF
  elseif hardCoreRegionType == __eHardCoreChannelRegionNoPenaltyKill then
    texture = nonPenaltyTexture
    string = PAGetString(Defines.StringSheet_GAME, "LUA_HARDCORE_NOPENALTY_BATTLE_REGION")
    fontColor = Defines.Color.C_FFF361DC
  end
  hardCoreUI.stc_HardCoreRegionChange:ChangeTextureInfoNameAsync(texture)
  hardCoreUI.stc_HardCoreRegionChange:setRenderTexture(hardCoreUI.stc_HardCoreRegionChange:getBaseTexture())
  hardCoreUI.stc_HardCoreRegionChangeText:SetFontColor(fontColor)
  hardCoreUI.stc_HardCoreRegionChangeText:SetText(string)
  local msg = {
    main = "",
    sub = "",
    addMsg = ""
  }
  Proc_ShowMessage_Ack_For_RewardSelect(msg, 5, messageType.hardCoreTimeRegionChange)
end
function PaGlobal_RewardSelect_SetNak_PersonalRelayFieldEvent(eventType, relayFieldNo, jackpotUserNickname)
  if ToClient_IsInstanceFieldPlayerbyContentsType(__eInstanceContentsType_Solare) == true or ToClient_IsInstanceFieldPlayerbyContentsType(__eInstanceContentsType_GuildMatch) == true or ToClient_IsInstanceFieldPlayerbyContentsType(__eInstanceContentsType_HorseRacing) == true then
    return
  end
  local jackpotMsgType, mainStr
  if relayFieldNo == 1 then
    if eventType == __eTrPersonalRelayEvent_OpenRelayField then
      jackpotMsgType = messageType.GoldOrcShow
      mainStr = PAGetString(Defines.StringSheet_GAME, "LUA_PERSONALRELAYFIELD_OPEN_GOLDORC")
    elseif eventType == __eTrPersonalRelayEvent_CloseRelayField then
      jackpotMsgType = messageType.GoldOrcShow
      mainStr = PAGetStringParam1(Defines.StringSheet_GAME, "LUA_PERSONAL_RELAY_JACKPOT_NOTIFY", "name", jackpotUserNickname)
    else
      return
    end
  else
  ...
  if jackpotMsgType == nil or mainStr == nil then
    return
  end
  local msg = {
    main = mainStr,
  ...
  Proc_ShowMessage_Ack_For_RewardSelect(msg, 6, jackpotMsgType)
end
function PaGlobal_SetHardCoreBossNak(randomSpawnCharacterKey, isPositionNak)
  if randomSpawnCharacterKey ~= nil and isPositionNak ~= nil then
    local textureID = ToClient_getHardCoreBossUINakTextureID(randomSpawnCharacterKey)
    local string
    hardCoreUI.stc_HardCoreBossNak:EraseAllEffect()
    if isPositionNak == true then
      string = ToClient_getHardCoreBossUIPositionNakString(randomSpawnCharacterKey)
    else
      string = ToClient_getHardCoreBossUINakString(randomSpawnCharacterKey)
      local isBoss = ToClient_getHardCoreRandomSpawnIsBoss(randomSpawnCharacterKey)
      if isBoss == true then
        hardCoreUI.stc_HardCoreBossNak:AddEffect("fUI_JinBoss_Nak_01A", false, 0, 0)
      end
    end
    hardCoreUI.stc_HardCoreBossNakText:SetText(PAGetString(Defines.StringSheet_RESOURCE, string))
    hardCoreUI.stc_HardCoreBossNak:ChangeTextureInfoTextureIDAsync(textureID)
    hardCoreUI.stc_HardCoreBossNak:setRenderTexture(hardCoreUI.stc_HardCoreBossNak:getBaseTexture())
    hardCoreUI.stc_HardCoreBossNak:SetShow(true)
  end
end
function PaGlobal_RewardSelect_SetNak_HardCore(messageData)
  if messageData.type == messageType.hardCoreBossNak then
    PaGlobal_SetHardCoreBossNak(messageData.msg.characterKey, messageData.msg.positionNak)
  elseif messageData.type == messageType.hardCoreBlackFieldNak then
    hardCoreUI.stc_HardCoreBlackField:SetShow(true)
  elseif messageData.type == messageType.hardCoreTimeLimitNak then
    hardCoreUI.stc_HardCoreTimeLimit:SetShow(true)
  elseif messageData.type == messageType.hardCoreTimeRegionChange then
    hardCoreUI.stc_HardCoreRegionChange:SetShow(true)
  else
    return
  end
end
...
function PaGlobal_RewardSelect_SetDefault()
  ...
  belmornText:SetShow(false)
  stc_worldBossNewJin:SetShow(false)
  worldBossControls.stc_worldBossEffect:EraseAllEffect()
  stc_NoticeImage:SetShow(false)
  stc_bossImage:SetShow(false)
  stc_blackBG:SetShow(false)
  stc_centerMessage:SetShow(false)
  ...
  eventBossUIOff()
  eventDrawUIOff()
  hardCoreUI.stc_HardCoreBossNak:SetShow(false)
  hardCoreUI.stc_HardCoreBlackField:SetShow(false)
  hardCoreUI.stc_HardCoreTimeLimit:SetShow(false)
  hardCoreUI.stc_HardCoreRegionChange:SetShow(false)
  local stc_personalRelay = UI.getChildControl(Panel_RewardSelect_NakMessage, "Static_PersonalRelay")
  stc_personalRelay:SetShow(false)
  stc_guildDragonMainBg:SetShow(false)
  UI.getChildControl(Panel_RewardSelect_NakMessage, "Static_StoneCrabQueen"):SetShow(false)
  local effectBG = UI.getChildControl(stc_guildDragonMainBg, "Static_Dragon_Effect")
...
function PaGlobalFunc_NakMessage_CheckReturnMiniGame()
  ...
  elseif Panel_Fishing ~= nil and Panel_Fishing:GetShow() == true then
    return true
  end
...
function PaGlobal_RewardSelect_SetNak_RoseWar(msgType, msg)
  local parentUI
  if msgType == messageType.RoseWarApplyGuild then
    parentUI = roseWarGuild
    parentUI:EraseAllEffect()
    parentUI:AddEffect("fUI_NakMessassage_03A", false, 0, 0)
    audioPostEvent_SystemUi(35, 3)
    _AudioPostEvent_SystemUiForXBOX(35, 3)
  elseif msgType == messageType.RoseWarApplyMercenary then
    parentUI = roseWarMercenary
    parentUI:EraseAllEffect()
    parentUI:AddEffect("fUI_NakMessassage_03B", false, 0, 0)
    audioPostEvent_SystemUi(35, 3)
    _AudioPostEvent_SystemUiForXBOX(35, 3)
  elseif msgType == messageType.RoseWarRaffleGuild then
    parentUI = roseWarGuild
    parentUI:EraseAllEffect()
    parentUI:AddEffect("fUI_NakMessassage_03A", false, 0, 0)
    audioPostEvent_SystemUi(35, 3)
    _AudioPostEvent_SystemUiForXBOX(35, 3)
  elseif msgType == messageType.RoseWarRaffleMercenary then
    parentUI = roseWarMercenary
    parentUI:EraseAllEffect()
    parentUI:AddEffect("fUI_NakMessassage_03B", false, 0, 0)
    audioPostEvent_SystemUi(35, 3)
    _AudioPostEvent_SystemUiForXBOX(35, 3)
  elseif msgType == messageType.RoseWarStart then
    parentUI = roseWarStart
    parentUI:EraseAllEffect()
    parentUI:AddEffect("fUI_NakMessassage_05A", false, 0, 0)
    audioPostEvent_SystemUi(35, 4)
    _AudioPostEvent_SystemUiForXBOX(35, 4)
  elseif msgType == messageType.RoseWarKamasylviaWin then
    parentUI = roseWarWin
    parentUI:EraseAllEffect()
    ...
    isForceShowMessage = true
  elseif msgType == messageType.RoseWarOdylitaWin then
    parentUI = roseWarWin
    parentUI:EraseAllEffect()
    parentUI:AddEffect("fUI_NakMessassage_06B", false, 0, 0)
    audioPostEvent_SystemUi(35, 5)
    ...
    isForceShowMessage = true
  elseif msgType == messageType.RoseWarTie then
    parentUI = roseWarTie
    parentUI:EraseAllEffect()
    ...
    UI.ASSERT(false, "RoseWarEventType\236\157\180 \236\182\148\234\176\128\235\144\152\235\169\180 \236\151\172\234\184\176\235\143\132 \236\158\145\236\151\133\237\149\180\236\163\188\236\132\184\236\154\148!")
    return
  end
  parentUI:SetShow(true)
...
function PaGlobal_RewardSelect_SetNak_Edania(msgType, msg)
  local parentUI
  if msgType == messageType.EdaniaNak1 then
    parentUI = edaniaNak1
    parentUI:EraseAllEffect()
    parentUI:AddEffect("fUI_NakMessage_DevilDom_01A", false, 0, 0)
    audioPostEvent_SystemUi(37, 0)
    _AudioPostEvent_SystemUiForXBOX(37, 0)
  elseif msgType == messageType.EdaniaNak2 then
    parentUI = edaniaNak2
    parentUI:EraseAllEffect()
    parentUI:AddEffect("fUI_NakMessage_DevilDom_01B", false, 0, 0)
    audioPostEvent_SystemUi(37, 1)
    _AudioPostEvent_SystemUiForXBOX(37, 1)
  elseif msgType == messageType.EdaniaNak3 then
    parentUI = edaniaNak3
    parentUI:EraseAllEffect()
    parentUI:AddEffect("fUI_NakMessage_DevilDom_01C", false, 0, 0)
    audioPostEvent_SystemUi(37, 2)
    _AudioPostEvent_SystemUiForXBOX(37, 2)
  elseif msgType == messageType.EdaniaNak4 then
    parentUI = edaniaNak4
    parentUI:EraseAllEffect()
    parentUI:AddEffect("fUI_NakMessage_DevilDom_01D", false, 0, 0)
    audioPostEvent_SystemUi(37, 3)
    _AudioPostEvent_SystemUiForXBOX(37, 3)
  end
  local mainText = UI.getChildControl(parentUI, "StaticText_Sub")
  local subText = UI.getChildControl(parentUI, "MultilineText")
  local icon = UI.getChildControl(parentUI, "Static_ItemIcon")
  parentUI:SetShow(true)
  mainText:SetShow(true)
  subText:SetShow(true)
  icon:SetShow(true)
  mainText:SetText(msg.main)
  subText:SetText(msg.sub)
  icon:ChangeTextureInfoTextureIDAsync(msg.addMsg)
end
...
registerEvent("FromClient_NoticeGuildMansionBuffInstallationEvent", "FromClient_NoticeGuildMansionBuffInstallationEvent")
...
registerEvent("FromClient_RoseWarNakMessage", "FromClient_RoseWarNakMessage")
...
registerEvent("FromClient_NotifyInstanceContentsCollectReplay", "FromClient_NotifyInstanceContentsCollectReplay")
registerEvent("FromClient_HardCoreBossNak", "PaGlobal_RewardSelect_SetNak_HardCoreBoss")
registerEvent("FromClient_BlackFieldNak", "PaGlobal_RewardSelect_SetNak_HardCoreBlackField")
registerEvent("FromClient_NotifyPersonalRelayFieldEvent", "PaGlobal_RewardSelect_SetNak_PersonalRelayFieldEvent")
registerEvent("FromClient_SelfHardCoreRegionChange", "PaGlobal_RewardSelect_SetNak_HardCoreChangeRegion")
registerEvent("FromClient_EdaniaNakMessage", "FromClient_EdaniaNakMessage")
