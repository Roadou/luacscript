...
function Panel_Widget_Party_info:setIcon(index)
  ...
  if textureId ~= nil then
    self._partyMemberUI[index].static_ClassIcon:ChangeTextureInfoTextureIDAsync(textureId, 0)
...
function Panel_Widget_Party_info:setMpBarTexture(index)
  ...
  local textureId
  textureId = NewClassData.newClass_Texture_ID[classType]._mpBarTextureTID
  if textureId ~= nil then
    self._partyMemberUI[index].progress2_Mp:ChangeTextureInfoTextureIDAsync(textureId, 0)
