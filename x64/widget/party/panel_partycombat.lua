...
function FromClient_UpdateMatchInfo(matchType, matchState)
  ...
  if CppEnums.MatchType.Pvp == matchType then
    ...
    ToClient_RequestNakMessageRenewelWithString(__eNakMessage_PartyCombat, messages.main)
  elseif CppEnums.MatchType.Race == matchType then
    ...
    if 2 == matchState then
      ToClient_RequestNakMessageRenewel(__eNakMessage_RaceMoveWait)
    elseif 3 == matchState then
      ToClient_RequestNakMessageRenewel(__eNakMessage_RaceReady)
    end
  end
end
function FromClient_MatchPvpResult(isWin)
  ...
  ToClient_RequestNakMessageRenewelWithString(__eNakMessage_PartyCombat, mainStr)
  HandleClicked_MatchOpen(true)
