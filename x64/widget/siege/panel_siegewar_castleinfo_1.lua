...
function PaGlobal_SiegeWar_CastleInfo:prepareOpen()
  ...
  if ToClient_IsVillageSiegeBeing() == true and (ToClient_GetMinorSiegeMode() == __eMinorSiegeModeOccupy or ToClient_getSiegeTerritoryType() == __eSiegeTerritoryType_Ocean) then
    return
  end
