  ...
  if nil ~= QuestListInfo then
    for ii = 0, __eQuestSelectType_Count do
      if self._ui.favorCheckBoxButton[ii] ~= nil then
        ...
        local checkText = UI.getChildControl(self._ui.favorCheckBoxButton[ii], "StaticText_CheckName")
        self._ui.favorCheckBoxButton[ii]:SetEnableArea(0, 0, self._ui.favorCheckBoxButton[ii]:GetSizeX() + checkText:GetTextSizeX() + 5, self._ui.favorCheckBoxButton[ii]:GetSizeY())
      end
    end
