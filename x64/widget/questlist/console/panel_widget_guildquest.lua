...
function GuildQuestWidget:update()
  ...
  if true == ToClient_isSatisfyCurrentGuildQuest() then
    ...
    self._ui.txt_QuestDemand:SetText(PAGetString(Defines.StringSheet_GAME, "GUILDQUEST_COMPLETE_WIDGET"))
    self._ui.txt_QuestDemand:SetPosY(35)
    ...
    self._ui.txt_QuestDemand:SetPosY(60)
