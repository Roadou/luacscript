...
function preCoolTimeBar:Show(isShow, progressTime, endFunction, coolTimeType)
  if isShow then
    ...
    if coolTimeType == __ePreCoolTimeType_Escape or coolTimeType == __ePreCoolTimeType_Telescope or coolTimeType == __ePreCoolTimeType_NearTownWarp or coolTimeType == __ePreCoolTimeType_MorningLandBossTeleport or coolTimeType == __ePreCoolTimeType_GuildMansionTeleport or coolTimeType == __ePreCoolTimeType_ImmortalHellTeleport or coolTimeType == __ePreCoolTimeType_EdanaCastleTeleport then
      _preCoolTime_cancel:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_CENCLE_FUNC_CASTING"))
    ...
    if coolTimeType ~= nil then
      ...
      elseif coolTimeType == __ePreCoolTimeType_ImmortalHellTeleport then
        Proc_ShowMessage_Ack(PAGetString(Defines.StringSheet_GAME, "LUA_IMMORTALHELL_TELEPORT_PROGRESS_CANCEL"))
      elseif coolTimeType == __ePreCoolTimeType_TotalPresetApply or coolTimeType == __ePreCoolTimeType_ReforgeStonePresetSave or coolTimeType == __ePreCoolTimeType_ReforgeStonePresetApply then
