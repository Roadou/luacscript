...
function PaGlobal_AgrisGaugeTooltip:prepareOpen(posX, posY)
  ...
  local optFeverPoint = ToClient_GetOtpFeverPoint()
  if optFeverPoint > 0 then
    local bonusStr = PAGetStringParam1(Defines.StringSheet_GAME, "LUA_OTP_HOTTIMEBUFF_LINK_DESC_02", "FeverPoint", tostring(optFeverPoint))
    desc = desc .. [[
