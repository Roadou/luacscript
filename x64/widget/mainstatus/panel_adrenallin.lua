...
function adrenallin_Update()
  ...
  if prevAdrenallin ~= adrenallin and ToClient_isConsole() == false then
...
function Panel_Adrenallin_ChangeTexture_On()
  Panel_Adrenallin:ChangeTextureInfoNameAsync("new_ui_common_forlua/default/window_sample_drag.dds")
  _close_Adrenallin:SetShow(true)
end
function Panel_Adrenallin_ChangeTexture_Off()
  _close_Adrenallin:SetShow(false)
  if Panel_UIControl:IsShow() then
    Panel_Adrenallin:ChangeTextureInfoNameAsync("new_ui_common_forlua/default/window_sample_isWidget.dds")
  else
    Panel_Adrenallin:ChangeTextureInfoNameAsync("new_ui_common_forlua/default/window_sample_empty.dds")
  end
end
