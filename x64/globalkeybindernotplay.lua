...
function GlobalKeyBinder_UpdateNotPlay(deltaTime)
  ...
  if nil ~= Panel_CustomizationMain then
    if (GlobalKeyBinder_CheckKeyPressed(VCK.KeyCode_ESCAPE) or GlobalKeyBinder_CheckKeyPressed(VCK.KeyCode_LBUTTON) and Panel_CustomizationMessage:GetShow() == true) and true == characterCreateIsOnLookAtCameraTimerRunning() then
