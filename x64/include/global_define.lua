...
Defines.Color = {
  ...
  C_FFFFBB00 = 4294949632,
  C_FF00D8FF = 4278245631,
  C_FFF361DC = 4294140379,
  ...
  C_FF988D83 = 4288187779,
  C_FFF1D59F = 4294038943,
  C_FF93D2CD = 4287877837,
  C_FF204343 = 4280304451,
  C_FFECFF86 = 4293721990,
  C_FF4A451A = 4283057434,
  C_FFFFB6A0 = 4294948512,
  C_FF5D4225 = 4284301861,
  C_FFCEA6FC = 4291733244,
  C_FF893DD0 = 4287184336,
  C_FF616161 = 4284572001
}
Defines.RenderMode = {
  ...
  eRenderMode_RoseWar = 24,
  eRenderMode_RoseWarMenu = 25,
  eRenderMode_Replay = 26,
  eRenderMode_InstanceContentsCeremony = 27,
  eRenderMode_SnowBoardInMirrorField = 28,
  eRenderMode_Count = 29
}
...
InventoryBottomOpenUIButtonIndex = {
  ...
  EnchantInventory = 11,
  ValksList = 12,
  ReforgeStonePreset = 13
}
Defines.SkillCCTypeConfig = {
...
function PaGlobal_Homepage_Open()
  ...
  elseif true == isGameTypeGT() then
    if getGameServiceType() == CppEnums.GameServiceType.eGameServiceType_GT_ALPHA then
      url = "https://alpha-blackdesert.pearlabyss.com/GlobalLab/"
    else
      url = "https://blackdesert.pearlabyss.com/GlobalLab/"
    end
