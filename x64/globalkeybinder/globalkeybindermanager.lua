...
function PaGlobal_GlobalKeyBinder:Init()
  ...
  self:Register(UIMode.eUIMode_RoseWar, self.Process_UIMode_RoseWar)
  self:Register(UIMode.eUIMode_RoseWarMenu, self.Process_UIMode_RoseWarMenu)
  ...
  self:Register(UIMode.eUIMode_Replay, self.Process_UIMode_Replay)
  self:Register(UIMode.eUIMode_SnowBoardInMirrorField, self.Process_UIMode_SnowBoardInMirrorField)
end
