...
function CloseManager_RegisterExeptionList()
  PaGlobal_panelExceptionList = {
    ...
    Panel_Window_ReplaySkillCooltime_All,
    Panel_HouseName,
    ...
    Panel_Widget_HardCoreBlackField_Enter,
    damagePanel_1,
    damagePanel_2,
    damagePanel_3,
    damagePanel_4,
    ...
    Panel_Worldmap_FamilyCharacter_Pin_All,
    Panel_Worldmap_FamilyCharacter_List_All,
    ...
    Panel_Window_Skill_ShowAllClasses_All,
    Panel_Window_SkillGroup_All,
    ...
    Panel_JobInfo,
    Panel_RoseWar_Command,
    Panel_RoseWar_MissionWidget,
    Panel_RoseWar_MissionAccept,
    Panel_RoseWar_Region,
    Panel_RoseWar_EditParty_Drag,
    Panel_RoseWar_TeamSkill,
    Panel_RoseWar_TeamBuff,
    Panel_RoseWar_ScoreBoardWidget,
    ...
    Panel_RoseWar_DeadMessage,
    Panel_RoseWar_Nak_WarLog,
    Panel_RoseWar_Nak_WarLog_L,
    Panel_RoseWar_Nak_Teleport,
    ...
    Panel_Window_ReplayInMirrorField_All,
    Panel_Widget_LocalWar_Match_All,
    Panel_LocalWar_Match_Confirm_All,
    Panel_Widget_MiniGame_YachtDice_MatchConfirm,
    Panel_Widget_MiniGame_YachtDice_FindingMatch,
    Panel_NakMessage_Renewel,
    Panel_Window_UseCharacterWp_All,
    Panel_Window_Edania_PVP_HUD,
    Panel_Widget_Edania_Countdown,
    Panel_Window_Edania_PVP_Challenger,
    Panel_Window_Edania_Join,
    Panel_Window_ArtifactPreset_All,
    Panel_Window_Edania_Worldmap_Castle,
    Panel_Window_EnchantInventory_All,
    Panel_Worldmap_KnowledgeList,
    Panel_Enchant_Console_KeyGuide,
    Panel_Window_CouponCode,
    Panel_Widget_Common_Countdown,
    Panel_Window_SnowBoard_Hud_All,
    Panel_Widget_OceanSiege_ReturnToSeaport,
    Panel_Window_OlviaAcademy_Alert
  }
end
