...
function FromClient_selfPlayer_regionChanged_TutorialManager(isSafeZone, isArenaZone, isDesert, isAtoraxion, regionType, regionKey, areaName, territoryName)
  PaGlobal_TutorialManager:handleRegionChanged(regionKey, areaName)
end
function PaGlobal_TutorialManager:handleRegionChanged(regionKey, areaName)
  if true == self:isDoingTutorial() and nil ~= self:getCurrentPhase() and nil ~= self:getCurrentPhase().handleRegionChanged then
    _PA_LOG("\234\179\189\235\175\188\236\154\176", "[\237\138\156\237\134\160\235\166\172\236\150\188\236\164\145 \236\167\128\236\151\173 \236\157\180\235\143\153] RegionKeyRaw : " .. tostring(regionKey) .. " / AreaName : " .. tostring(areaName))
    self:getCurrentPhase():handleRegionChanged(regionKey)
  end
end
