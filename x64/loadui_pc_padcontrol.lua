...
function preLoadGameUI_PC()
  ...
  loadUI("UI_Data/Window/Inventory/Panel_Window_InventoryEquip_Detail_All.xml", "Panel_Window_Inventory_Detail", UIGroup.PAGameUIGroup_SimpleTooltip, SETRENDERMODE_BITSET_ALLRENDER())
  ...
  basicLoadUI("UI_Data/Window/MessageBox/UI_Win_UseItem_All.xml", "Panel_UseItem_All", UIGroup.PAGameUIGroup_Movie)
  ...
  loadUI("UI_Data/Window/Equipment/Panel_Equipment_CrystalTooltip.XML", "Panel_Equipment_Crystal_Tooltip", UIGroup.PAGameUIGroup_Window_Progress, SETRENDERMODE_BITSET_ALLRENDER())
  ...
  if _ContentsGroup_WorldMapKnowledgeIcon == true then
    loadUI("UI_Data/Window/Worldmap_Grand/Panel_Window_Worldmap_KnowledgeList_All.XML", "Panel_Worldmap_KnowledgeList", UIGroup.PAGameUIGroup_WorldMap_Popups, SETRENDERMODE_BITSET_WORLDMAP())
  end
  ...
  basicLoadUI("UI_Data/Widget/Chatting/Panel_Window_Join_ChannelChat.XML", "Panel_Window_ChannelChat", UIGroup.PAGameUIGroup_Windows, RenderMode.eRenderMode_RoseWar)
  ...
  if _ContentsGroup_RoseWar == true then
    ...
    loadUI("UI_Data/Window/RoseWar/Panel_RoseWar_DeadMessage.XML", "Panel_RoseWar_DeadMessage", UIGroup.PAGameUIGroup_ModalDialog, PAUIRenderModeBitSet({
      RenderMode.eRenderMode_Dialog,
      RenderMode.eRenderMode_Default
    }))
...
function reloadUI_PCPad_SwapCharacter()
  if _ContentsGroup_ShowOtherClassSkill == true then
    loadUI("UI_Data/Window/Skill/Panel_Window_SkillGroup_All.xml", "Panel_Window_SkillGroup_All", UIGroup.PAGameUIGroup_Windows, PAUIRenderModeBitSet({
      RenderMode.eRenderMode_Default,
      RenderMode.eRenderMode_SkillWindow,
...
PaGlobal_SetReloadUIFunc(reloadUI_PCPad_SwapCharacter, __eUIReloadEventType_SwapCharacter)
