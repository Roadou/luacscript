...
function servantSupport:skillExpTrainingTest(stableSlotNo, skillkey)
  ...
  return stable_startServantSkillExpTraining(servantInfo:getServantNo(), skillKey)
end
...
function servantSupport:changeSkill(stableSlotNo, fromSkillKey, toSkillKey)
  ...
  return stable_changeSkill(servantInfo:getServantNo(), fromSkillKey, toSkillKey)
end
...
function servantSupport:forgetServantSkill(stableSlotNo, skillKey)
  ...
  return stable_forgetServantSkill(servantInfo:getServantNo(), skillKey)
end
